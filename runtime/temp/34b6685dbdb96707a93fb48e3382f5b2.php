<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:104:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/carorder/handle.html";i:1748308624;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
...
<!--        <meta name="viewport" content="width=device-width,user-scalable=yes, minimum-scale=0.4, initial-scale=0.8,target-densitydpi=low-dpi" />-->
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('Y/m/d',$v['car_time']); ?></td>
                                        <td><?php echo $v['end_time']; ?></td>
                                        <td>暂无状态</td>
                                        <td><?php if($v['is_stop'] == 1): ?>已暂停<?php else: ?>正常<?php endif; ?></td>
                                        <td class="td-manage">
                                            <a title="查看" href="<?php echo url('handleOrder',array('id'=>$v['id'])); ?>">
                                                <i class="layui-icon">&#xe63c;</i></a>
                                            </a>
                                            <?php if($v['is_stop'] != 1): ?>
                                            <a title="暂停订单" href="javascript:void(0)" onclick="stop(<?php echo $v['id']; ?>)">
                                                <i class=" layui-icon">&#xe651;</i></a>
                                            </a>
                                            <?php endif; ?>
                                        </td>
    ...
    <script>layui.use(['laydate', 'form','table','code'],
        function() {
            ...
            $(function(){
				 ...
				 $('#export_price2').click(function(){
				     ...
				     $('#form1').attr('action',"<?php echo url('exportPricea'); ?>")
				     $('#form1').submit();
				     $('#form1').attr('action',"")
				 })
        ...
        function stop(id){
            layer.confirm('确认要停止此订单吗？',
            function(index) {
                ajaxform("<?php echo url('stop'); ?>",{id:id},1);
            });
       } 
