<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/order/priced.html";i:1773237688;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                            ...
                            <table class="layui-table layui-form" lay-filter="demo">
                                <thead>
                                    <tr>                                       
                                        ...
                                        <th lay-data="{field:'status', minWidth:210}">审核</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="layui-btn layui-btn-normal layui-btn-mini" onclick="sendCar3(<?php echo $v['id']; ?>)">发给生产</span>
...
//                height: 689 //设置高度
       ...
       function sendCar2(id,status){
            ...
            function(index) {
				$.ajaxSetup({
					async: false  // 设置所有Ajax请求为同步
				});
				var index = layer.load(0,{time: 10*1000,shade:false});
				var res1 = $.post("<?php echo url('sendCar'); ?>", {id:id}, function (obj) {
				}, 'json');
				if(res1.responseJSON.code != 0){
					layer.msg(res1.responseJSON.msg, {icon: 2});
					return;
				}
				var res2 = $.post("<?php echo url('sendCar2'); ?>", {id:id,status:status}, function (obj) {
				}, 'json');	
				if(res2.responseJSON.code != 0){
					layer.msg(res1.responseJSON.msg, {icon: 2});
					return;
				}else{
					layer.msg(res1.responseJSON.msg, {icon: 1,time:1000}, function () {
						location.reload();
					});
				}
         ...
         function sendCar3(id){
            layer.confirm('确认要发送吗？',
            function(index) {
                ajaxform("<?php echo url('sendCar3'); ?>",{id:id},1);
            });
       }
        /*删除*/
