<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:106:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/series/series_add.html";i:1758811198;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" name="static_show" value="0" title="否" <?php if($res['static_show'] == 0): ?>checked<?php endif; ?>>
                            <input type="radio" name="static_show" value="1" title="是" <?php if($res['static_show'] == 1): ?>checked<?php endif; ?>>
                        </div>
                    </div>						
                    <div class="layui-form-item">
