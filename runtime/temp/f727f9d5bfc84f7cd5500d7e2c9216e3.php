<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/public/../application/admin/view/bom/yarn_add.html";i:1635496792;s:91:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
...
<!--        <meta name="viewport" content="width=device-width,user-scalable=yes, minimum-scale=0.4, initial-scale=0.8,target-densitydpi=low-dpi" />-->
            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="thickness" name="thickness" required="" lay-verify="require" class="layui-input" value="<?php echo $res['thickness']; ?>">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
        ...
        <script>layui.use(['form', 'layer'],
            function() {
                ...
                form.on('submit(add)',
                function(data) {
                    ajaxform("<?php echo url('bom/yarnAdd'); ?>",data.field);
                    return false;
                });
