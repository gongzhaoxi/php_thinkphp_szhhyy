<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:105:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/worker_group/add.html";i:1758896593;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
	...
	<div class="layui-row">
		<form class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="department" name="department" value=""  class="layui-input" >
				</div>
			</div>
			<div class="layui-form-item" >
