<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:108:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/finance/paid_record.html";i:1758810406;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="box">
						<div class="layui-form-item" style="margin-bottom: 0px;">
							...
							<div class="layui-input-inline" style="width: 300px">
								<input type="text"  name="finance_remark"  class="layui-input" value="<?php echo $v['finance_remark']; ?>">
							</div>
						</div>
        ...
        <script>layui.use(['laydate','form'],
            function() {
                ...
                $('.save-btn').click(function () {
					...
					var finance_remark = _box.find('input[name=finance_remark]').val();
                    var id = _box.find('input[name=id]').val();
                    var order_id = $('#order_id').val();
                    ajaxform("<?php echo url('paidRecord'); ?>",{have_pay:have_pay,pay_type:pay_type,other_pay:other_pay,id:id,order_id:order_id,rebate:rebate,finance_remark:finance_remark})
                });
