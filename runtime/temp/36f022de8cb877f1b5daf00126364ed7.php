<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:120:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/public/../application/admin/view/orderprogress/mobile_orderdetail.html";i:1635496794;}*/ ?>
...
.title ul li.li1{ width:4%;border-right:1px solid #999; overflow: hidden;}
.title ul li.li2{ width:8%;border-right:1px solid #999; overflow: hidden;}
.title ul li.li3{ width:8%;border-right:1px solid #999; overflow: hidden;}
.title ul li.li4{ width:8%;border-right:1px solid #999; overflow: hidden;}
.title ul li.li5{ width:8%;border-right:1px solid #999; overflow: hidden;}
...
.list ul li.li1{ width:4%;border-right:1px solid #EAEAEA; overflow: hidden;}
.list ul li.li2{ width:8%;border-right:1px solid #EAEAEA; overflow: hidden;}
.list ul li.li3{ width:8%;border-right:1px solid #EAEAEA; overflow: hidden;}
.list ul li.li4{ width:8%;border-right:1px solid #EAEAEA; overflow: hidden;}
.list ul li.li5{ width:8%;border-right:1px solid #EAEAEA; overflow: hidden;}
.list ul li.li6{ width:62%;display: flex;align-items: center;overflow: auto; height: auto;}
...
<!-- <div class="search">
<form action="">
<input type="text" name="ordernum" class="se1" value="<?php echo $condition['ordernum']; ?>" placeholder="请输入订单号" style="width: 15vw">
<input type="text" name="uname" class="se1" value="<?php echo $condition['uname']; ?>" placeholder="请输入客户名"  style="width: 15vw"></input>
<input type="date" name="ordertime" class="se1" value="<?php echo $condition['ordertime']; ?>"  style="width: 15vw"></input>
<input type="text" name="phone" class="se1" value="<?php echo $condition['phone']; ?>" placeholder="请输入电话号码"  style="width: 15vw"></input>
<button class="se2"  style="width: 10vw">搜索</button>
</form>
</div> -->
<!-- 
<div class="title">
...
<!-- 		<li class="li1"><?php echo $or['id']; ?></li>
		...
		<li class="li3"><?php echo $or['time']; ?></li>
		<li class="li4"><?php echo $or['Cname']; ?></li>
		<li class="li5"><?php echo $or['tel']; ?></li> -->
		<li class="li6" style=" width: 100%; margin-top: 13px;">
		<?php if(is_array($or['status']) || $or['status'] instanceof \think\Collection || $or['status'] instanceof \think\Paginator): $i = 0; $__LIST__ = $or['status'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gx): $mod = ($i % 2 );++$i;?>
			<div class="li-content">
				<div class="li-one <?php if($gx['time']=='未开始'): ?>change<?php endif; ?>"><?php echo $gx['name']; ?></div>
				<div class="li-two" ><p><?php echo $gx['time']; ?></p></div>
			</div>
