<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/order/edit.html";i:1758810652;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
...
<!--                                <button class="layui-btn" id="refresh" onclick="" type='button'>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 50%">
									...
									<input type="radio" name="type" value="<?php echo $k; ?>" title="<?php echo $v; ?>" <?php if($res['type'] == $k): ?>checked<?php endif; ?>>
									<?php endforeach; ?>
                                </div>
                            </div>
							<div class="layui-inline">
