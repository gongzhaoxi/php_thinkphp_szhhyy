<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/order/add.html";i:1758810468;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
                        ...
                        <div class="layui-card-body ">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 50%">
									...
									<input type="radio" name="type" value="<?php echo $k; ?>" title="<?php echo $v; ?>" <?php if(1 == $k): ?>checked<?php endif; ?>>
									<?php endforeach; ?>
                                </div>
                            </div>
