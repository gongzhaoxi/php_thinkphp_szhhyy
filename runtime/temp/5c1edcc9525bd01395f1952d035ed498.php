<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:107:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/allorder/print_tag.html";i:1774922650;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
...
<body>
	<div id="myForm">
		<form class="layui-form" action="">
			<div class="layui-form-item">
				<label class="layui-form-label _layui-form-label">销售订单号1：</label>
	...
	<style>
	.print{width:389.29133858267716px;height:566.9291338582677px;padding:10px;max-width:100%; overflow:hidden;font-weight:600;}
