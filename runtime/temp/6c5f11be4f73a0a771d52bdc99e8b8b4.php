<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:106:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/order/add_product.html";i:1635510062;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;s:101:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/order/common_add_price.html";i:1758810926;s:105:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/order/common_add_calculate.html";i:1635496794;s:94:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/order/common_js.html";i:1758810968;}*/ ?>
<!DOCTYPE html>
					...
					<div class="layui-form-item ">
                        ...
                        <div class="layui-input-inline">
                            <select name="guardrail" lay-filter="guardrail">
                              ...
                              <option value="1">加防护栏</option>
                            </select>
                        </div>
						<label class="layui-form-label guardrail" style="display: none;">单价</label>
						<div class="layui-input-inline guardrail" style="display: none;">
							<input name="guardrail_price" value="5.00" type="number" class="layui-input">
						</div>
						<label class="layui-form-label guardrail" style="display: none;">数量</label>
						<div class="layui-input-inline guardrail" style="display: none;">
							<input name="guardrail_num" value="1" type="number" class="layui-input">
						</div>
                    </div>						
