<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:105:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/finance/delivery.html";i:1635496794;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="xadmin.open('查看详细', '<?php echo url('allorder/readDelivery',array('id'=>$v['id'])); ?>', 1200, 600)">查看</a>&nbsp;&nbsp;
<!--                                            <a href="javascript:void(0)" onclick="xadmin.open('查看详细', '<?php echo url('editDelivery',array('id'=>$v['id'])); ?>', 1200, 600)">修改</a>-->
                                            </td>
                                        <td><?php echo $send_status[$v['status']]; ?></td>
                                        <td>
                                            <?php if($v['is_check'] == 0): ?>
                                            <a href="javascript:void(0)" onclick="check(this,<?php echo $v['id']; ?>)" class="layui-btn layui-btn-normal">审核通过</a>
                                            <?php else: ?>
                                            <a href="javascript:void(0)" class="layui-btn layui-btn-disabled">已通过可打印</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
    ...
    <script>layui.use(['laydate', 'form'],
        function() {
            ...
            $('#export-btn').click(function () {
                ...
                $('#form1').attr('action',"<?php echo url('Allorder/exportSend'); ?>");
                $('#form1').submit();
                $('#form1').attr('action','');
            })
        });
        ...
        function check(obj, id) {
            ...
            function(index) {
                //发异步删除数据
                ajaxform("<?php echo url('checkDelivery'); ?>",{id:id},1);
            });
        }
    </script>
