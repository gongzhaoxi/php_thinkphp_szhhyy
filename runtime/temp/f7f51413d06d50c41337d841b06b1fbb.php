<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/worker/index.html";i:1756305808;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	layui.use(['table', 'form', 'jquery'], function() {
		...
		table.render({
			...
			cols: [[
				{type: 'checkbox'},
				{field: 'username',title: '用户名工号',align: 'center'},
				{field: 'password',title: '密码',align: 'center'},
				{field: 'group_name',title: '所属班组',align: 'center'},
