<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:107:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/order/add_material.html";i:1732236282;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                <table class="layui-table layui-form">
                    ...
                    <tbody id="table">
                        <tr id="clone">
                            <td><input name="name[]" type="text"  class="layui-input"/></td>
                            <td>
                                <input name="type[]" type="text" lay-verify="required" class="layui-input material" autocomplete="off"/>
                                <div class="material-div" id="material-div"></div>
                            </td>
                            <td><input name="color[]" type="text"  class="layui-input type"/>
                                <div class="material-div" id="material-div"></div>
                            </td>
                            <td class="unit"><input name="unit[]" type="text" lay-verify="required" class="layui-input"/></td>
                            <td class="width-td"><input name="width[]" type="text" lay-verify="required" class="layui-input width all"/></td>
                            <td class="height-td"><input name="height[]" type="text" lay-verify="required" class="layui-input height all"/></td>
                            <td class="count-td"><input name="count[]" type="text" lay-verify="required" class="layui-input count all"/></td>
                            <td class="area-td"><input name="area[]" type="text" lay-verify="required" class="layui-input area all"/></td>
                            <td class="product-area-td"><input name="product_area[]" type="text" lay-verify="required" class="layui-input product-area"/></td>
                            <td class="price"><input name="price[]" type="text" lay-verify="required" class="layui-input price all"/></td>
                            <td class="rebate-td"><input name="rebate[]" lay-verify="rebate" type="text" class="layui-input rebate all" value="<?php echo $res['dealer_rebate']; ?>"/></td>
                            <td class="rebate-price-td"><input name="rebate_price[]" lay-verify="required" type="text" class="layui-input rebate_price all"/></td>
...
<script>
    layui.use(['laydate', 'form'],
            function () {
                ...
                form.on('submit(add)',
                        function (data) {                            
                            ajaxform("<?php echo url('addMaterial'); ?>", data.field);
                            return false;
                        });
