<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/public/../application/admin/view/bom/yarn.html";i:1635496792;s:91:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="layui-card-header">
                            <form class="layui-form layui-col-space5">
                                ...
                                <div class="layui-input-inline" style="float: right">
                                    ...
                                    <button class="layui-btn" onclick="xadmin.open('添加物料', '<?php echo url('yarnAdd'); ?>', 600, 400)" type='button'>
                                        <i class="layui-icon"></i>添加物料
                                    </button>
                                    <button class="layui-btn layui-btn-normal" type='button' id='import'>
                                        <i class="layui-icon"></i>导入数据
                                    </button>
                                    <a class="layui-btn layui-btn-warm" href="<?php echo url('bom/exportYarn'); ?>">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                            <a title="编辑" onclick="xadmin.open('编辑','<?php echo url('yarnAdd',array('id'=>$v['id'])); ?>', 600, 400)" href="javascript:;">
                                                <i class="layui-icon">&#xe642;</i>
                                            </a>
     ...
     <script>layui.use(['laydate', 'form','upload'],
        function() {
            ...
            var uploadInst = upload.render({
                elem: '#import' //绑定元素
                , url: "<?php echo url('bom/importYarn'); ?>" //上传接口
        ...
        function member_del(obj, id) {
            ...
            function(index) {
                //发异步删除数据
                ajaxform("<?php echo url('bom/yarnDel'); ?>",{id:id},1);
            });
        }
        ...
        function delAll (argument) {
            ...
            layer.confirm('确认要删除吗？',function(index){
               ajaxform("<?php echo url('bom/yarnDel'); ?>",{ids:ids},1);
            });
