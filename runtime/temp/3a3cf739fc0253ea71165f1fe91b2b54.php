<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:106:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/public/../application/admin/view/finance/no_handle.html";i:1769441907;s:92:"/mnt/datadisk0/www/wwwroot/wchuanghua2.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="layui-card-header">
                            <form class="layui-form layui-col-space5" id="form1">
                                ...
                                <div class="layui-input-inline layui-show-xs-block">
                                    <input type="text" name="keyword" id="keyword" placeholder="请输入订单号/经销商名称" autocomplete="off" class="layui-input" value='<?php echo $name; ?>'>
                                </div>
                                <div class="layui-input-inline layui-show-xs-block">
...
<!--                                        <td><?php echo $pay_type[$v['pay_type']]; ?></td>-->
	...
	layui.config({
		...
		select: "select",
	}).use(['laydate', 'form','table','layer','select'],
        function() {
            $ = layui.jquery;
            var laydate = layui.laydate;
            var  form = layui.form;
			var table = layui.table;
			var layer = layui.layer,select= layui.select;
			//转换静态表格
			table.init('demo', {
    			//height: 689 //设置高度
			...
			$('#export_price2').click(function(){
				 ...
				 $('#form1').attr('action',"<?php echo url('exportNoHandle'); ?>")
				 $('#form1').submit();
				 $('#form1').attr('action',"")
			 })
