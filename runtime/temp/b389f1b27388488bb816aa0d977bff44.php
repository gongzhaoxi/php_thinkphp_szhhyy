<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:110:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/public/../application/admin/view/allorder/wait_delivery.html";i:1745284124;s:91:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="layui-card-header">
                            <form class="layui-form layui-col-space5" >
                                ...
                                <div class="layui-input-inline layui-show-xs-block">
                                    <input type="text" name="keyword" placeholder="请输入名称/编号" autocomplete="off" class="layui-input" value="<?php echo $search['keyword']; ?>">
                                </div>
                                <div class="layui-input-inline layui-show-xs-block">
