<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:116:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/public/../application/admin/view/structure/edit_ruler_formula.html";i:1635496795;s:91:"/mnt/datadisk0/www/wwwroot/wchuanghua.ecloudm.com/application/admin/view/public/header.html";i:1635496794;}*/ ?>
<!DOCTYPE html>
            ...
            <form class="layui-form layui-col-space5">
                ...
                <div class="layui-form-item" id="clone">
                    <div class="input-field layui-inline ">
                        <input type="text" id="code" name="field[]" required="" lay-verify="required" class="layui-input" value='<?php echo $v['field']; ?>'>
                    </div>
                ...
                <div class="layui-col-md12">
                    <input name='srf_id' type='hidden' value='<?php echo $srf_id; ?>'/>
...
<script>layui.use(['laydate', 'form'],
            function () {
                ...
                form.on('submit(add)',
                function(data) {
                    ajaxform("<?php echo url('editRulerFormula'); ?>",data.field);
                    return false;
                });
            });
</script>
