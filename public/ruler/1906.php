...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:68px;left:43px;width:128px; height:109px;">
...
<div class="posi_a ov_h" style="top:160px;left:175px;width:60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:26px;left:175px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
