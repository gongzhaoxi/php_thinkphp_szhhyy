...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:109px;top:377px;left:120px;"><p style="width:109px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:32px;top:5px;left:234px;"><p style="height:32px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
