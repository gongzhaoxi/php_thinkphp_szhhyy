...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:26px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:26px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:151px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:151px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:276px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:276px;width:77px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="134"/></div>
</div>
...
<div class="posi_a ov_h" style="top:141px;left:151px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
		<p style="width:78px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:26px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
