...
<div class="posi_a ov_h" style="top:328px;left:70px;height:45px;width:142px;">
	<div class="size_tb_bg font borDW">
		<p style="width:142px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:147px;left:213px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:197px;left:0px;height:45px;width:63px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:242px;left:-60px;width:60px;height:135px;">
	<div class="size_lr_bg font borDH">
		<p style="height:135px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:163px;left:-60px;width:60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:248px;left:-2px;width:60px;height:124px;">
	<div class="size_lr_bg font borDH">
		<p style="height:124px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-2px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
