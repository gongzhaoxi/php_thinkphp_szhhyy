...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:79px;width:129px; height:267px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:43px;width:166px; height:98px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:283px;left:209px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:43px;height: 45px;width:166px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:3px;width: 60px;height:89px;">
	<div class="size_lr_bg font borDH">
