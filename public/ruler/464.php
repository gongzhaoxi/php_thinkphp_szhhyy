...
<div class="size_lr_bg font posi_a borSH" style="height:42px;top:33px;left:128px;writing-mode:tb-rl;"><p style="height:42px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:42px;top:177px;left:128px;writing-mode:tb-rl;"><p style="height:42px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:205px;top:172px;left:156px;"><p style="height:205px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
