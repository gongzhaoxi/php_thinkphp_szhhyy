...
<div class="size_lr_bg font posi_a borSH" style="height:136px;top:3px;left:337px;"><p style="height:136px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:93px;top:3px;left:186px;writing-mode:tb-rl;"><p style="height:93px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:93px;top:184px;left:186px;writing-mode:tb-rl;"><p style="height:93px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:39px;top:107px;left:128px;"><p style="width:39px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:70px;top:229px;left:55px;"><p style="width:70px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
