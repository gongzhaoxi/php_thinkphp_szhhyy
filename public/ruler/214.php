...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:39px;left:5px;width:77px; height:212px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:30px;top:4px;left:87px;"><p style="height:30px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:290px;left:87px;"><p style="height:83px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:214px;top:38px;left:87px;"><p style="height:214px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:79px;top:-20px;left:4px;"><p style="width:79px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:24px;top:377px;left:4px;"><p style="width:24px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
</div>
</div>
<script>
