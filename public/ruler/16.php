...
<div class="size_lr_bg font posi_a borSH" style="height:100px;top:26px;left:116px;writing-mode:tb-rl;"><p style="height:100px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:100px;top:166px;left:116px;writing-mode:tb-rl;"><p style="height:100px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:215px;top:162px;left:205px;"><p style="height:215px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:34px;top:136px;left:67px;"><p style="width:34px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:129px;left:106px;"><p style="height:35px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
