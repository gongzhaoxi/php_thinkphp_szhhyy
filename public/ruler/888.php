...
<div class="size_lr_bg font posi_a borSH" style="height:220px;top:55px;left:314px;"><p style="height:220px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:314px;"><p style="height:358px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
