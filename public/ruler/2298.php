...
<div class="posi_a ov_h" style="top:113px;left:209px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:238px;left:41px;height:45px;width:204px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:288px;left:175px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:86px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:5px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
