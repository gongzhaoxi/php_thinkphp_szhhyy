...
<div class="posi_a ov_h" style="top:299px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:5px;height:45px;width:194px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:194px;width:60px;height:221px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:270px;left:164px;width:60px;height:49px;">
	<div class="size_lr_bg font borDH">
		<p style="height:49px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
