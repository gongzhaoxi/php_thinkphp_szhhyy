...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:148px;top:229px;left:-30px;"><p style="height:148px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:133px;top:7px;left:12px;writing-mode:tb-rl;"><p style="height:133px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:133px;top:237px;left:12px;writing-mode:tb-rl;"><p style="height:133px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:84px;top:178px;left:7px;"><p style="width:84px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
