...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:37px;left:60px;width:92px; height:209px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="92" height="209"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 213px;height: 284px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:213px;height:284px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:95px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:310px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:233px;left:84px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:5px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
		<p style="width:177px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:159px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:182px;left:173px;width:60px;height:195px;">
	<div class="size_lr_bg font borDH">
		<p style="height:195px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:124px;left:173px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:284px;left:146px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:146px;width:60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:146px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
