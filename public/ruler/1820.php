...
<div class="posi_a ov_h" style="top:326px;left:10px;height:45px;width:120px;">
	<div class="size_tb_bg font borDW">
		<p style="width:120px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:314px;left:67px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
