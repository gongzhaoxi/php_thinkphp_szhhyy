...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:57px;left:62px;width:99px; height:128px;">
...
<div class="posi_a ov_h" style="top:194px;left:4px;height:45px;width:158px;">
	<div class="size_tb_bg font borDW">
		<p style="width:158px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:4px;height:45px;width:106px;">
	<div class="size_tb_bg font borDW">
		<p style="width:106px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:57px;height:45px;width:106px;">
	<div class="size_tb_bg font borDW">
		<p style="width:106px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:4px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:125px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:273px;left:72px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:-7px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:-7px;width:60px;height:73px;">
	<div class="size_lr_bg font borDH">
