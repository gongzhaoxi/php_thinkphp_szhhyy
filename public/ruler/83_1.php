...
<div class="size_lr_bg font posi_a borSH" style="height:163px;top:214px;left:160px;"><p style="height:163px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:39px;left:130px;writing-mode:tb-rl;"><p style="height:119px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:219px;left:130px;writing-mode:tb-rl;"><p style="height:119px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:178px;left:102px;"><p style="width:54px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:53px;top:162px;left:160px;"><p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
