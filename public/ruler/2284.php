...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:79px;width:129px; height:110px;">
...
<div class="posi_a ov_h" style="top:160px;left:5px;width:60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:5px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
