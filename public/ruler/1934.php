...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:51px;left:42px;width:154px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="154" height="275"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:51px;left:238px;width:154px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="154" height="275"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:437px;">
	<div class="size_tb_bg font borDW">
		<p style="width:437px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:434px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:154px;top:332px;left:42px;"><p style="width:154px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:397px;"><p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
