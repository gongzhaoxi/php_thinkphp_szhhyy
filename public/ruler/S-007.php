...
<!-- 砂网 -->
<!-- <div style="background: url(../color/shawang.png); position:absolute; top: 0px;left: 0;width: 189px;height: 377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:142px;top:-20px;left:212px;"><p style="width:142px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:730px;">
	<div class="size_tb_bg font borDW">
		<p style="width:730px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="size_tb_bg font posi_a borSW" style="width:187px;top:377px;left:354px;"><p style="width:187px"><span><?php if(empty($DW)){$DW='DW';}?><?php echo $DW;?></span></p></div>
<!-- 左边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:202px;top:175px;left:-30px;"><p style="height:202px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div> -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:730px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:153px;top:23px;left:541px;"><p style="height:153px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:180px;top:188px;left:189px;"><p style="height:180px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div> -->
<!-- 锁位 -->
</div>
</div>
<script>
