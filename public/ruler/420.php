...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:184px;top:4px;left:-30px;"><p style="height:184px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:135px;top:4px;left:135px;writing-mode:tb-rl;"><p style="height:135px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:135px;top:238px;left:135px;writing-mode:tb-rl;"><p style="height:135px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
