...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:146px;">
	<div class="size_tb_bg font borDW">
		<p style="width:146px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:105px;top:82px;left:146px;"><p style="height:105px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:27px;top:5px;left:146px;"><p style="height:27px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:68px;top:44px;left:146px;"><p style="height:68px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:146px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:146px;width:60px;height:377px;">
