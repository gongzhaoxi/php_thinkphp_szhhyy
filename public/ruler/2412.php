...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:93px;width:152px; height:207px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:93px;width:152px; height:98px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:328px;left:93px;height: 45px;width:152px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:285px;left:45px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:285px;left:0px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:85px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:9px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:9px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
