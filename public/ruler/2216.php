...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:62px;left:62px;width:99px; height:137px;">
...
<div class="posi_a ov_h" style="top:250px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:213px;left:62px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:33px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
		<p style="width:130px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:122px;left:4px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:168px;left:-60px;width:60px;height:209px;">
	<div class="size_lr_bg font borDH">
		<p style="height:209px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:113px;left:-60px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:125px;width:60px;height:114px;">
	<div class="size_lr_bg font borDH">
		<p style="height:114px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:290px;left:97px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:-7px;width:60px;height:89px;">
	<div class="size_lr_bg font borDH">
		<p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:-7px;width:60px;height:107px;">
	<div class="size_lr_bg font borDH">
