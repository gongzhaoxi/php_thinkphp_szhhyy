...
<!-- <div class="posi_a ov_h" style="top:92px;left:210px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:129px;left:7px;height: 45px;width:69px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:121px;left:16px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:196px;left:77px;width: 60px;height:173px;">
	<div class="size_lr_bg font borDH">
		<p style="height:173px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:9px;left:77px;width: 60px;height:173px;">
	<div class="size_lr_bg font borDH">
		<p style="height:173px"><span><?php if(empty($D1)){$D1='D1';}?><?php echo $D1;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
