...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:10px;left:150px;"><p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:239px;left:150px;"><p style="height:128px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:174px;top:10px;left:340px;"><p style="height:174px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:170px;left:229px;"><p style="width:82px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:147px;left:160px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:357px;top:10px;left:449px;"><p style="height:357px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
