...
<div class="posi_a ov_h" style="top:-45px;left:0px;height:45px;width:178px;">
	<div class="size_tb_bg font borDW">
		<p style="width:178px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:357px;left:181px;height:45px;width:166px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:491px;width:60px;height:377px;">
