...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:185px;top:-20px;left:6px;"><p style="width:185px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:233px;top:-20px;left:197px;"><p style="width:233px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:171px;left:-30px;"><p style="height:35px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:212px;left:-30px;"><p style="height:119px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 右边 -->
