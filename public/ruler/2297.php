...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:66px;left:42px;width:129px; height:110px;">
...
<div class="posi_a ov_h" style="top:113px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:305px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:238px;left:5px;height:45px;width:204px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:175px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
