...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:91px;top:-20px;left:36px;"><p style="width:91px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:480px;">
	<div class="size_tb_bg font borDW">
		<p style="width:480px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:121px;top:252px;left:-30px;"><p style="height:121px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:480px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:480px;"><p style="height:147px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:115px;top:131px;left:67px;"><p style="height:115px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:60px;top:377px;left:67px;"><p style="width:60px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
