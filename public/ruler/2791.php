...
<div style="overflow: hidden;position:absolute; top:276px;left:6px;width:223px; height:64px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="223" height="64"/></div>
</div>
...
<div class="posi_a ov_h" style="top:295px;left:6px;height: 45px;width:223px;">
	<div class="size_tb_bg font borDW">
		<p style="width:223px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:276px;left:170px;width: 60px;height:64px;">
	<div class="size_lr_bg font borDH">
		<p style="height:64px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:182px;left:167px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
