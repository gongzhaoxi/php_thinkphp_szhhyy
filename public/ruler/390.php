...
/*上下标尺寸*/
.size_tb_bg{background:url(../images/left_1.png) left center,url(../images/right_1.png) right center;}
/*左右标尺寸*/
...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:8px;left:118px;width:147px; height:361px;">
...
<div style="overflow: hidden;position:absolute; top:8px;left:453px;width:147px; height:361px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="147" height="361"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 719px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:49px;top:377px;left:663px;"><p style="width:49px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:719px;">
	<div class="size_tb_bg font borDW">
		<p style="width:719px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:719px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:81px;top:7px;left:412px;writing-mode:tb-rl;"><p style="height:81px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:94px;top:276px;left:412px;writing-mode:tb-rl;"><p style="height:94px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:109px;top:268px;left:719px;"><p style="height:109px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:205px;left:273px;"><p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:95px;left:389px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:149px;top:377px;left:117px;"><p style="width:149px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
...
<p>FH：<input type="text" name="FH" value="总高-边框*2+搭接*2-外框*2"></p>
