...
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:377px;">
	<div class="size_tb_bg font borDW">
		<p style="width:377px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:0px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
		<p style="width:100px"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:100px;height:45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:189px;height:45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($W3)){$W3='W3';}?><?php echo $W3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:279px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
		<p style="width:100px"><span><?php if(empty($W4)){$W4='W4';}?><?php echo $W4;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:110px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-20px;left:110px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:310px;left:110px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:265px;left:21px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:-15px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:168px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:350px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="posi_a ov_h" style="top:0px;left:357px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:-45px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:49px;left:-14px;width:60px;height:279px;">
	<div class="size_lr_bg font borDH">
		<p style="height:279px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:0px;left:-35px;width:60px;height:167px;"> -->
	<!-- <div class="size_lr_bg font borDH"> -->
		<!-- <p style="height:167px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p> -->
	<!-- </div> -->
<!-- </div> -->
<!-- <div class="posi_a ov_h" style="top:172px;left:24px;width:60px;height:73px;"> -->
	<!-- <div class="size_lr_bg font borDH"> -->
		<!-- <p style="height:73px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p> -->
	<!-- </div> -->
<!-- </div> -->
