...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:50px;left:76px;width:113px; height:279px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 238px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:238px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:238px;">
	<div class="size_tb_bg font borDW">
		<p style="width:238px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:328px;left:75px;height:45px;width:113px;">
	<div class="size_tb_bg font borDW">
		<p style="width:113px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:140px;left:190px;height:45px;width:49px;">
	<div class="size_tb_bg font borDW">
		<p style="width:49px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:176px;left:0px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:227px;left:2px;width:60px;height:144px;">
	<div class="size_lr_bg font borDH">
		<p style="height:144px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:2px;width:60px;height:144px;">
	<div class="size_lr_bg font borDH">
		<p style="height:144px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
