...
<div style="overflow: hidden;position:absolute; top:282px;left:4px;width:155px; height:90px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="155" height="90"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:4px;height: 45px;width:155px;">
	<div class="size_tb_bg font borDW">
		<p style="width:155px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:188px;left:123px;width: 60px;height:189px;">
	<div class="size_lr_bg font borDH">
