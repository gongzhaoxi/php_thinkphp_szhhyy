...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:126px;left:4px;width:55px; height:125px;">
...
<div style="overflow: hidden;position:absolute; top:126px;left:86px;width:55px; height:125px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="55" height="125"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:126px;left:167px;width:55px; height:125px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="55" height="125"/></div>
</div>
...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:227px;">
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:227px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:54px;top:3px;left:227px;"><p style="height:54px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:20px;top:59px;left:227px;"><p style="height:20px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:54px;top:320px;left:227px;"><p style="height:54px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:127px;top:125px;left:227px;"><p style="height:127px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:57px;top:-20px;left:3px;"><p style="width:57px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:20px;top:377px;left:144px;"><p style="width:20px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
