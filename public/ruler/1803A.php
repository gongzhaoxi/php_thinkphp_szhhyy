...
<div class="posi_a ov_h" style="top:307px;left:129px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:153px;width:60px;height:377px;">
...
<div class="posi_a ov_h" style="top:252px;left:89px;width:60px;height:120px;">
	<div class="size_lr_bg font borDH">
		<p style="height:120px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:7px;left:106px;width:60px;height:190px;">
	<div class="size_lr_bg font borDH">
		<p style="height:190px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
