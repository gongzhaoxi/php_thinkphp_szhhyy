...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:46px;left:30px;width:104px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="104" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:30px;width:104px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="104" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:189px;width:104px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="104" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:189px;width:104px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="104" height="119"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:323px;">
	<div class="size_tb_bg font borDW">
		<p style="width:323px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:81px;left:0px;height:45px;width:29px;">
	<div class="size_tb_bg font borDW">
		<p style="width:29px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:142px;left:32px;height:45px;width:139px;">
	<div class="size_tb_bg font borDW">
		<p style="width:139px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:32px;height:45px;width:139px;">
	<div class="size_tb_bg font borDW">
		<p style="width:139px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:143px;left:29px;height:45px;width:106px;">
	<div class="size_tb_bg font borDW">
		<p style="width:106px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:46px;left:288px;width:60px;height:121px;">
	<div class="size_lr_bg font borDH">
		<p style="height:121px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:205px;width:60px;height:26px;">
	<div class="size_lr_bg font borDH">
		<p style="height:26px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
