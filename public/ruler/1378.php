...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:164px;top:-20px;left:288px;"><p style="width:164px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:457px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:81px;top:44px;left:382px;"><p style="height:81px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
...
<div class="size_lr_bg font posi_a borSH" style="height:104px;top:82px;left:457px;"><p style="height:104px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:457px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
