...
<div class="posi_a ov_h" style="top:207px;left:30px;width: 60px;height:30px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:156px;left:142px;width: 60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:142px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
