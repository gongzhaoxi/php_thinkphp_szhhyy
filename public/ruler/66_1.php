...
<div class="size_lr_bg font posi_a borSH" style="height:159px;top:4px;left:166px;writing-mode:tb-rl;"><p style="height:159px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:159px;top:214px;left:166px;writing-mode:tb-rl;"><p style="height:159px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
