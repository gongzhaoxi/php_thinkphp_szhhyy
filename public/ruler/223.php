...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:63px;left:5px;width:66px; height:176px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:26px;top:4px;left:76px;"><p style="height:26px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:72px;top:301px;left:76px;"><p style="height:72px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:178px;top:62px;left:76px;"><p style="height:178px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:68px;top:-20px;left:4px;"><p style="width:68px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:20px;top:377px;left:4px;"><p style="width:20px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
</div>
</div>
<script>
