...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:71px;top:190px;left:112px;"><p style="width:71px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:24px;top:377px;left:6px;"><p style="width:24px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
</div>
</div>
<script>
