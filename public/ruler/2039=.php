...
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:174px;left:-2px;writing-mode:tb-rl;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<!-- 锁位 -->
