...
<div class="posi_a ov_h" style="top:288px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:4px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:270px;left:97px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
		<p style="height:51px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:97px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
