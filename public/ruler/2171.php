...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:32px;left:40px;width:114px; height:179px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="114" height="179"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:230px;">
...
<div class="posi_a ov_h" style="top:276px;left:97px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:357px;left:5px;height:45px;width:92px;">
	<div class="size_tb_bg font borDW">
		<p style="width:92px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:39px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
		<p style="width:58px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:6px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
		<p style="width:58px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:243px;left:159px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
