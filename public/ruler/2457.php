...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:37px;left:42px;width:126px; height:190px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="126" height="190"/></div>
</div>
...
<div class="posi_a ov_h" style="top:5px;left:174px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
