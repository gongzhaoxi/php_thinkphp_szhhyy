...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 383px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:3px;left:213px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:159px;top:214px;left:213px;writing-mode:tb-rl;"><p style="height:159px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
