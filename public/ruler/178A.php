...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:59px;left:70px;width:109px; height:125px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="109" height="125"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 250px;height: 244px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:250px;height:244px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:80px;left:214px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:265px;left:0px;height:45px;width:47px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:193px;left:70px;height:45px;width:141px;">
	<div class="size_tb_bg font borDW">
		<p style="width:141px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:244px;left:210px;width:60px;height:129px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:160px;left:1px;width:60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:1px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
