...
<div style="overflow: hidden;position:absolute; top:264px;left:66px;width:114px; height:83px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="114" height="83"/></div>
</div>
...
<div class="posi_a ov_h" style="top:262px;left:0px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:302px;left:66px;height: 45px;width:114px;">
	<div class="size_tb_bg font borDW">
		<p style="width:114px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:264px;left:120px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
