...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:75px;left:40px;width:93px; height:227px;">
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:195px;">
...
<div class="posi_a ov_h" style="top:288px;left:41px;height:45px;width:93px;">
	<div class="size_tb_bg font borDW">
		<p style="width:93px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:323px;left:6px;height:45px;width:186px;">
	<div class="size_tb_bg font borDW">
		<p style="width:186px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:97px;left:138px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:216px;left:155px;width:60px;height:161px;">
	<div class="size_lr_bg font borDH">
		<p style="height:161px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:220px;left:127px;width:60px;height:119px;">
	<div class="size_lr_bg font borDH">
		<p style="height:119px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:40px;left:127px;width:60px;height:72px;">
	<div class="size_lr_bg font borDH">
		<p style="height:72px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:117px;left:99px;width:60px;height:98px;">
	<div class="size_lr_bg font borDH">
		<p style="height:98px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
