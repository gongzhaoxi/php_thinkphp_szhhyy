...
<div class="size_lr_bg font posi_a borSH" style="height:123px;top:3px;left:139px;writing-mode:tb-rl;"><p style="height:123px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:129px;left:128px;"><p style="height:35px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
