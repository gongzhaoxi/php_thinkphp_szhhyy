...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:82px;width:131px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="131" height="205"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:44px;height: 45px;width:133px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:120px;left:18px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:5px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:5px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
