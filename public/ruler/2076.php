...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:53px;left:61px;width:80px; height:85px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="80" height="85"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:241px;left:61px;width:80px; height:85px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="80" height="85"/></div>
</div>
...
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:200px;">
	<div class="size_tb_bg font borDW">
		<p style="width:200 px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:18px;left:0px;height:45px;width:31px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:5px;left:61px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:53px;left:165px;width:60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
