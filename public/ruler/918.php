...
<div class="size_lr_bg font posi_a borSH" style="height:117px;top:130px;left:420px;"><p style="height:117px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:177px;top:81px;left:345px;"><p style="height:177px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
