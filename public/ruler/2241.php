...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:41px;width:128px; height:149px;">
...
<div class="posi_a ov_h" style="top:95px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:233px;left:102px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:186px;left:173px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
		<p style="height:64px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:36px;left:173px;width:60px;height:85px;">
	<div class="size_lr_bg font borDH">
