...
<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:103px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="103" height="97"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:5px;height: 45px;width:103px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:195px;left:34px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
