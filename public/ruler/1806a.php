...
<div class="posi_a ov_h" style="top:212px;left:103px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
		<p style="width:80px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:44px;left:8px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
		<p style="width:177px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:44px;left:194px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:257px;left:-60px;width:60px;height:122px;">
	<div class="size_lr_bg font borDH">
		<p style="height:122px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:183px;left:126px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
		<p style="height:70px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:268px;left:227px;width:60px;height:103px;">
	<div class="size_lr_bg font borDH">
		<p style="height:103px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:227px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
