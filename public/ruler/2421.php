...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:5px;width:133px; height:176px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="133" height="176"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:277px;left:5px;width:210px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="210" height="66"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 220px;height: 246px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 220px;height: 246px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:296px;left:5px;height: 45px;width:210px;">
	<div class="size_tb_bg font borDW">
		<p style="width:210px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:100px;left:144px;height: 45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:211px;left:70px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:147px;left:180px;width: 60px;height:230px;">
	<div class="size_lr_bg font borDH">
		<p style="height:230px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:89px;left:104px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:151px;left:143px;width: 60px;height:62px;">
	<div class="size_lr_bg font borDH">
		<p style="height:62px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:143px;width: 60px;height:52px;">
	<div class="size_lr_bg font borDH">
