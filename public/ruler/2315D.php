...
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:5px;left:207px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:90px;top:181px;left:207px;writing-mode:tb-rl;"><p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:81px;top:120px;left:162px;"><p style="width:81px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:57px;top:120px;left:244px;"><p style="height:57px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
