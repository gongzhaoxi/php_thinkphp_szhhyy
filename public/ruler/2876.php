...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:64px;left:56px;width:83px; height:139px;">
...
<div style="overflow: hidden;position:absolute; top:293px;left:5px;width:160px; height:53px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:293px;left:-35px;width: 60px;height:53px;">
	<div class="size_lr_bg font borDH">
