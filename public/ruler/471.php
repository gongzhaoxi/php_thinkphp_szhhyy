...
<div class="size_lr_bg font posi_a borSH" style="height:41px;top:158px;left:25px;writing-mode:tb-rl;"><p style="height:41px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
