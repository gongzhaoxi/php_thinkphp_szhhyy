...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:20px;width:57px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:20px;width:57px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:114px;width:57px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:114px;width:57px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:208px;width:57px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:208px;width:57px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:302px;width:57px; height:134px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="134"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:215px;left:302px;width:57px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="133"/></div>
</div>
...
<div class="posi_a ov_h" style="top:141px;left:113px;height:45px;width:59px;">
	<div class="size_tb_bg font borDW">
		<p style="width:59px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:20px;height:45px;width:59px;">
	<div class="size_tb_bg font borDW">
		<p style="width:59px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:28px;left:342px;width:60px;height:135px;">
	<div class="size_lr_bg font borDH">
		<p style="height:135px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
