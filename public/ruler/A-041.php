...
<div class="size_lr_bg font posi_a borSH" style="height:42px;top:6px;left:150px;"><p style="height:42px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:132px;top:54px;left:150px;"><p style="height:132px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
