...
<div class="posi_a ov_h" style="top:132px;left:216px;height: 45px;width:68px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:178px;left:250px;width: 60px;height:198px;">
	<div class="size_lr_bg font borDH">
		<p style="height:198px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:117px;left:176px;width: 60px;height:62px;">
	<div class="size_lr_bg font borDH">
		<p style="height:62px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:249px;left:-60px;width: 60px;height:122px;">
	<div class="size_lr_bg font borDH">
