...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:180px;top:377px;left:385px;"><p style="width:180px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:52px;top:9px;left:574px;"><p style="height:52px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
