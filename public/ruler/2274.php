...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:94px;width:150px; height:110px;">
...
<div class="posi_a ov_h" style="top:238px;left:0px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:227px;left:50px;height:45px;width:195px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:278px;left:168px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
		<p style="height:64px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:10px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:25px;left:10px;width:60px;height:76px;">
	<div class="size_lr_bg font borDH">
