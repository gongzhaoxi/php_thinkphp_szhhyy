...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:6px;width:149px; height:204px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="149" height="204"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:6px;width:237px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="237" height="96"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:6px;height: 45px;width:237px;">
	<div class="size_tb_bg font borDW">
		<p style="width:237px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:130px;left:163px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:85px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:120px;left:123px;width: 60px;height:57px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:168px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:168px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
