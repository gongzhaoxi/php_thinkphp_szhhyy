...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:80px;width:129px; height:254px;">
...
<div class="posi_a ov_h" style="top:95px;left:208px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:121px;left:5px;height: 45px;width:70px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:114px;left:15px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:172px;left:4px;width: 60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:4px;width: 60px;height:105px;">
	<div class="size_lr_bg font borDH">
