...
<div style="overflow: hidden;position:absolute; top:289px;left:4px;width:143px; height:57px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="143" height="57"/></div>
</div>
...
<div class="posi_a ov_h" style="top:301px;left:4px;height: 45px;width:143px;">
	<div class="size_tb_bg font borDW">
		<p style="width:143px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:289px;left:88px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:179px;left:87px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
