...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:6px;width:132px; height:267px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="132" height="267"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:6px;width:208px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="208" height="96"/></div>
</div>
...
<div class="posi_a ov_h" style="top:130px;left:143px;height: 45px;width:73px;">
	<div class="size_tb_bg font borDW">
		<p style="width:73px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:6px;height: 45px;width:208px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:176px;left:180px;width: 60px;height:201px;">
	<div class="size_lr_bg font borDH">
		<p style="height:201px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:120px;left:103px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:142px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:142px;width: 60px;height:110px;">
	<div class="size_lr_bg font borDH">
