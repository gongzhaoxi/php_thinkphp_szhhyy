...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:43px;left:25px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:230px;left:25px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:151px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:230px;left:151px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:276px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:230px;left:276px;width:77px; height:104px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="104"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:149px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
		<p style="width:78px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:25px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
		<p style="width:78px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:43px;left:342px;width:60px;height:105px;">
	<div class="size_lr_bg font borDH">
