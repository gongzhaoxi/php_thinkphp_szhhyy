...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:112px;top:-20px;left:8px;"><p style="width:112px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:137px;top:240px;left:-30px;"><p style="height:137px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:8px;left:128px;"><p style="height:119px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:121px;top:248px;left:128px;"><p style="height:121px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_lr_bg font posi_a borSH" style="height:107px;top:134px;left:128px;"><p style="height:107px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
</div>
</div><script>
