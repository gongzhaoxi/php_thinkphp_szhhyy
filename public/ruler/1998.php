...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-5px;left:0px;height: 30px;width:300px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:300px;">
		<p style="width:300px; height: 30px;"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-5px;left:300px;height: 30px;width:300px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:300px;">
		<p style="width:300px; height: 30px;"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:-5px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:600px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:600px;">
		<p style="width:600px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
...
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:25px;top:53px;left:0px;"><p style="width:25px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="font posi_a borSW" style="width:25px;top:53px;left:285px;"><p style="width:25px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p></div>
<div class="font posi_a borSW" style="width:25px;top:53px;left:572px;"><p style="width:25px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:226px;top:300px;left:46px;"><p style="width:226px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:226px;top:20px;left:331px;"><p style="width:226px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:226px;top:343px;left:331px;"><p style="width:226px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<div class="font posi_a borSW" style="width:226px;top:165px;left:331px;"><p style="width:226px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:262px;top:68px;left:46px;writing-mode:tb-rl;"><p style="height:262px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:377px;top:0px;left:600px;writing-mode:tb-rl;"><p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p></div>
