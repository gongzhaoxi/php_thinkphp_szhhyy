...
<div class="posi_a ov_h" style="top:274px;left:0px;height:45px;width:54px;">
	<div class="size_tb_bg font borDW">
		<p style="width:54px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:102px;height:45px;width:97px;">
	<div class="size_tb_bg font borDW">
		<p style="width:97px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:224px;left:54px;height:45px;width:97px;">
	<div class="size_tb_bg font borDW">
		<p style="width:97px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:243px;left:162px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:113px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
