...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:43px;left:62px;width:84px; height:287px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="84" height="287"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:237px;width:82px; height:286px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="286"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:411px;width:84px; height:286px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="84" height="286"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:557px;">
	<div class="size_tb_bg font borDW">
		<p style="width:557px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:557px;width: 60px;height:377px;">
...
<!-- <div class="size_tb_bg font posi_a borSW" style="width:102px;top:377px;left:42px;"><p style="width:102px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div> -->
