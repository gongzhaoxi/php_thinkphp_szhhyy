...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:6px;width:150px; height:229px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="150" height="229"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:264px;left:49px;width:150px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="150" height="84"/></div>
</div>
...
<div class="posi_a ov_h" style="top:262px;left:0px;height: 45px;width:49px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:302px;left:49px;height: 45px;width:150px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:264px;left:140px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
