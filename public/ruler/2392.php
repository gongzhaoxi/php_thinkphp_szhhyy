...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:83px;width:130px; height:204px;">
...
<div class="posi_a ov_h" style="top:241px;left:110px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:6px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:6px;width: 60px;height:110px;">
	<div class="size_lr_bg font borDH">
