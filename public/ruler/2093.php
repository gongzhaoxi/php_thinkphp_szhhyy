...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:47px;left:26px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:26px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:47px;left:143px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:143px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:47px;left:261px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:261px;width:91px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="119"/></div>
</div>
...
<div class="posi_a ov_h" style="top:141px;left:143px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
		<p style="width:94px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:25px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
