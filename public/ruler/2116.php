...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:78px;width:124px; height:235px;">
...
<div class="posi_a ov_h" style="top:329px;left:45px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
		<p style="width:75px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:86px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:176px;width:60px;height:377px;">
...
<div class="posi_a ov_h" style="top:273px;left:86px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
		<p style="height:101px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:159px;left:1px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:1px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
