...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:42px;width:126px; height:204px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:42px;width:164px; height:95px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="164" height="95"/></div>
</div>
...
<div class="posi_a ov_h" style="top:328px;left:42px;height: 45px;width:166px;">
	<div class="size_tb_bg font borDW">
		<p style="width:166px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:90px;left:0px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:288px;left:0px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:288px;left:209px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:226px;left:105px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:-60px;width: 60px;height:97px;">
	<div class="size_lr_bg font borDH">
		<p style="height:97px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:181px;left:174px;width: 60px;height:62px;">
	<div class="size_lr_bg font borDH">
		<p style="height:62px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:174px;width: 60px;height:82px;">
	<div class="size_lr_bg font borDH">
