...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:148px;left:26px;width:60px; height:148px;">
...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:112px;">
	<div class="size_tb_bg font borDW">
		<p style="width:112px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:112px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:64px;top:3px;left:112px;"><p style="height:64px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:24px;top:69px;left:112px;"><p style="height:24px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:150px;top:147px;left:112px;"><p style="height:150px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:64px;top:377px;left:24px;"><p style="width:64px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:19px;top:-20px;left:3px;"><p style="width:19px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:19px;top:377px;left:90px;"><p style="width:19px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
