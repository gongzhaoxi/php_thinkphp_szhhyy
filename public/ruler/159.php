...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:79px;left:42px;width:100px; height:219px;">
...
<div style="overflow: hidden;position:absolute; top:79px;left:185px;width:100px; height:219px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="100" height="219"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:79px;left:327px;width:100px; height:219px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="100" height="219"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:79px;left:470px;width:100px; height:219px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="100" height="219"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:612px;">
	<div class="size_tb_bg font borDW">
		<p style="width:612px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:612px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:102px;top:377px;left:41px;"><p style="width:102px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:32px;top:377px;left:575px;"><p style="width:32px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
