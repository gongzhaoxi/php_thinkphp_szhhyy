...
<div style="overflow: hidden;position:absolute; top:284px;left:61px;width:95px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:299px;left:61px;height: 45px;width:95px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:269px;left:28px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:269px;left:0px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:88px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:117px;left:5px;height: 45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:168px;left:-5px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:32px;left:-5px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
