...
<div class="size_lr_bg font posi_a borSH" style="height:130px;top:33px;left:166px;writing-mode:tb-rl;"><p style="height:130px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:130px;top:214px;left:166px;writing-mode:tb-rl;"><p style="height:130px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:166px;left:153px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
