...
<div style="overflow: hidden;position:absolute; top:294px;left:5px;width:184px; height:53px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="184" height="53"/></div>
</div>
...
<div class="posi_a ov_h" style="top:302px;left:30px;height: 45px;width:184px;">
	<div class="size_tb_bg font borDW">
		<p style="width:184px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:294px;left:129px;width: 60px;height:53px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:25px;left:131px;width: 60px;height:66px;">
	<div class="size_lr_bg font borDH">
