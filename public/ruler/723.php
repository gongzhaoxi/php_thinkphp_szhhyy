...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:62px;top:377px;left:420px;"><p style="width:62px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:492px;">
	<div class="size_tb_bg font borDW">
		<p style="width:492px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:357px;top:10px;left:492px;"><p style="height:357px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:492px;width:60px;height:377px;">
