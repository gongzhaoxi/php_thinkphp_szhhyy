...
<div class="posi_a ov_h" style="top:212px;left:80px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:179px;left:-9px;width: 60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:-9px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
