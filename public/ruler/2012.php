...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:49px;left:21px;width:49px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="49" height="279"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:49px;left:92px;width:49px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="49" height="279"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:49px;left:163px;width:49px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="49" height="279"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:49px;left:235px;width:49px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="49" height="279"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:49px;left:306px;width:49px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="49" height="279"/></div>
</div>
<!-- 标尺寸 -->
