...
<div class="size_lr_bg font posi_a borSH" style="height:86px;top:54px;left:271px;"><p style="height:86px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:118px;top:48px;left:431px;"><p style="height:118px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:269px;top:54px;left:431px;"><p style="height:269px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
