...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:6px;width:123px; height:253px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="123" height="253"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 206px;height: 261px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:206px;height:261px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:206px;">
	<div class="size_tb_bg font borDW">
		<p style="width:206px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:298px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:6px;height:45px;width:196px;">
	<div class="size_tb_bg font borDW">
		<p style="width:196px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:241px;left:6px;height:45px;width:161px;">
	<div class="size_tb_bg font borDW">
		<p style="width:161px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:134px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:168px;left:166px;width:60px;height:209px;">
	<div class="size_lr_bg font borDH">
		<p style="height:209px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:114px;left:166px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:262px;left:130px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:130px;width:60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:130px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
