...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:377px;left:102px;"><p style="width:54px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:166px;">
	<div class="size_tb_bg font borDW">
		<p style="width:166px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:28px;top:4px;left:166px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:166px;"><p style="height:147px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="posi_a ov_h" style="top:0px;left:166px;width:60px;height:377px;">
