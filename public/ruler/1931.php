...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:95px;left:88px;width:114px; height:189px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="114" height="189"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:95px;left:288px;width:114px; height:189px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="114" height="189"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:489px;">
	<div class="size_tb_bg font borDW">
		<p style="width:489px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:489px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:448px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
</div>
</div>
<script>
