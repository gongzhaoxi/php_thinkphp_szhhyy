...
<div class="size_lr_bg font posi_a borSH" style="height:180px;top:6px;left:238px;"><p style="height:180px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:110px;top:6px;left:40px;writing-mode:tb-rl;"><p style="height:110px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:261px;left:40px;writing-mode:tb-rl;"><p style="height:145px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:115px;top:342px;left:75px;"><p style="width:115px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
