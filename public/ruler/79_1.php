...
<div class="size_lr_bg font posi_a borSH" style="height:148px;top:229px;left:308px;"><p style="height:148px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:133px;top:7px;left:267px;writing-mode:tb-rl;"><p style="height:133px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:133px;top:237px;left:267px;writing-mode:tb-rl;"><p style="height:133px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:178px;left:218px;"><p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:147px;left:308px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
