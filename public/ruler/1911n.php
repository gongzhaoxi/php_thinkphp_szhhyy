...
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:377px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:377px;">
		<p style="width:377px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:350px;top:22px;left:-10px;writing-mode:tb-rl;"><p style="height:350px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p></div>
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:18px;top:22px;left:0px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="font posi_a borSW" style="width:19px;top:22px;left:361px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
...
<div class="font posi_a borSW" style="width:158px;top:344px;left:195px;"><p style="width:158px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:263px;top:66px;left:26px;writing-mode:tb-rl;"><p style="height:263px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:377px;top:0px;left:377px;writing-mode:tb-rl;"><p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:263px;top:66px;left:262px;writing-mode:tb-rl;"><p style="height:263px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
