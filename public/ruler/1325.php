...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:256px;">
	<div class="size_tb_bg font borDW">
		<p style="width:256px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:256px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:28px;top:4px;left:256px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:178px;top:7px;left:256px;"><p style="height:178px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:256px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:256px;width:60px;height:377px;">
