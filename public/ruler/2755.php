...
<div class="posi_a ov_h" style="top:168px;left:150px;width: 60px;height:83px;">
	<div class="size_lr_bg font borDH">
		<p style="height:83px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:150px;width: 60px;height:103px;">
	<div class="size_lr_bg font borDH">
		<p style="height:103px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
