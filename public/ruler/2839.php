...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:64px;left:30px;width:83px; height:140px;">
...
<div class="posi_a ov_h" style="top:302px;left:30px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:277px;left:115px;height: 45px;width:30px;">
	<div class="size_tb_bg font borDW">
