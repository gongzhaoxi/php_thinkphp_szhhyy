...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:44px;left:23px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:232px;left:23px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:44px;left:112px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:232px;left:112px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:44px;left:201px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:232px;left:201px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:44px;left:289px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:232px;left:289px;width:66px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="103"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:112px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
		<p style="width:66px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:23px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
		<p style="width:66px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:44px;left:342px;width:60px;height:104px;">
	<div class="size_lr_bg font borDH">
		<p style="height:104px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
