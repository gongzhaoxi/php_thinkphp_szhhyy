...
<div class="size_lr_bg font posi_a borSH" style="height:134px;top:243px;left:160px;"><p style="height:163px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:126px;top:5px;left:130px;writing-mode:tb-rl;"><p style="height:126px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:126px;top:247px;left:130px;writing-mode:tb-rl;"><p style="height:126px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
