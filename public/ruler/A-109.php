...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:179px;top:-20px;left:6px;"><p style="width:179px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:225px;top:-20px;left:190px;"><p style="width:225px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:605px;">
	<div class="size_tb_bg font borDW">
		<p style="width:605px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:6px;left:-30px;"><p style="height:40px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:605px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:275px;top:51px;left:-30px;"><p style="height:275px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
