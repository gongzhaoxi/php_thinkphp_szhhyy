...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:58px;width:91px; height:109px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="109"/></div>
</div>
<!-- 砂网 -->
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:180px;height:243px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:180px;">
	<div class="size_tb_bg font borDW">
		<p style="width:180px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:281px;left:0px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:271px;left:0px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
		<p style="width:56px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div> -->
...
<div class="posi_a ov_h" style="top:194px;left:67px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<!-- <div class="posi_a ov_h" style="top:223px;left:104px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
		<p style="width:94px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:110px;left:5px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:140px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:273px;left:113px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:160px;left:-8px;width:60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:-8px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
