...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:58px;left:72px;width:114px; height:127px;">
...
<div class="posi_a ov_h" style="top:113px;left:219px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:224px;left:41px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
		<p style="width:68px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:5px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:186px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
