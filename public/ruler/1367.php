...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:135px;top:-20px;left:149px;"><p style="width:135px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:104px;top:82px;left:289px;"><p style="height:104px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
