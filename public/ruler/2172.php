...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:32px;left:74px;width:114px; height:179px;">
...
<div class="posi_a ov_h" style="top:74px;left:190px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:193px;left:74px;height:45px;width:116px;">
	<div class="size_tb_bg font borDW">
		<p style="width:116px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
		<p style="width:58px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:38px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:106px;left:-60px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:274px;left:157px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:5px;left:0px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
