...
<!-- 砂网 -->
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:234px;height:243px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:185px;left:-60px;width:60px;height:183px;">
	<div class="size_lr_bg font borDH">
		<p style="height:183px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p>
	</div>
</div>
