...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:78px;width:123px; height:234px;">
...
<div class="posi_a ov_h" style="top:328px;left:5px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:73px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:5px;height:45px;width:67px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:100px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
		<p style="height:101px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:159px;left:2px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:2px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
