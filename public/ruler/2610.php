...
<div style="overflow: hidden;position:absolute; top:276px;left:66px;width:103px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:327px;left:66px;height: 45px;width:103px;">
	<div class="size_tb_bg font borDW">
