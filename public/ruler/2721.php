...
<div style="overflow: hidden;position:absolute; top:284px;left:5px;width:178px; height:60px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="178" height="60"/></div>
</div>
...
<div class="posi_a ov_h" style="top:299px;left:5px;height: 45px;width:178px;">
	<div class="size_tb_bg font borDW">
		<p style="width:178px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:176px;left:60px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:284px;left:124px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
