...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:61px;left:4px;width:95px; height:132px;">
...
<div style="overflow: hidden;position:absolute; top:284px;left:4px;width:152px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="152" height="61"/></div>
</div>
...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height: 45px;width:161px;">
	<div class="size_tb_bg font borDW">
		<p style="width:161px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:299px;left:4px;height: 45px;width:152px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:177px;left:35px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:117px;left:105px;height: 45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:141px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:163px;left:121px;width: 60px;height:214px;">
	<div class="size_lr_bg font borDH">
		<p style="height:214px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:111px;left:65px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:256px;left:-60px;width: 60px;height:118px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:168px;left:94px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:32px;left:94px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
