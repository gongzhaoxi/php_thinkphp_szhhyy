...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:7px;left:43px;width:103px; height:250px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="103" height="250"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:107px;top:264px;left:189px;"><p style="height:107px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:252px;top:6px;left:189px;"><p style="height:252px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:105px;top:-20px;left:42px;"><p style="width:105px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:40px;top:377px;left:6px;"><p style="width:40px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:31px;top:-20px;left:152px;"><p style="width:31px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
