...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:252px;top:-20px;left:266px;"><p style="width:252px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:96px;top:55px;left:230px;"><p style="height:96px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:96px;top:226px;left:230px;"><p style="height:96px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:525px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="size_lr_bg font posi_a borSH" style="height:132px;top:55px;left:525px;"><p style="height:132px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:525px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
