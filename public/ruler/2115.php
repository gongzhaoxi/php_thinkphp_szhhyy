...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:5px;width:124px; height:235px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="124" height="235"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:206px;">
	<div class="size_tb_bg font borDW">
		<p style="width:206px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:329px;left:86px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
		<p style="width:75px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:45px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
		<p style="width:75px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:135px;height:45px;width:67px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:126px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:86px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
