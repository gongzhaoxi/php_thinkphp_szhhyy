...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:93px;left:4px;width:77px; height:191px;">
...
<div style="overflow: hidden;position:absolute; top:93px;left:183px;width:77px; height:191px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="77" height="191"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 266px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:129px;top:-20px;left:3px;"><p style="width:129px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:33px;left:154px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:238px;left:154px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:143px;top:234px;left:266px;"><p style="height:143px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:45px;top:205px;left:87px;"><p style="width:45px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:142px;left:142px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:80px;top:377px;left:3px;"><p style="width:80px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
