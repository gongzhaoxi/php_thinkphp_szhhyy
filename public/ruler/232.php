...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:81px;left:4px;width:59px; height:148px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:23px;top:3px;left:67px;"><p style="height:23px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:64px;top:310px;left:67px;"><p style="height:64px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:150px;top:80px;left:67px;"><p style="height:150px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:61px;top:-20px;left:3px;"><p style="width:61px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:19px;top:377px;left:3px;"><p style="width:19px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
</div>
</div>
<script>
