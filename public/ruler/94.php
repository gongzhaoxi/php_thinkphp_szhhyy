...
<div class="size_lr_bg font posi_a borSH" style="height:155px;top:6px;left:233px;writing-mode:tb-rl;"><p style="height:155px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:131px;top:240px;left:233px;writing-mode:tb-rl;"><p style="height:131px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
