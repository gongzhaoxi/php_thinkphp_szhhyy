...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:59px;left:8px;width:104px; height:260px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="104" height="260"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:59px;left:266px;width:106px; height:259px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="106" height="259"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:59px;left:321px;width:107px; height:260px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="107" height="260"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:59px;left:642px;width:103px; height:260px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="103" height="260"/></div>
</div>
<!-- 砂网 -->
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:255px;height:244px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:753px;">
	<div class="size_tb_bg font borDW">
		<p style="width:753px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:204px;left:213px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:257px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:357px;left:5px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
		<p style="width:100px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:324px;left:266px;height:45px;width:104px;">
	<div class="size_tb_bg font borDW">
		<p style="width:104px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<!-- <div class="posi_a ov_h" style="top:237px;left:41px;height:45px;width:209px;">
	<div class="size_tb_bg font borDW">
		<p style="width:209px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:177px;left:120px;height:45px;width:65px;">
	<div class="size_tb_bg font borDW">
		<p style="width:65px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:733px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:222px;left:-60px;width:60px;height:155px;">
	<div class="size_lr_bg font borDH">
		<p style="height:155px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:152px;width:60px;height:66px;">
	<div class="size_lr_bg font borDH">
		<p style="height:66px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:244px;left:215px;width:60px;height:129px;">
	<div class="size_lr_bg font borDH">
		<p style="height:129px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:289px;left:183px;width:60px;height:82px;">
	<div class="size_lr_bg font borDH">
		<p style="height:82px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:229px;left:191px;width:60px;height:140px;">
	<div class="size_lr_bg font borDH">
		<p style="height:140px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:191px;width:60px;height:140px;">
	<div class="size_lr_bg font borDH">
		<p style="height:140px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
