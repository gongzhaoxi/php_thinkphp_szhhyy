...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:107px;top:81px;left:458px;"><p style="height:107px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
<!-- 中间横 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:50px;top:164px;left:-30px;"><p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:32px;top:6px;left:458px;"><p style="height:32px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:177px;top:81px;left:458px;"><p style="height:177px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
