...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:71px;left:4px;width:97px; height:138px;">
...
<div style="overflow: hidden;position:absolute; top:282px;left:4px;width:97px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="97" height="61"/></div>
</div>
...
<div class="posi_a ov_h" style="top:299px;left:4px;height: 45px;width:97px;">
	<div class="size_tb_bg font borDW">
		<p style="width:97px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:282px;left:102px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
		<p style="width:34px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:209px;left:35px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:231px;left:60px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S0)){$S0='S0';}?><?php echo $S0;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:31px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:107px;height: 45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:188px;left:124px;width: 60px;height:189px;">
	<div class="size_lr_bg font borDH">
		<p style="height:189px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:108px;left:67px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:282px;left:-60px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:282px;left:43px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:193px;left:96px;width: 60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:27px;left:96px;width: 60px;height:77px;">
	<div class="size_lr_bg font borDH">
