...
<div class="size_lr_bg font posi_a borSH" style="height:42px;top:33px;left:25px;writing-mode:tb-rl;"><p style="height:42px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:41px;top:177px;left:25px;writing-mode:tb-rl;"><p style="height:41px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
