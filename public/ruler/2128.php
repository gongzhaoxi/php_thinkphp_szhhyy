...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:75px;width:117px; height:234px;">
...
<div class="posi_a ov_h" style="top:98px;left:192px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:135px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
		<p style="width:61px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:38px;height:45px;width:59px;">
	<div class="size_tb_bg font borDW">
		<p style="width:59px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:6px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:191px;width:60px;height:132px;">
	<div class="size_lr_bg font borDH">
		<p style="height:132px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:95px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:4px;left:0px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
