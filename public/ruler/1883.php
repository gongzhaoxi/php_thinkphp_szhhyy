...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:32px;left:74px;width:80px; height:179px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="80" height="179"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:192px;left:39px;height:45px;width:149px;">
	<div class="size_tb_bg font borDW">
		<p style="width:149px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:5px;left:187px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
