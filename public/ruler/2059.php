...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:64px;width:132px; height:168px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="132" height="168"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:203px;left:64px;width:132px; height:168px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="132" height="168"/></div>
</div>
...
<div class="posi_a ov_h" style="top:56px;left:11px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:153px;left:11px;height:45px;width:187px;">
	<div class="size_tb_bg font borDW">
