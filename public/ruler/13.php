...
<div class="size_lr_bg font posi_a borSH" style="height:123px;top:3px;left:116px;writing-mode:tb-rl;"><p style="height:123px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:35px;top:136px;left:67px;"><p style="width:35px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
