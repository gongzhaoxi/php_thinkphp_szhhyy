...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:225px;">
	<div class="size_tb_bg font borDW">
		<p style="width:225px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:225px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:56px;top:179px;left:53px;"><p style="width:56px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:28px;top:4px;left:225px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:178px;top:7px;left:225px;"><p style="height:178px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:225px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:225px;width:60px;height:377px;">
