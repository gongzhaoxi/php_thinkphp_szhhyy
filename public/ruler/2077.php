...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:3px;left:42px;width:102px; height:171px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="171"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:42px;width:102px; height:171px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="171"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:3px;left:187px;width:102px; height:171px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="171"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:187px;width:102px; height:171px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="171"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:329px;">
	<div class="size_tb_bg font borDW">
		<p style="width:329px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:71px;left:0px;height:45px;width:43px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:43px;height:45px;width:102px;">
	<div class="size_tb_bg font borDW">
		<p style="width:102px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:309px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:3px;left:294px;width:60px;height:173px;">
	<div class="size_lr_bg font borDH">
		<p style="height:173px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:173px;left:208px;width:60px;height:27px;">
	<div class="size_lr_bg font borDH">
		<p style="height:27px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
