...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:46px;left:24px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:24px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:148px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:148px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:273px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:273px;width:81px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="119"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:148px;height:45px;width:84px;">
	<div class="size_tb_bg font borDW">
		<p style="width:84px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:24px;height:45px;width:84px;">
	<div class="size_tb_bg font borDW">
		<p style="width:84px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:46px;left:342px;width:60px;height:122px;">
	<div class="size_lr_bg font borDH">
		<p style="height:122px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
