...
<div class="size_lr_bg font posi_a borSH" style="height:112px;top:265px;left:156px;"><p style="height:112px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:129px;left:127px;writing-mode:tb-rl;"><p style="height:88px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:104px;top:270px;left:127px;writing-mode:tb-rl;"><p style="height:104px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:46px;top:233px;left:106px;"><p style="width:46px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:46px;top:220px;left:156px;"><p style="height:46px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
