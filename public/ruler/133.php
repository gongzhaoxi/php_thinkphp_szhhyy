...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:9px;left:9px;width:144px; height:359px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:361px;top:8px;left:162px;"><p style="height:361px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:146px;top:377px;left:8px;"><p style="width:146px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
