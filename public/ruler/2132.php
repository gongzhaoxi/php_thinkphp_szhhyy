...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:74px;width:117px; height:251px;">
...
<div class="posi_a ov_h" style="top:98px;left:191px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:269px;left:0px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:240px;left:41px;height:45px;width:187px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:262px;left:191px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
		<p style="height:113px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:291px;left:157px;width:60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:0px;width:60px;height:87px;">
	<div class="size_lr_bg font borDH">
