...
<div class="posi_a ov_h" style="top:218px;left:75px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:170px;left:-9px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-9px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
