...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:100px;left:92px;width:71px; height:179px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="71" height="179"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:328px;left:59px;height:45px;width:134px;">
	<div class="size_tb_bg font borDW">
		<p style="width:134px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:138px;left:196px;height:45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:228px;left:-6px;width:60px;height:146px;">
	<div class="size_lr_bg font borDH">
		<p style="height:146px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-6px;width:60px;height:162px;">
	<div class="size_lr_bg font borDH">
		<p style="height:162px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
