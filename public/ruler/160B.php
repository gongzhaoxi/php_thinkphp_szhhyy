...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:56px;left:46px;width:68px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="68" height="169"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 144px;height: 281px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 144px;height: 281px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height: 45px;width:144px;">
...
<div class="posi_a ov_h" style="top:232px;left:47px;height: 45px;width:66px;">
	<div class="size_tb_bg font borDW">
		<p style="width:66px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:286px;left:57px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:281px;left:104px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
