...
<div class="size_lr_bg font posi_a borSH" style="height:104px;top:4px;left:25px;writing-mode:tb-rl;"><p style="height:104px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:160px;left:25px;writing-mode:tb-rl;"><p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
