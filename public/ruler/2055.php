...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:81px;left:64px;width:144px; height:213px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="144" height="213"/></div>
</div>
...
<div class="posi_a ov_h" style="top:98px;left:9px;height:45px;width:48px;">
	<div class="size_tb_bg font borDW">
		<p style="width:48px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:182px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:339px;left:64px;width:60px;height:35px;">
	<div class="size_lr_bg font borDH">
