...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:9px;width:161px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="161" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:9px;width:161px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="161" height="169"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:179px;">
...
<div class="posi_a ov_h" style="top:156px;left:9px;height:45px;width:161px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:6px;left:-26px;width:60px;height:171px;">
	<div class="size_lr_bg font borDH">
