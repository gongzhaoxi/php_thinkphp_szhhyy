...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:7px;width:193px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="193" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:7px;width:193px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="193" height="133"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:207px;">
...
<div class="posi_a ov_h" style="top:142px;left:7px;height:45px;width:193px;">
	<div class="size_tb_bg font borDW">
		<p style="width:193px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:330px;left:7px;height:45px;width:193px;">
	<div class="size_tb_bg font borDW">
		<p style="width:193px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:28px;left:172px;width:60px;height:135px;">
	<div class="size_lr_bg font borDH">
		<p style="height:135px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:216px;left:172px;width:60px;height:135px;">
	<div class="size_lr_bg font borDH">
		<p style="height:135px"><span><?php if(empty($FH1)){$FH1='FH1';}?><?php echo $FH1;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
