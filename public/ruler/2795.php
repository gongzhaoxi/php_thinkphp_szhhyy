...
<div style="overflow: hidden;position:absolute; top:282px;left:4px;width:97px; height:90px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:327px;left:4px;height: 45px;width:97px;">
	<div class="size_tb_bg font borDW">
