...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:135px;top:377px;left:149px;"><p style="width:135px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:291px;">
	<div class="size_tb_bg font borDW">
		<p style="width:291px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:7px;left:291px;"><p style="height:40px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:291px;width:60px;height:377px;">
