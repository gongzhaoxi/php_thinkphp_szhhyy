...
<div class="size_lr_bg font posi_a borSH" style="height:114px;top:9px;left:113px;"><p style="height:114px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:35px;top:7px;left:229px;"><p style="height:35px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:118px;top:48px;left:229px;"><p style="height:118px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:229px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
