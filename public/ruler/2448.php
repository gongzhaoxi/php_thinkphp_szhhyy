...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:37px;left:80px;width:128px; height:190px;">
...
<div class="posi_a ov_h" style="top:266px;left:210px;width: 60px;height:106px;">
	<div class="size_lr_bg font borDH">
		<p style="height:106px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:266px;left:-35px;width: 60px;height:72px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:37px;left:3px;width: 60px;height:55px;">
	<div class="size_lr_bg font borDH">
