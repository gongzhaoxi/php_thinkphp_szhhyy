...
<div class="posi_a ov_h" style="top:216px;left:125px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:163px;left:3px;width: 60px;height:99px;">
	<div class="size_lr_bg font borDH">
		<p style="height:99px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:3px;width: 60px;height:88px;">
	<div class="size_lr_bg font borDH">
