...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:73px;width:109px; height:263px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="109" height="263"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:73px;width:109px; height:95px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="109" height="95"/></div>
</div>
...
<div class="posi_a ov_h" style="top:92px;left:217px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:7px;height: 45px;width:60px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:175px;left:215px;width: 60px;height:202px;">
	<div class="size_lr_bg font borDH">
		<p style="height:202px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:7px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:182px;left:0px;width: 60px;height:89px;">
	<div class="size_lr_bg font borDH">
		<p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:0px;width: 60px;height:109px;">
	<div class="size_lr_bg font borDH">
		<p style="height:109px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
