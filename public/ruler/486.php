...
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:6px;left:153px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:265px;left:153px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
