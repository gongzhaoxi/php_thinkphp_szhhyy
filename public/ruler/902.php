...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:41px;top:377px;left:716px;"><p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:144px;top:7px;left:231px;"><p style="height:144px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:144px;top:226px;left:231px;"><p style="height:144px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:118px;top:7px;left:720px;"><p style="height:118px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:220px;top:55px;left:764px;"><p style="height:220px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:267px;top:55px;left:764px;"><p style="height:267px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
