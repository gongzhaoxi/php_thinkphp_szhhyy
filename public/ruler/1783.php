...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:192px;top:-20px;left:0px;"><p style="width:192px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:118px;top:377px;left:6px;"><p style="width:118px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:574px;">
	<div class="size_tb_bg font borDW">
		<p style="width:574px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:156px;top:7px;left:193px;"><p style="height:156px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:126px;top:244px;left:193px;"><p style="height:126px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div> -->
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:56px;top:179px;left:130px;"><p style="width:56px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:57px;top:160px;left:-30px;"><p style="height:57px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:160px;top:217px;left:-30px;"><p style="height:160px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div> -->
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:25px;top:6px;left:574px;"><p style="height:25px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:574px;"><p style="height:57px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="posi_a ov_h" style="top:0px;left:574px;width:60px;height:377px;">
