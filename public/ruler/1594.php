...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:46px;top:377px;left:10px;"><p style="width:46px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:119px;top:377px;left:228px;"><p style="width:119px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:448px;">
	<div class="size_tb_bg font borDW">
		<p style="width:448px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:10px;left:448px;"><p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:239px;left:448px;"><p style="height:128px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:27px;top:5px;left:448px;"><p style="height:27px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:89px;top:36px;left:448px;"><p style="height:89px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:448px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:448px;width:60px;height:377px;">
