...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:70px;width:109px; height:188px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="109" height="188"/></div>
</div>
...
<div class="posi_a ov_h" style="top:78px;left:213px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:205px;left:119px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:117px;left:5px;height: 45px;width:60px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:256px;left:210px;width: 60px;height:116px;">
	<div class="size_lr_bg font borDH">
		<p style="height:116px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:0px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:0px;width: 60px;height:84px;">
	<div class="size_lr_bg font borDH">
		<p style="height:84px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:0px;width: 60px;height:102px;">
	<div class="size_lr_bg font borDH">
