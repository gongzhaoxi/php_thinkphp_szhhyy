...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:42px;width:128px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="205"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:240px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="97"/></div>
</div>
...
<div class="posi_a ov_h" style="top:328px;left:5px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
