...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 390px;height: 264px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:26px;top:377px;left:360px;"><p style="width:26px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:390px;">
	<div class="size_tb_bg font borDW">
		<p style="width:390px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:390px;width: 60px;height:377px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:43px;top:34px;left:218px;writing-mode:tb-rl;"><p style="height:43px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:52px;top:179px;left:218px;writing-mode:tb-rl;"><p style="height:52px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:202px;top:175px;left:390px;"><p style="height:202px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:45px;top:94px;left:148px;"><p style="width:45px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:81px;left:205px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:81px;top:235px;left:63px;"><p style="width:81px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
