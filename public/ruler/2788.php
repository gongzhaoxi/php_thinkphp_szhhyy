...
<div class="posi_a ov_h" style="top:79px;left:185px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:284px;left:-5px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:-5px;width: 60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:-5px;width: 60px;height:71px;">
	<div class="size_lr_bg font borDH">
