...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:68px;left:32px;width:91px; height:149px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="149"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:287px;left:32px;width:118px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="118" height="84"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:32px;height: 45px;width:118px;">
	<div class="size_tb_bg font borDW">
		<p style="width:118px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:102px;left:89px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
