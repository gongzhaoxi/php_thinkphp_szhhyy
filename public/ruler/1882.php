...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:31px;left:64px;width:103px; height:181px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="103" height="181"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:73px;left:0px;height:45px;width:34px;">
	<div class="size_tb_bg font borDW">
		<p style="width:34px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:270px;left:113px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:192px;left:5px;height:45px;width:222px;">
	<div class="size_tb_bg font borDW">
		<p style="width:222px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:171px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:155px;left:190px;width:60px;height:222px;">
	<div class="size_lr_bg font borDH">
		<p style="height:222px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:106px;left:190px;width:60px;height:49px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:161px;left:160px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:160px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
