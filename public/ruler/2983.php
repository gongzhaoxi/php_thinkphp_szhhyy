...
<div style="overflow: hidden;position:absolute; top:282px;left:33px;width:96px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="96" height="61"/></div>
</div>
...
<div class="posi_a ov_h" style="top:299px;left:33px;height: 45px;width:96px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:282px;left:130px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
		<p style="width:34px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:209px;left:34px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:60px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:282px;left:71px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:26px;left:95px;width: 60px;height:78px;">
	<div class="size_lr_bg font borDH">
