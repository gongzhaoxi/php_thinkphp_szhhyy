...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:39px;top:377px;left:257px;"><p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:303px;">
	<div class="size_tb_bg font borDW">
		<p style="width:303px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:60px;top:179px;left:7px;"><p style="width:60px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:6px;left:303px;"><p style="height:40px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:272px;top:52px;left:303px;"><p style="height:272px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:303px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:303px;width:60px;height:377px;">
