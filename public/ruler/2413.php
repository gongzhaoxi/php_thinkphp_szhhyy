...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:6px;width:149px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="149" height="205"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:6px;width:149px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="149" height="66"/></div>
</div>
...
<div class="posi_a ov_h" style="top:296px;left:6px;height: 45px;width:149px;">
	<div class="size_tb_bg font borDW">
		<p style="width:149px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:283px;left:157px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:202px;height: 45px;width:49px;">
	<div class="size_tb_bg font borDW">
		<p style="width:49px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:162px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:242px;left:85px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
		<p style="height:36px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:342px;left:42px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
		<p style="height:36px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:177px;left:210px;width: 60px;height:200px;">
	<div class="size_lr_bg font borDH">
		<p style="height:200px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:119px;left:123px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:96px;width: 60px;height:68px;">
	<div class="size_lr_bg font borDH">
		<p style="height:68px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:167px;width: 60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:167px;width: 60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
