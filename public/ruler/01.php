...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:22px;top:377px;left:311px;"><p style="width:22px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:168px;top:56px;left:-30px;"><p style="height:168px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:93px;top:280px;left:-30px;"><p style="height:93px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:29px;left:185px;writing-mode:tb-rl;"><p style="height:88px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:163px;left:185px;writing-mode:tb-rl;"><p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
