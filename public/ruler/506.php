...
<div class="size_lr_bg font posi_a borSH" style="height:197px;top:180px;left:-30px;"><p style="height:197px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:67px;top:29px;left:143px;writing-mode:tb-rl;"><p style="height:67px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:68px;top:183px;left:143px;writing-mode:tb-rl;"><p style="height:68px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:22px;top:4px;left:170px;"><p style="height:22px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:170px;top:55px;left:170px;"><p style="height:170px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:94px;top:280px;left:170px;"><p style="height:94px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:40px;top:154px;left:127px;"><p style="width:40px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:99px;left:133px;"><p style="height:40px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
