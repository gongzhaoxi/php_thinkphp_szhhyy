...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:30px;left:6px;width:115px; height:181px;">
...
<div class="posi_a ov_h" style="top:193px;left:5px;height:45px;width:115px;">
	<div class="size_tb_bg font borDW">
		<p style="width:115px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:160px;left:120px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:120px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
