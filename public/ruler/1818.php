...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 377px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:377px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:325px;left:128px;height:45px;width:57px;">
	<div class="size_tb_bg font borDW">
		<p style="width:57px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:325px;left:8px;height:45px;width:113px;">
	<div class="size_tb_bg font borDW">
		<p style="width:113px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:325px;left:257px;height:45px;width:113px;">
	<div class="size_tb_bg font borDW">
		<p style="width:113px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:251px;left:126px;width:60px;height:119px;">
	<div class="size_lr_bg font borDH">
		<p style="height:119px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:228px;left:188px;width:60px;height:142px;">
	<div class="size_lr_bg font borDH">
		<p style="height:142px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:188px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
