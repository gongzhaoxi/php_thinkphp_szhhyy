...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:73px;width:120px; height:276px;">
...
<div class="posi_a ov_h" style="top:98px;left:193px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:297px;left:0px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:38px;height:45px;width:189px;">
	<div class="size_tb_bg font borDW">
		<p style="width:189px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:4px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:283px;left:191px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:157px;width:60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:185px;left:0px;width:60px;height:94px;">
	<div class="size_lr_bg font borDH">
		<p style="height:94px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:0px;width:60px;height:116px;">
	<div class="size_lr_bg font borDH">
