...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:30px;left:82px;width:132px; height:177px;">
...
<div style="overflow: hidden;position:absolute; top:264px;left:82px;width:132px; height:83px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:302px;left:82px;height: 45px;width:132px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:259px;left:40px;height: 45px;width:43px;">
	<div class="size_tb_bg font borDW">
		<p style="width:43px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:259px;left:0px;height: 45px;width:43px;">
	<div class="size_tb_bg font borDW">
		<p style="width:43px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:106px;left:5px;height: 45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:348px;left:110px;width: 60px;height:30px;">
	<div class="size_lr_bg font borDH">
		<p style="height:30px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:152px;left:-60px;width: 60px;height:225px;">
	<div class="size_lr_bg font borDH">
		<p style="height:225px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:103px;left:17px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:238px;left:180px;width: 60px;height:137px;">
	<div class="size_lr_bg font borDH">
		<p style="height:137px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:264px;left:43px;width: 60px;height:84px;">
	<div class="size_lr_bg font borDH">
		<p style="height:84px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:5px;width: 60px;height:52px;">
	<div class="size_lr_bg font borDH">
		<p style="height:52px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:30px;left:5px;width: 60px;height:70px;">
	<div class="size_lr_bg font borDH">
