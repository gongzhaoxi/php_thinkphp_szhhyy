...
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:464px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:464px;">
		<p style="width:464px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:358px;top:19px;left:-10px;writing-mode:tb-rl;"><p style="height:358px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p></div>
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:18px;top:45px;left:0px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="font posi_a borSW" style="width:19px;top:45px;left:441px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:383px;top:319px;left:42px;"><p style="width:383px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:383px;top:20px;left:42px;"><p style="width:383px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:383px;top:356px;left:42px;"><p style="width:383px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<div class="font posi_a borSW" style="width:383px;top:181px;left:42px;"><p style="width:383px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:283px;top:62px;left:42px;writing-mode:tb-rl;"><p style="height:283px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:377px;top:0px;left:464px;writing-mode:tb-rl;"><p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p></div>
