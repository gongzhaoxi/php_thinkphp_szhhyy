...
<div class="posi_a ov_h" style="top:327px;left:54px;height:45px;width:97px;">
	<div class="size_tb_bg font borDW">
		<p style="width:97px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:224px;left:103px;height:45px;width:97px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:113px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:5px;left:2px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
