...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:249px;top:-20px;left:7px;"><p style="width:249px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:313px;top:-20px;left:263px;"><p style="width:313px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:47px;top:165px;left:-30px;"><p style="height:47px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:149px;top:220px;left:-30px;"><p style="height:149px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 右边 -->
