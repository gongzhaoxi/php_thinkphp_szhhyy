...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:93px;left:34px;width:78px; height:192px;">
...
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:30px;">
	<div class="size_tb_bg font borDW">
		<p style="width:30px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:299px;left:35px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
		<p style="width:78px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:329px;left:5px;height:45px;width:156px;">
	<div class="size_tb_bg font borDW">
		<p style="width:156px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:100px;left:117px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:210px;left:124px;width:60px;height:167px;">
	<div class="size_lr_bg font borDH">
		<p style="height:167px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:215px;left:101px;width:60px;height:129px;">
	<div class="size_lr_bg font borDH">
		<p style="height:129px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:101px;width:60px;height:81px;">
	<div class="size_lr_bg font borDH">
		<p style="height:81px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:119px;left:77px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
