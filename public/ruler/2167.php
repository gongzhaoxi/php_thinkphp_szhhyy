...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:32px;left:40px;width:115px; height:178px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="178"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 230px;height: 243px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:230px;height:243px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:276px;left:0px;height:45px;width:51px;">
	<div class="size_tb_bg font borDW">
		<p style="width:51px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:194px;left:40px;height:45px;width:117px;">
	<div class="size_tb_bg font borDW">
		<p style="width:117px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:96px;height:45px;width:86px;">
	<div class="size_tb_bg font borDW">
		<p style="width:86px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:51px;height:45px;width:86px;">
	<div class="size_tb_bg font borDW">
		<p style="width:86px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:109px;left:162px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:190px;width:60px;height:221px;">
	<div class="size_lr_bg font borDH">
		<p style="height:221px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:106px;left:190px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:146px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:101px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:157px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:157px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
