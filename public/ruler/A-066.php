...
<div class="size_lr_bg font posi_a borSH" style="height:362px;top:8px;left:328px;"><p style="height:362px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:121px;top:-20px;left:71px;"><p style="width:121px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
