...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:35px;width:99px; height:231px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="231"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:90px;left:0px;height:45px;width:35px;">
	<div class="size_tb_bg font borDW">
