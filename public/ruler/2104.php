...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:46px;left:18px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:213px;left:18px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:112px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:213px;left:112px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:205px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:213px;left:205px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:299px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:213px;left:299px;width:61px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="119"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:111px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:46px;left:342px;width:60px;height:120px;">
	<div class="size_lr_bg font borDH">
		<p style="height:120px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
