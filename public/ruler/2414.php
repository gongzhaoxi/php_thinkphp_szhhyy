...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:94px;width:149px; height:205px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:94px;width:149px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:296px;left:94px;height: 45px;width:149px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:289px;left:44px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:289px;left:0px;height: 45px;width:49px;">
	<div class="size_tb_bg font borDW">
		<p style="width:49px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:342px;left:132px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:119px;left:29px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:55px;width: 60px;height:68px;">
	<div class="size_lr_bg font borDH">
		<p style="height:68px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:11px;width: 60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:11px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
