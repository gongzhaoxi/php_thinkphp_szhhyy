...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-15px;left:0px;height: 15px;width:359px;">
	<div class="size_tb_bg font borDW" style="height: 15px;width:359px;">
		<p style="width:359px; height: 15px;"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-15px;left:359px;height: 15px;width:265px;">
	<div class="size_tb_bg font borDW" style="height: 15px;width:265px;">
		<p style="width:265px; height: 15px;"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 15px;width:624px;">
	<div class="size_tb_bg font borDW" style="height: 15px;width:624px;">
		<p style="width:624px; height: 15px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
...
<div class="size_tb_bg font posi_a borSW" style="width:158px;top:305px;left:27px;"><p style="width:158px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:158px;top:21px;left:195px;"><p style="width:158px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:112px;top:299px;left:17px;"><p style="width:112px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<!-- 竖向坐标 -->
