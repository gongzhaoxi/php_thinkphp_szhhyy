...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:133px;left:21px;width:54px; height:211px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="211"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:133px;left:115px;width:54px; height:211px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="211"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:133px;left:209px;width:54px; height:211px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="211"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:133px;left:303px;width:54px; height:211px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="211"/></div>
</div>
<!-- 标尺寸 -->
