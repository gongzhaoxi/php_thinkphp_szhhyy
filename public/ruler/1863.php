...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:83px;left:58px;width:57px; height:144px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="144"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 190px;height: 310px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:190px;height:310px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:190px;">
	<div class="size_tb_bg font borDW">
		<p style="width:190px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:300px;left:79px;height:45px;width:31px;">
	<div class="size_tb_bg font borDW">
		<p style="width:31px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:260px;left:31px;height:45px;width:109px;">
	<div class="size_tb_bg font borDW">
		<p style="width:109px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:146px;height:45px;width:44px;">
	<div class="size_tb_bg font borDW">
		<p style="width:44px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:182px;left:150px;width:60px;height:195px;">
	<div class="size_lr_bg font borDH">
		<p style="height:195px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:143px;left:150px;width:60px;height:39px;">
	<div class="size_lr_bg font borDH">
		<p style="height:39px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:310px;left:-60px;width:60px;height:62px;">
	<div class="size_lr_bg font borDH">
		<p style="height:62px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:187px;left:128px;width:60px;height:117px;">
	<div class="size_lr_bg font borDH">
		<p style="height:117px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:128px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
