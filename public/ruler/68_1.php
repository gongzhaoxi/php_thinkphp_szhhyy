...
<div class="size_lr_bg font posi_a borSH" style="height:153px;top:5px;left:198px;writing-mode:tb-rl;"><p style="height:153px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:154px;top:219px;left:198px;writing-mode:tb-rl;"><p style="height:154px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
