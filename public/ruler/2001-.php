...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:165px;left:21px;width:53px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="53" height="148"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:165px;left:115px;width:53px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="53" height="148"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:165px;left:209px;width:53px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="53" height="148"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:165px;left:303px;width:53px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="53" height="148"/></div>
</div>
<!-- 标尺寸 -->
