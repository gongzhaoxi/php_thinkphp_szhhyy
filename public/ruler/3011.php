...
<div style="overflow: hidden;position:absolute; top:287px;left:5px;width:173px; height:85px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="173" height="85"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:5px;height: 45px;width:173px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:215px;left:55px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
