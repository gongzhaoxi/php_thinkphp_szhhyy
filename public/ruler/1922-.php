...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:97px;left:90px;width:112px; height:185px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="112" height="185"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:97px;left:290px;width:112px; height:185px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="112" height="185"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:449px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
</div>
</div>
<script>
