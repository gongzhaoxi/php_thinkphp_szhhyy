...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:37px;left:80px;width:126px; height:190px;">
...
<div class="posi_a ov_h" style="top:163px;left:3px;width: 60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:3px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
