...
<div class="posi_a ov_h" style="top:182px;left:153px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:227px;left:187px;width:60px;height:150px;">
	<div class="size_lr_bg font borDH">
		<p style="height:150px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:152px;left:122px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:234px;left:138px;width:60px;height:136px;">
	<div class="size_lr_bg font borDH">
		<p style="height:136px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:8px;left:138px;width:60px;height:68px;">
	<div class="size_lr_bg font borDH">
		<p style="height:68px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
