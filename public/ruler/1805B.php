...
<div class="posi_a ov_h" style="top:183px;left:155px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:228px;left:188px;width:60px;height:149px;">
	<div class="size_lr_bg font borDH">
		<p style="height:149px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:161px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:235px;left:144px;width:60px;height:136px;">
	<div class="size_lr_bg font borDH">
		<p style="height:136px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:9px;left:144px;width:60px;height:67px;">
	<div class="size_lr_bg font borDH">
