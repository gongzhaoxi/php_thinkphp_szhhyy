...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 194px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:154px;top:33px;left:-30px;"><p style="height:154px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:33px;left:166px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:238px;left:166px;writing-mode:tb-rl;"><p style="height:106px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:26px;top:4px;left:194px;"><p style="height:26px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:193px;top:92px;left:194px;"><p style="height:193px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:44px;top:377px;left:146px;"><p style="width:44px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:142px;left:153px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:80px;top:292px;left:63px;"><p style="width:80px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
