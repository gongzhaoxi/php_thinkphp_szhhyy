...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:94px;width:151px; height:267px;">
...
<div class="posi_a ov_h" style="top:283px;left:200px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:84px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:10px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:10px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
