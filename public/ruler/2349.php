...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:73px;width:116px; height:252px;">
...
<div class="posi_a ov_h" style="top:121px;left:197px;height: 45px;width:65px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:262px;left:200px;width: 60px;height:76px;">
	<div class="size_lr_bg font borDH">
		<p style="height:76px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:192px;width: 60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:192px;width: 60px;height:105px;">
	<div class="size_lr_bg font borDH">
