...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:253px;top:-20px;left:266px;"><p style="width:253px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:37px;top:377px;left:7px;"><p style="width:37px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:184px;top:377px;left:335px;"><p style="width:184px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:526px;">
	<div class="size_tb_bg font borDW">
		<p style="width:526px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:102px;top:48px;left:526px;"><p style="height:102px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:103px;top:226px;left:526px;"><p style="height:103px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:150px;top:36px;left:144px;"><p style="height:150px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:62px;top:179px;left:198px;"><p style="width:62px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:62px;top:157px;left:-30px;"><p style="height:62px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:158px;top:526px;left:-30px;"><p style="height:158px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:34px;top:7px;left:526px;"><p style="height:34px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:89px;top:36px;left:526px;"><p style="height:89px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:526px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:526px;width:60px;height:377px;">
