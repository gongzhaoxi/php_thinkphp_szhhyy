...
<div style="overflow: hidden;position:absolute; top:266px;left:80px;width:127px; height:72px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="127" height="72"/></div>
</div>
...
<div class="posi_a ov_h" style="top:328px;left:125px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:163px;left:2px;width: 60px;height:99px;">
	<div class="size_lr_bg font borDH">
		<p style="height:99px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:2px;width: 60px;height:88px;">
	<div class="size_lr_bg font borDH">
