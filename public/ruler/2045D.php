...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:451px;">
	<div class="size_tb_bg font borDW">
		<p style="width:451px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:0px;height:45px;width:147px;">
	<div class="size_tb_bg font borDW">
		<p style="width:147px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:147px;height:45px;width:155px;">
	<div class="size_tb_bg font borDW">
		<p style="width:155px"><span><?php if(empty($I2)){$I2='I2';}?><?php echo $I2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:303px;height:45px;width:147px;">
	<div class="size_tb_bg font borDW">
		<p style="width:147px"><span><?php if(empty($I1)){$I1='I1';}?><?php echo $I1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:260px;left:6px;height:45px;width:142px;">
	<div class="size_tb_bg font borDW">
		<p style="width:142px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:52px;left:6px;height:45px;width:109px;">
	<div class="size_tb_bg font borDW">
		<p style="width:109px"><span><?php if(empty($Z1)){$Z1='Z1';}?><?php echo $Z1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:260px;left:150px;height:45px;width:150px;">
	<div class="size_tb_bg font borDW">
		<p style="width:150px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:260px;left:308px;height:45px;width:142px;">
	<div class="size_tb_bg font borDW">
		<p style="width:142px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:52px;left:308px;height:45px;width:108px;">
	<div class="size_tb_bg font borDW">
		<p style="width:108px"><span><?php if(empty($R1)){$R1='R1';}?><?php echo $R1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:63px;left:423px;height:45px;width:25px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:280px;left:117px;width:60px;height:81px;">
	<div class="size_lr_bg font borDH">
