...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:169px;top:-20px;left:10px;"><p style="width:169px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:153px;top:23px;left:189px;"><p style="height:153px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
