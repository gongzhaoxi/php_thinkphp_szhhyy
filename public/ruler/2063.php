...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:62px;left:58px;width:119px; height:171px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="119" height="171"/></div>
</div>
...
<div class="posi_a ov_h" style="top:52px;left:10px;height:45px;width:43px;">
	<div class="size_tb_bg font borDW">
		<p style="width:43px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:242px;left:59px;height:45px;width:122px;">
	<div class="size_tb_bg font borDW">
		<p style="width:122px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:294px;left:152px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
