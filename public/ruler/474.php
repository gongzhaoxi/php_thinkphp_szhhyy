...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:160px;left:34px;width:67px; height:183px;">
...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 126px;left: 0;width: 156px;height: 251px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:99px;top:377px;left:4px;"><p style="width:99px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:27px;top:-20px;left:125px;"><p style="width:27px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:122px;top:4px;left:156px;"><p style="height:122px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:79px;top:298px;left:156px;"><p style="height:79px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:72px;top:129px;left:127px;writing-mode:tb-rl;"><p style="height:72px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:71px;top:302px;left:127px;writing-mode:tb-rl;"><p style="height:71px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:46px;top:267px;left:106px;"><p style="width:46px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:46px;top:204px;left:156px;"><p style="height:46px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<p>D：<input type="text" name="D" value="总高-边框+搭接-外框*4-执手高*2-锁位高-上固定高"></p>
