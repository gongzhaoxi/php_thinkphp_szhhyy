...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:192px;">
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:25px;top:6px;left:192px;"><p style="height:25px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:192px;"><p style="height:57px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="posi_a ov_h" style="top:0px;left:192px;width:60px;height:377px;">
