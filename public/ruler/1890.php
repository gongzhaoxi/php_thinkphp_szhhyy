...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:58px;left:64px;width:102px; height:127px;">
...
<div class="posi_a ov_h" style="top:159px;left:161px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:161px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
