...
<div class="size_lr_bg font posi_a borSH" style="height:184px;top:4px;left:194px;"><p style="height:184px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:136px;top:4px;left:23px;writing-mode:tb-rl;"><p style="height:136px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
