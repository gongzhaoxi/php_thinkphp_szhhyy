...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:47px;left:35px;width:121px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="121" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:35px;width:121px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="121" height="119"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:191px;">
	<div class="size_tb_bg font borDW">
		<p style="width:191px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:35px;">
	<div class="size_tb_bg font borDW">
		<p style="width:35px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:164px;left:35px;height:45px;width:123px;">
	<div class="size_tb_bg font borDW">
		<p style="width:123px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:46px;left:156px;width:60px;height:121px;">
	<div class="size_lr_bg font borDH">
