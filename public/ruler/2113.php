...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:101px;left:70px;width:126px; height:225px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="126" height="225"/></div>
</div>
...
<div class="posi_a ov_h" style="top:167px;left:0px;height:45px;width:70px;">
	<div class="size_tb_bg font borDW">
		<p style="width:70px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:310px;left:70px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:3px;left:4px;height:45px;width:257px;">
	<div class="size_tb_bg font borDW">
		<p style="width:257px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
