...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-5px;left:0px;height: 30px;width:241px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:241px;">
		<p style="width:241px; height: 30px;"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-5px;left:240px;height: 30px;width:237px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:237px;">
		<p style="width:237px; height: 30px;"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:718px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:718px;">
		<p style="width:718px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:350px;top:27px;left:-30px;writing-mode:tb-rl;"><p style="height:350px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p></div>
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:18px;top:84px;left:0px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="font posi_a borSW" style="width:19px;top:84px;left:699px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:89px;top:315px;left:29px;"><p style="width:89px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:90px;top:28px;left:364px;"><p style="width:90px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:90px;top:359px;left:364px;"><p style="width:90px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<div class="font posi_a borSW" style="width:90px;top:180px;left:364px;"><p style="width:90px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:268px;top:70px;left:29px;writing-mode:tb-rl;"><p style="height:268px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:377px;top:0px;left:718px;writing-mode:tb-rl;"><p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p></div>
