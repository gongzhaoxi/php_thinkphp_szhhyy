...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:58px;left:80px;width:129px; height:128px;">
...
<div class="posi_a ov_h" style="top:114px;left:209px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:194px;left:80px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
		<p style="width:130px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
		<p style="width:68px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:224px;left:43px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
		<p style="width:68px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:5px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:210px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:273px;left:176px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
		<p style="height:102px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:2px;width:60px;height:82px;">
	<div class="size_lr_bg font borDH">
		<p style="height:82px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:2px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
