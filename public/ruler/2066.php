...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:3px;left:31px;width:115px; height:170px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="170"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:31px;width:115px; height:170px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="170"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:175px;">
	<div class="size_tb_bg font borDW">
		<p style="width:175px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:70px;left:0px;height:45px;width:31px;">
	<div class="size_tb_bg font borDW">
		<p style="width:31px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:157px;left:30px;height:45px;width:118px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:0px;left:-14px;width:60px;height:175px;">
	<div class="size_lr_bg font borDH">
		<p style="height:175px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
