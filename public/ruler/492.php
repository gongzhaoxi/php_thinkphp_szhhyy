...
<div class="size_lr_bg font posi_a borSH" style="height:48px;top:33px;left:139px;writing-mode:tb-rl;"><p style="height:48px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:48px;top:183px;left:139px;writing-mode:tb-rl;"><p style="height:48px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:45px;top:148px;left:118px;"><p style="width:45px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:46px;top:85px;left:167px;"><p style="height:46px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
