...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:79px;width:128px; height:149px;">
...
<div class="posi_a ov_h" style="top:142px;left:209px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:277px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:233px;left:79px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:42px;height:45px;width:205px;">
	<div class="size_tb_bg font borDW">
		<p style="width:205px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:5px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:283px;left:210px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:173px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:2px;width:60px;height:95px;">
	<div class="size_lr_bg font borDH">
		<p style="height:95px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:2px;width:60px;height:116px;">
	<div class="size_lr_bg font borDH">
