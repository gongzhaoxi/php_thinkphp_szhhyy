...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:6px;width:151px; height:254px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="254"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:262px;left:6px;width:240px; height:76px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:121px;left:163px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
		<p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:292px;left:6px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:114px;left:123px;width: 60px;height:55px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:172px;left:167px;width: 60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:167px;width: 60px;height:105px;">
	<div class="size_lr_bg font borDH">
