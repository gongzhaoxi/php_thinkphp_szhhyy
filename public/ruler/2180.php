...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:75px;width:114px; height:194px;">
...
<div class="posi_a ov_h" style="top:83px;left:190px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:250px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:210px;left:75px;height:45px;width:116px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:240px;left:41px;height:45px;width:185px;">
	<div class="size_tb_bg font borDW">
		<p style="width:185px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:6px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:167px;left:-60px;width:60px;height:210px;">
	<div class="size_lr_bg font borDH">
		<p style="height:210px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:114px;left:-60px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:190px;width:60px;height:112px;">
	<div class="size_lr_bg font borDH">
		<p style="height:112px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:290px;left:156px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:1px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:86px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:1px;width:60px;height:106px;">
	<div class="size_lr_bg font borDH">
