...
<div style="overflow: hidden;position:absolute; top:294px;left:30px;width:134px; height:53px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="134" height="53"/></div>
</div>
...
<div class="posi_a ov_h" style="top:302px;left:30px;height: 45px;width:134px;">
	<div class="size_tb_bg font borDW">
		<p style="width:134px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:294px;left:106px;width: 60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:131px;width: 60px;height:73px;">
	<div class="size_lr_bg font borDH">
		<p style="height:73px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:24px;left:131px;width: 60px;height:66px;">
	<div class="size_lr_bg font borDH">
