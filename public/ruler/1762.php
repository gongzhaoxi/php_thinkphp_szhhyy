...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:285px;top:-20px;left:0px;"><p style="width:285px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:175px;top:377px;left:9px;"><p style="width:175px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:853px;">
	<div class="size_tb_bg font borDW">
		<p style="width:853px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:148px;top:9px;left:243px;"><p style="height:148px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:110px;top:258px;left:243px;"><p style="height:110px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:85px;top:197px;left:192px;"><p style="width:85px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:85px;top:165px;left:-30px;"><p style="height:85px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:127px;top:250px;left:-30px;"><p style="height:127px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:37px;top:9px;left:853px;"><p style="height:37px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:853px;"><p style="height:57px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="posi_a ov_h" style="top:0px;left:853px;width:60px;height:377px;">
