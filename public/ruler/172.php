...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:120px;left:51px;width:112px; height:250px;">
...
<div style="overflow: hidden;position:absolute; top:120px;left:214px;width:112px; height:250px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="112" height="250"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:107px;top:6px;left:377px;"><p style="height:107px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:252px;top:119px;left:377px;"><p style="height:252px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:333px;"><p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
