...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:75px;left:5px;width:92px; height:227px;">
...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 160px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:152px;top:-20px;left:4px;"><p style="width:152px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:134px;top:243px;left:160px;"><p style="height:134px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:91px;top:39px;left:130px;writing-mode:tb-rl;"><p style="height:91px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:91px;top:247px;left:130px;writing-mode:tb-rl;"><p style="height:91px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:206px;left:102px;"><p style="width:54px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:53px;top:134px;left:160px;"><p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:94px;top:312px;left:4px;"><p style="width:94px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
...
<p>I：<input type="text" name="I" value="总宽-边框+搭接-外框*2"></p>
<?php
$frame=3; //外框厚度
?>
</div> -->
