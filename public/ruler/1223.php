...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:59px;">
	<div class="size_tb_bg font borDW">
		<p style="width:59px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:29px;top:5px;left:59px;"><p style="height:29px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:59px;width:60px;height:377px;">
