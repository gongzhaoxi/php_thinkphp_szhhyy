...
<div style="overflow: hidden;position:absolute; top:264px;left:71px;width:114px; height:83px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:262px;left:214px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:302px;left:71px;height: 45px;width:114px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:103px;left:15px;width: 60px;height:49px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:264px;left:31px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
