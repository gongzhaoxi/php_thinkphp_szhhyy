...
<div style="overflow: hidden;position:absolute; top:72px;left:164px;width:60px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="60" height="148"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 251px;height: 292px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:142px;top:3px;left:251px;"><p style="height:142px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:86px;top:3px;left:139px;writing-mode:tb-rl;"><p style="height:86px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:123px;top:166px;left:139px;writing-mode:tb-rl;"><p style="height:123px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:35px;top:100px;left:89px;"><p style="width:35px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:92px;left:128px;"><p style="height:35px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
