...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:71px;width:109px; height:179px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="109" height="179"/></div>
</div>
...
<div class="posi_a ov_h" style="top:74px;left:0px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:6px;left:178px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
