...
<div class="posi_a ov_h" style="top:328px;left:63px;height:45px;width:93px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:220px;left:-6px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
		<p style="height:152px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-6px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
