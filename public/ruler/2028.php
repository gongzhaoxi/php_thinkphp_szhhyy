...
<div class="posi_a ov_h" style="top:41px;left:4px;height: 45px;width:183px;">
	<div class="size_tb_bg font borDW">
		<p style="width:183px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:363px;top:7px;left:-30px;"><p style="height:363px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div> -->
