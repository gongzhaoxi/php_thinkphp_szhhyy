...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:50px;top:163px;left:-30px;"><p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:28px;top:5px;left:213px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:225px;top:76px;left:213px;"><p style="height:225px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:213px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
