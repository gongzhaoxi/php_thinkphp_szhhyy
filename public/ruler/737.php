...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:377px;left:767px;"><p style="width:54px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:1022px;">
	<div class="size_tb_bg font borDW">
		<p style="width:1022px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:10px;left:280px;"><p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:239px;left:280px;"><p style="height:128px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:174px;top:10px;left:980px;"><p style="height:174px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:170px;left:675px;"><p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:147px;left:285px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:357px;top:10px;left:1022px;"><p style="height:357px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:1022px;width:60px;height:377px;">
