...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:7px;left:87px;width:128px; height:250px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:107px;top:264px;left:302px;"><p style="height:107px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:252px;top:6px;left:302px;"><p style="height:252px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:130px;top:-20px;left:86px;"><p style="width:130px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:44px;top:377px;left:252px;"><p style="width:44px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:34px;top:-20px;left:262px;"><p style="width:34px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
