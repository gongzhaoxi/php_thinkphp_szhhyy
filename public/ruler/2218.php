...
<div class="posi_a ov_h" style="top:171px;left:-7px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:32px;left:-7px;width:60px;height:78px;">
	<div class="size_lr_bg font borDH">
