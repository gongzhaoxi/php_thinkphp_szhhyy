...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:80px;width:130px; height:149px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="130" height="149"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:95px;left:209px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:186px;left:2px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
		<p style="height:64px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:36px;left:2px;width:60px;height:85px;">
	<div class="size_lr_bg font borDH">
