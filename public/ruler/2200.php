...
<div class="posi_a ov_h" style="top:95px;left:181px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:277px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:33px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
		<p style="width:177px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:5px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:124px;left:-60px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:284px;left:173px;width:60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:316px;left:146px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:-7px;width:60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-7px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
