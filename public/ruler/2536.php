...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:70px;width:110px; height:189px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="110" height="189"/></div>
</div>
...
<div class="posi_a ov_h" style="top:168px;left:0px;width: 60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:0px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
