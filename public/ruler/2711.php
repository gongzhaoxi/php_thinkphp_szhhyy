...
<div style="overflow: hidden;position:absolute; top:276px;left:59px;width:85px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="85" height="96"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:60px;height: 45px;width:85px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:279px;left:0px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:279px;left:146px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:279px;left:173px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:279px;left:27px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
