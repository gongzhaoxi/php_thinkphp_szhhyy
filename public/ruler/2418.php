...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:94px;width:149px; height:204px;">
...
<div class="posi_a ov_h" style="top:130px;left:6px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:120px;left:28px;width: 60px;height:57px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:10px;width: 60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:10px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
