...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:5px;width:131px; height:204px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="131" height="204"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:277px;left:44px;width:131px; height:65px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="131" height="65"/></div>
</div>
...
<div class="posi_a ov_h" style="top:276px;left:117px;width: 60px;height:68px;">
	<div class="size_lr_bg font borDH">
