...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:206px;left:4px;"><p style="width:54px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:53px;top:134px;left:-30px;"><p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
