...
<div class="size_lr_bg font posi_a borSH" style="height:87px;top:99px;left:315px;"><p style="height:87px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:120px;top:4px;left:143px;"><p style="height:120px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
<!-- 中间横 -->
