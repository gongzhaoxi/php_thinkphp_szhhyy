...
<div class="posi_a ov_h" style="top:183px;left:154px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:115px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:235px;left:134px;width:60px;height:136px;">
	<div class="size_lr_bg font borDH">
		<p style="height:136px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:9px;left:134px;width:60px;height:67px;">
	<div class="size_lr_bg font borDH">
