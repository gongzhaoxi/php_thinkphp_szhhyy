...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:37px;left:42px;width:128px; height:190px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="190"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:267px;left:5px;width:240px; height:72px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="72"/></div>
</div>
...
<div class="posi_a ov_h" style="top:294px;left:5px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
		<p style="width:240px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<!-- <div class="posi_a ov_h" style="top:276px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:276px;left:171px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div> -->
...
<div class="posi_a ov_h" style="top:216px;left:86px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:266px;left:-60px;width: 60px;height:106px;">
	<div class="size_lr_bg font borDH">
		<p style="height:106px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:266px;left:185px;width: 60px;height:72px;">
	<div class="size_lr_bg font borDH">
		<p style="height:72px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:163px;left:174px;width: 60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:174px;width: 60px;height:88px;">
	<div class="size_lr_bg font borDH">
		<p style="height:88px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
