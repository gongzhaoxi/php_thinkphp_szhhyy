...
<div class="size_lr_bg font posi_a borSH" style="height:167px;top:210px;left:164px;"><p style="height:167px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:166px;left:12px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
