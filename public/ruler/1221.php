...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
		<p style="width:72px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:36px;top:6px;left:72px;"><p style="height:36px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:72px;width:60px;height:377px;">
