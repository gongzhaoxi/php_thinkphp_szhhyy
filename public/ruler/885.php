...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:41px;top:377px;left:124px;"><p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:172px;">
	<div class="size_tb_bg font borDW">
		<p style="width:172px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:41px;top:7px;left:172px;"><p style="height:41px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:267px;top:55px;left:172px;"><p style="height:267px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:172px;"><p style="height:358px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
