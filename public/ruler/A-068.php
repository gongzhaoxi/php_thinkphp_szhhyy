...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:456px;">
	<div class="size_tb_bg font borDW">
		<p style="width:456px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:233px;top:72px;left:84px;"><p style="height:233px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:456px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:121px;top:-20px;left:7px;"><p style="width:121px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:362px;top:8px;left:456px;"><p style="height:362px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
</div>
</div>
<script>
