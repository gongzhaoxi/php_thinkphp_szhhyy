...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:32px;left:75px;width:115px; height:178px;">
...
<div class="posi_a ov_h" style="top:74px;left:191px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:194px;left:75px;height:45px;width:117px;">
	<div class="size_tb_bg font borDW">
		<p style="width:117px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:51px;height:45px;width:86px;">
	<div class="size_tb_bg font borDW">
		<p style="width:86px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:96px;height:45px;width:86px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:274px;left:101px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
