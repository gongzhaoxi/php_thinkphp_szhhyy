...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:80px;width:128px; height:267px;">
...
<div style="overflow: hidden;position:absolute; top:277px;left:63px;width:123px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:277px;left:216px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:298px;left:63px;height: 45px;width:123px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:120px;left:15px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:24px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:4px;left:3px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
