...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:142px;top:235px;left:-30px;"><p style="height:142px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:152px;top:6px;left:189px;"><p style="height:152px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:130px;top:241px;left:189px;"><p style="height:130px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:71px;top:190px;left:82px;"><p style="width:71px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:72px;top:164px;left:189px;"><p style="height:72px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:24px;top:377px;left:159px;"><p style="width:24px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
</div>
</div>
<script>
