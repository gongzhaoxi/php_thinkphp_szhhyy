...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:59px;left:73px;width:114px; height:127px;">
...
<div class="posi_a ov_h" style="top:247px;left:5px;height:45px;width:215px;">
	<div class="size_tb_bg font borDW">
		<p style="width:215px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:191px;height:45px;width:63px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:270px;left:186px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
