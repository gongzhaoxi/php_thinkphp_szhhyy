...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:7px;width:117px; height:231px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="117" height="231"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:110px;left:132px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:161px;left:127px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
		<p style="height:77px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:127px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
