...
<div class="posi_a ov_h" style="top:84px;left:208px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:172px;left:2px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:2px;width:60px;height:78px;">
	<div class="size_lr_bg font borDH">
