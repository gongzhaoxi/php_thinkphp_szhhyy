...
<div class="posi_a ov_h" style="top:193px;left:5px;height:45px;width:220px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:155px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:155px;width:60px;height:72px;">
	<div class="size_lr_bg font borDH">
