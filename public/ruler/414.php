...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:181px;top:5px;left:-30px;"><p style="height:181px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:5px;left:246px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:261px;left:246px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
