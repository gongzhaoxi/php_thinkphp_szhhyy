...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:66px;left:102px;width:88px; height:243px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="88" height="243"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:66px;left:337px;width:88px; height:243px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="88" height="243"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:478px;"><p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<!-- <div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:492px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div> -->
</div>
</div>
<script>
