...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:31px;left:74px;width:114px; height:181px;">
...
<div class="posi_a ov_h" style="top:194px;left:74px;height:45px;width:114px;">
	<div class="size_tb_bg font borDW">
		<p style="width:114px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:6px;height:45px;width:120px;">
	<div class="size_tb_bg font borDW">
		<p style="width:120px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:68px;height:45px;width:120px;">
	<div class="size_tb_bg font borDW">
		<p style="width:120px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:6px;height:45px;width:63px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:105px;left:-60px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
		<p style="height:51px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:244px;left:152px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:273px;left:90px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:0px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:0px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
