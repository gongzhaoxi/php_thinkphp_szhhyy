...
<div style="overflow: hidden;position:absolute; top:277px;left:44px;width:131px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:120px;left:17px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:5px;width: 60px;height:68px;">
	<div class="size_lr_bg font borDH">
