...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:291px;">
...
<div class="posi_a ov_h" style="top:-30px;left:291px;height: 30px;width:335px;">
...
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-50px;left:0px;height: 50px;width:628px;">
	<div class="size_tb_bg font borDW" style="height: 50px;width:628px;">
		<p style="width:628px; height: 50px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
