...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 118px;height: 281px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 118px;height: 281px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height: 45px;width:118px;">
	<div class="size_tb_bg font borDW">
		<p style="width:118px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:115px;left:0px;height: 45px;width:43px;">
	<div class="size_tb_bg font borDW">
		<p style="width:43px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:232px;left:46px;height: 45px;width:67px;">
	<div class="size_tb_bg font borDW">
		<p style="width:67px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:140px;left:114px;height: 45px;width:31px;">
	<div class="size_tb_bg font borDW">
		<p style="width:31px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:286px;left:58px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
		<p style="width:34px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:121px;left:-60px;width: 60px;height:39px;">
	<div class="size_lr_bg font borDH">
		<p style="height:39px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:281px;left:78px;width: 60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:164px;left:-14px;width: 60px;height:113px;">
	<div class="size_lr_bg font borDH">
		<p style="height:113px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:-14px;width: 60px;height:113px;">
	<div class="size_lr_bg font borDH">
