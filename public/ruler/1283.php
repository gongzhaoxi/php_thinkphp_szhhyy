...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:207px;">
	<div class="size_tb_bg font borDW">
		<p style="width:207px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:118px;top:6px;left:207px;"><p style="height:118px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
