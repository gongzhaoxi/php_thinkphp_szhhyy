...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:24px;left:27px;width:93px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:27px;width:93px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:148px;width:93px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:148px;width:93px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="152"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:268px;">
	<div class="size_tb_bg font borDW">
		<p style="width:268px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:28px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:153px;left:28px;height:45px;width:95px;">
	<div class="size_tb_bg font borDW">
		<p style="width:95px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:248px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:25px;left:233px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
		<p style="height:152px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:176px;left:155px;width:60px;height:27px;">
	<div class="size_lr_bg font borDH">
