...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:66px;left:79px;width:129px; height:110px;">
...
<div class="posi_a ov_h" style="top:115px;left:209px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:245px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:227px;left:42px;height:45px;width:204px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:277px;left:175px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
