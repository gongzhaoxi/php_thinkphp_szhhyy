...
<div class="size_lr_bg font posi_a borSH" style="height:87px;top:99px;left:144px;"><p style="height:87px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:42px;top:178px;left:4px;"><p style="width:42px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
