...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:72px;left:4px;width:60px; height:148px;">
...
<div style="overflow: hidden;position:absolute; top:72px;left:142px;width:60px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="60" height="148"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 205px;height: 292px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:99px;top:-20px;left:3px;"><p style="width:99px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:22px;top:377px;left:180px;"><p style="width:22px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:205px;">
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:205px;width: 60px;height:377px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:76px;top:26px;left:116px;writing-mode:tb-rl;"><p style="height:76px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:89px;top:178px;left:116px;writing-mode:tb-rl;"><p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:202px;top:175px;left:205px;"><p style="height:215px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:34px;top:112px;left:67px;"><p style="width:34px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:104px;left:106px;"><p style="height:35px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:62px;top:224px;left:3px;"><p style="width:62px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
