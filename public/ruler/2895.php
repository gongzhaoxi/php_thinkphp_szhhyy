...
<div style="overflow: hidden;position:absolute; top:288px;left:32px;width:145px; height:58px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="145" height="58"/></div>
</div>
...
<div class="posi_a ov_h" style="top:300px;left:32px;height: 45px;width:145px;">
	<div class="size_tb_bg font borDW">
		<p style="width:145px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:288px;left:118px;width: 60px;height:57px;">
	<div class="size_lr_bg font borDH">
