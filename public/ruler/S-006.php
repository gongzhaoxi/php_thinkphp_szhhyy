...
<div class="size_tb_bg font posi_a borSW" style="width:187px;top:377px;left:189px;"><p style="width:187px"><span><?php if(empty($DW)){$DW='DW';}?><?php echo $DW;?></span></p></div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:153px;top:23px;left:565px;"><p style="height:153px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
