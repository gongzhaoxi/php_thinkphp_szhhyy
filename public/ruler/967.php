...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:39px;top:377px;left:211px;"><p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:257px;">
	<div class="size_tb_bg font borDW">
		<p style="width:257px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:146px;top:6px;left:38px;"><p style="height:146px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:146px;top:225px;left:38px;"><p style="height:146px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:61px;top:179px;left:6px;"><p style="width:61px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:6px;left:257px;"><p style="height:40px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:272px;top:52px;left:257px;"><p style="height:272px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:257px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:257px;width:60px;height:377px;">
