...
<div class="posi_a ov_h" style="top:231px;left:34px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:193px;left:95px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:95px;width: 60px;height:99px;">
	<div class="size_lr_bg font borDH">
