...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:29px;left:23px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:23px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:29px;left:112px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:112px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:29px;left:201px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:201px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:29px;left:289px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:289px;width:66px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="66" height="133"/></div>
</div>
...
<div class="posi_a ov_h" style="top:141px;left:112px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:29px;left:342px;width:60px;height:134px;">
	<div class="size_lr_bg font borDH">
		<p style="height:134px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
