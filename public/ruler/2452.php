...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:80px;width:126px; height:174px;">
...
<div class="posi_a ov_h" style="top:74px;left:209px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:100px;left:5px;height: 45px;width:70px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:89px;left:15px;width: 60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:245px;left:210px;width: 60px;height:128px;">
	<div class="size_lr_bg font borDH">
		<p style="height:128px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:276px;left:-35px;width: 60px;height:66px;">
	<div class="size_lr_bg font borDH">
		<p style="height:66px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:150px;left:3px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:3px;width: 60px;height:52px;">
	<div class="size_lr_bg font borDH">
