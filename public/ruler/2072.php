...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:54px;left:6px;width:160px; height:109px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="160" height="109"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:6px;width:160px; height:109px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="160" height="109"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:172px;">
...
<div class="posi_a ov_h" style="top:142px;left:6px;height:45px;width:162px;">
	<div class="size_tb_bg font borDW">
		<p style="width:162px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:54px;left:137px;width:60px;height:110px;">
	<div class="size_lr_bg font borDH">
		<p style="height:110px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
