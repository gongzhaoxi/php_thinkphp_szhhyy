...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:5px;width:152px; height:207px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="152" height="207"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:152px; height:98px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="152" height="98"/></div>
</div>
...
<div class="posi_a ov_h" style="top:328px;left:6px;height: 45px;width:152px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:285px;left:158px;height: 45px;width:48px;">
	<div class="size_tb_bg font borDW">
		<p style="width:48px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:285px;left:202px;height: 45px;width:48px;">
	<div class="size_tb_bg font borDW">
		<p style="width:48px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:161px;height: 45px;width:85px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:167px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:167px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
