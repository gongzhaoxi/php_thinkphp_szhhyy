...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:57px;left:64px;width:102px; height:127px;">
...
<div class="posi_a ov_h" style="top:270px;left:113px;height:45px;width:44px;">
	<div class="size_tb_bg font borDW">
		<p style="width:44px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:192px;left:35px;height:45px;width:132px;">
	<div class="size_tb_bg font borDW">
		<p style="width:132px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:159px;left:161px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:161px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
