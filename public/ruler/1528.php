...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:103px;top:55px;left:40px;"><p style="height:103px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:89px;top:233px;left:40px;"><p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:62px;top:164px;left:-30px;"><p style="height:62px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:88px;top:36px;left:219px;"><p style="height:88px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
