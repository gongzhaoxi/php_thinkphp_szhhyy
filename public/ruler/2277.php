...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:6px;width:149px; height:110px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="149" height="110"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:303px;left:0px;height:45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:239px;left:7px;height:45px;width:195px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:168px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
