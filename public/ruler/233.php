...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:81px;left:26px;width:60px; height:148px;">
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:64px;top:-20px;left:24px;"><p style="width:64px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:19px;top:-20px;left:90px;"><p style="width:19px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:23px;top:3px;left:112px;"><p style="height:23px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:64px;top:310px;left:112px;"><p style="height:64px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:150px;top:80px;left:112px;"><p style="height:150px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
