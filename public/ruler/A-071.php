...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:840px;">
	<div class="size_tb_bg font borDW">
		<p style="width:840px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:56px;top:8px;left:-30px;"><p style="height:56px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:298px;top:71px;left:-30px;"><p style="height:298px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:233px;top:72px;left:148px;"><p style="height:233px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:840px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_tb_bg font posi_a borSW" style="width:57px;top:377px;left:7px;"><p style="width:57px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:121px;top:-20px;left:72px;"><p style="width:121px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:362px;top:8px;left:840px;"><p style="height:362px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
</div>
</div>
<script>
