...
<div class="size_lr_bg font posi_a borSH" style="height:168px;top:286px;left:-30px;"><p style="height:168px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
