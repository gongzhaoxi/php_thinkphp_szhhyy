...
<div class="size_lr_bg font posi_a borSH" style="height:174px;top:10px;left:530px;"><p style="height:174px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:170px;left:419px;"><p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:357px;top:10px;left:639px;"><p style="height:357px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
