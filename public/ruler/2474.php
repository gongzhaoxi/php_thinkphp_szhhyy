...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:80px;width:126px; height:174px;">
...
<div class="posi_a ov_h" style="top:90px;left:15px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:246px;left:210px;width: 60px;height:128px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:151px;left:4px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:4px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
