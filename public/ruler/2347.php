...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:42px;width:129px; height:254px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="129" height="254"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:262px;left:5px;width:240px; height:76px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="76"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 250px;height: 262px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 250px;height: 262px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:95px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:121px;left:177px;height: 45px;width:70px;">
	<div class="size_tb_bg font borDW">
		<p style="width:70px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:292px;left:5px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:342px;left:85px;width: 60px;height:32px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:114px;left:136px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:262px;left:185px;width: 60px;height:76px;">
	<div class="size_lr_bg font borDH">
		<p style="height:76px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:174px;width: 60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:174px;width: 60px;height:105px;">
	<div class="size_lr_bg font borDH">
