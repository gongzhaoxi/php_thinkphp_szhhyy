...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:95px;width:150px; height:110px;">
...
<div class="posi_a ov_h" style="top:160px;left:10px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:10px;width:60px;height:98px;">
	<div class="size_lr_bg font borDH">
