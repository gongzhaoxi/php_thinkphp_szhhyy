...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:66px;width:99px; height:178px;">
...
<div class="posi_a ov_h" style="top:73px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
		<p style="width:36px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:270px;left:114px;height:45px;width:44px;">
	<div class="size_tb_bg font borDW">
		<p style="width:44px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:192px;left:35px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:172px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:161px;left:160px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
		<p style="height:77px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:160px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
