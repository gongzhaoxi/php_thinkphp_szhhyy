...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:80px;width:127px; height:205px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:80px;width:127px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:327px;left:80px;height: 45px;width:128px;">
	<div class="size_tb_bg font borDW">
		<p style="width:128px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:90px;left:209px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:280px;left:38px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:72px;">
	<div class="size_tb_bg font borDW">
