...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:94px;width:151px; height:230px;">
...
<div class="posi_a ov_h" style="top:106px;left:6px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:103px;left:28px;width: 60px;height:49px;">
	<div class="size_lr_bg font borDH">
		<p style="height:49px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:238px;left:210px;width: 60px;height:136px;">
	<div class="size_lr_bg font borDH">
		<p style="height:136px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:264px;left:-34px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:10px;width: 60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:10px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
