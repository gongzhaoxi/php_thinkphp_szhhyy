...
<div class="size_lr_bg font posi_a borSH" style="height:163px;top:214px;left:194px;"><p style="height:163px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
