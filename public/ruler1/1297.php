...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:27px;top:377px;left:4px;"><p style="width:27px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:247px;">
	<div class="size_tb_bg font borDW">
		<p style="width:247px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:247px;"><p style="height:90px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:247px;width:60px;height:377px;">
