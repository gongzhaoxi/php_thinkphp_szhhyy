...
<div class="posi_a ov_h" style="top:115px;left:209px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:263px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:249px;left:41px;height:45px;width:204px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:297px;left:175px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:24px;left:5px;width:60px;height:76px;">
	<div class="size_lr_bg font borDH">
