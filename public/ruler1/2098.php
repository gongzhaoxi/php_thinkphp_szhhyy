...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:23px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:23px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:4px;left:117px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:117px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:4px;left:211px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:211px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:4px;left:304px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:304px;width:51px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="51" height="169"/></div>
</div>
...
<div class="posi_a ov_h" style="top:155px;left:117px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
		<p style="width:52px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:23px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
		<p style="width:52px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:4px;left:342px;width:60px;height:170px;">
	<div class="size_lr_bg font borDH">
		<p style="height:170px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
