...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:75px;left:63px;width:93px; height:227px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 195px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:195px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:328px;left:6px;height:45px;width:185px;">
	<div class="size_tb_bg font borDW">
		<p style="width:185px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:155px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:170px;left:0px;height:45px;width:57px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:215px;left:-60px;width:60px;height:162px;">
	<div class="size_lr_bg font borDH">
		<p style="height:162px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:162px;left:-60px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:220px;left:-6px;width:60px;height:117px;">
	<div class="size_lr_bg font borDH">
		<p style="height:117px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:40px;left:-6px;width:60px;height:117px;">
	<div class="size_lr_bg font borDH">
