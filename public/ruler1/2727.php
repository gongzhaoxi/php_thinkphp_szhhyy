...
<div class="posi_a ov_h" style="top:181px;left:167px;width: 60px;height:88px;">
	<div class="size_lr_bg font borDH">
		<p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:167px;width: 60px;height:108px;">
	<div class="size_lr_bg font borDH">
		<p style="height:108px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
