...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:66px;left:58px;width:90px; height:128px;">
...
<div style="overflow: hidden;position:absolute; top:289px;left:58px;width:90px; height:57px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:301px;left:58px;height: 45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:278px;left:27px;height: 45px;width:31px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:191px;left:83px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:80px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:129px;left:4px;height: 45px;width:48px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:175px;left:-60px;width: 60px;height:202px;">
	<div class="size_lr_bg font borDH">
		<p style="height:202px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:100px;left:-7px;width: 60px;height:75px;">
	<div class="size_lr_bg font borDH">
		<p style="height:75px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:112px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
		<p style="height:111px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:289px;left:18px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:179px;left:-9px;width: 60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:25px;left:-9px;width: 60px;height:70px;">
	<div class="size_lr_bg font borDH">
