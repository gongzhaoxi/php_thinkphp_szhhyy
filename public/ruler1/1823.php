...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:104px;left:70px;width:110px; height:169px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="110" height="169"/></div>
</div>
<!-- 砂网 -->
...
<div class="posi_a ov_h" style="top:197px;left:0px;height:45px;width:65px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:242px;left:-60px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
		<p style="height:102px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:163px;left:-60px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
		<p style="height:77px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:248px;left:0px;width:60px;height:124px;">
	<div class="size_lr_bg font borDH">
		<p style="height:124px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:0px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
