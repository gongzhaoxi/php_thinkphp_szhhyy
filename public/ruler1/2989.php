...
<div style="overflow: hidden;position:absolute; top:282px;left:4px;width:154px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="154" height="61"/></div>
</div>
...
<div class="posi_a ov_h" style="top:299px;left:4px;height: 45px;width:154px;">
	<div class="size_tb_bg font borDW">
		<p style="width:154px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:209px;left:33px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:282px;left:99px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:193px;left:96px;width: 60px;height:62px;">
	<div class="size_lr_bg font borDH">
