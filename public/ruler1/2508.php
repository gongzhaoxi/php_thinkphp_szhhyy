...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:36px;left:71px;width:109px; height:204px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:71px;width:109px; height:64px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:295px;left:71px;height: 45px;width:109px;">
	<div class="size_tb_bg font borDW">
		<p style="width:109px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:90px;left:212px;height: 45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:274px;left:212px;height: 45px;width:38px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:130px;left:6px;height: 45px;width:60px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:120px;left:5px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:31px;width: 60px;height:65px;">
	<div class="size_lr_bg font borDH">
		<p style="height:65px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:182px;left:0px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:36px;left:0px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
