...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 134px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:127px;top:-20px;left:4px;"><p style="width:127px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:134px;">
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:134px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:26px;top:4px;left:134px;"><p style="height:26px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:193px;top:92px;left:134px;"><p style="height:193px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
...
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:44px;top:206px;left:4px;"><p style="width:44px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:142px;left:-30px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:80px;top:288px;left:51px;"><p style="width:80px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
...
<p>I：<input type="text" name="I" value="锁位高-边框+搭接-外框*2"></p>
<?php
$frame=3; //外框厚度
?>
</div> -->
