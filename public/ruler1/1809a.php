...
<div class="posi_a ov_h" style="top:188px;left:0px;height:45px;width:153px;">
	<div class="size_tb_bg font borDW">
		<p style="width:153px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:167px;left:113px;width:60px;height:67px;">
	<div class="size_lr_bg font borDH">
