...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:6px;width:130px; height:204px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="130" height="204"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:6px;width:207px; height:65px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="207" height="65"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 220px;height: 276px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 220px;height: 276px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:296px;left:6px;height: 45px;width:207px;">
	<div class="size_tb_bg font borDW">
		<p style="width:207px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:130px;left:144px;height: 45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:70px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
		<p style="height:35px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:342px;left:70px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
		<p style="height:36px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:177px;left:180px;width: 60px;height:200px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:276px;left:154px;width: 60px;height:66px;">
	<div class="size_lr_bg font borDH">
		<p style="height:66px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:143px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:143px;width: 60px;height:800px;">
	<div class="size_lr_bg font borDH">
		<p style="height:800px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
