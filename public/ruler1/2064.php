...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:74px;left:57px;width:134px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="134" height="133"/></div>
</div>
<!-- <div style="overflow: hidden;position:absolute; top:204px;left:63px;width:81px; height:146px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="146"/></div>
</div> -->
...
<div class="posi_a ov_h" style="top:47px;left:10px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:236px;left:56px;height:45px;width:138px;">
	<div class="size_tb_bg font borDW">
		<p style="width:138px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:288px;left:165px;width:60px;height:88px;">
	<div class="size_lr_bg font borDH">
		<p style="height:88px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
