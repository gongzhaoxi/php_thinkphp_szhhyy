...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:92px;left:33px;width:79px; height:193px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="79" height="193"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:24px;top:-20px;left:116px;"><p style="width:24px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:195px;top:91px;left:145px;"><p style="height:195px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:84px;top:289px;left:145px;"><p style="height:84px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
