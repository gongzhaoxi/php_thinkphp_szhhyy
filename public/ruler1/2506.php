...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:36px;left:70px;width:108px; height:203px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:70px;width:108px; height:64px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:295px;left:70px;height: 45px;width:108px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:225px;left:125px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:182px;left:0px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:0px;width: 60px;height:110px;">
	<div class="size_lr_bg font borDH">
