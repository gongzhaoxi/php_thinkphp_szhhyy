...
<div class="size_lr_bg font posi_a borSH" style="height:105px;top:81px;left:460px;"><p style="height:105px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:120px;top:5px;left:177px;"><p style="height:120px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
