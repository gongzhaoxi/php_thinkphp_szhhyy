...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:7px;width:150px; height:109px;">
...
<div class="posi_a ov_h" style="top:223px;left:5px;height:45px;width:158px;">
	<div class="size_tb_bg font borDW">
		<p style="width:158px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:243px;left:129px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
