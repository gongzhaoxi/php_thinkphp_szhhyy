...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:24px;left:20px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:20px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:109px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:109px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:200px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:200px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:289px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:289px;width:69px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="151"/></div>
</div>
...
<div class="posi_a ov_h" style="top:153px;left:109px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
		<p style="width:72px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:19px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
		<p style="width:72px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:24px;left:342px;width:60px;height:154px;">
	<div class="size_lr_bg font borDH">
		<p style="height:154px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
