...
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:245px;">
	<div class="size_tb_bg font borDW">
		<p style="width:245px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:129px;left:-30px;"><p style="height:119px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:223px;top:53px;left:245px;"><p style="height:223px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
