...
<div style="overflow: hidden;position:absolute; top:284px;left:5px;width:208px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="208" height="61"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 217px;height: 255px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 217px;height: 255
...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height: 45px;width:217px;">
	<div class="size_tb_bg font borDW">
		<p style="width:217px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:299px;left:5px;height: 45px;width:208px;">
	<div class="size_tb_bg font borDW">
		<p style="width:208px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:79px;left:0px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:205px;left:87px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:117px;left:162px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:163px;left:177px;width: 60px;height:214px;">
	<div class="size_lr_bg font borDH">
		<p style="height:214px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:112px;left:122px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:284px;left:153px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:150px;width: 60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:150px;width: 60px;height:73px;">
	<div class="size_lr_bg font borDH">
