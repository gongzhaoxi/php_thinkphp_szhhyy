...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:43px;left:37px;width:116px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="116" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:37px;width:116px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="116" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:225px;width:116px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="116" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:225px;width:116px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="116" height="105"/></div>
</div>
...
<div class="posi_a ov_h" style="top:49px;left:0px;height:45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:122px;left:37px;height:45px;width:118px;">
	<div class="size_tb_bg font borDW">
		<p style="width:118px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:148px;left:248px;width:60px;height:23px;">
	<div class="size_lr_bg font borDH">
		<p style="height:23px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
