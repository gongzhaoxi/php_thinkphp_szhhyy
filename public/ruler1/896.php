...
<div class="size_lr_bg font posi_a borSH" style="height:118px;top:7px;left:270px;"><p style="height:118px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:63px;top:157px;left:526px;"><p style="height:63px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:157px;top:220px;left:526px;"><p style="height:157px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
