...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:968px;">
	<div class="size_tb_bg font borDW">
		<p style="width:968px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:968px;width: 60px;height:377px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:362px;top:8px;left:968px;"><p style="height:362px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
</div>
</div>
<script>
