...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:72px;left:49px;width:60px; height:148px;">
...
<div style="overflow: hidden;position:absolute; top:72px;left:187px;width:60px; height:148px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="60" height="148"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 296px;height: 292px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:144px;top:-20px;left:3px;"><p style="width:144px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:20px;top:377px;left:273px;"><p style="width:20px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:296px;">
	<div class="size_tb_bg font borDW">
		<p style="width:296px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:296px;width: 60px;height:377px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:26px;left:296px;"><p style="height:119px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:78px;top:26px;left:161px;writing-mode:tb-rl;"><p style="height:78px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:85px;top:181px;left:161px;writing-mode:tb-rl;"><p style="height:85px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:199px;top:178px;left:296px;"><p style="height:199px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:35px;top:115px;left:112px;"><p style="width:35px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:35px;top:107px;left:151px;"><p style="height:35px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:62px;top:224px;left:48px;"><p style="width:62px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
...
<p>FH：<input type="text" name="FH" value="总高-边框*2+搭接*2-外框*9-间距*6-下固定高"></p>
