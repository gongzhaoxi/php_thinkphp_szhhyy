...
<div style="overflow: hidden;position:absolute; top:287px;left:5px;width:172px; height:85px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="172" height="85"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:5px;height: 45px;width:172px;">
	<div class="size_tb_bg font borDW">
