...
<div class="posi_a ov_h" style="top:328px;left:6px;height:45px;width:219px;">
	<div class="size_tb_bg font borDW">
		<p style="width:219px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:41px;left:-6px;width:60px;height:117px;">
	<div class="size_lr_bg font borDH">
