...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:1332px;">
	<div class="size_tb_bg font borDW">
		<p style="width:1332px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:313px;top:32px;left:1332px;"><p style="height:313px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:1332px;width:60px;height:377px;">
