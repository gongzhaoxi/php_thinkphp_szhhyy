...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:29px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:29px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:146px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:146px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:261px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:261px;width:86px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="133"/></div>
</div>
...
<div class="posi_a ov_h" style="top:140px;left:145px;height:45px;width:88px;">
	<div class="size_tb_bg font borDW">
		<p style="width:88px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:30px;height:45px;width:88px;">
	<div class="size_tb_bg font borDW">
		<p style="width:88px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
