...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:43px;left:20px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:20px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:114px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:114px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:208px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:208px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:302px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:302px;width:57px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="57" height="103"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:114px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
		<p style="width:58px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:20px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
		<p style="width:58px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:43px;left:342px;width:60px;height:106px;">
	<div class="size_lr_bg font borDH">
		<p style="height:106px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
