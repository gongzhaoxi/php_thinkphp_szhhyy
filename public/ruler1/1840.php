...
<div class="posi_a ov_h" style="top:328px;left:6px;height:45px;width:226px;">
	<div class="size_tb_bg font borDW">
		<p style="width:226px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:50px;left:2px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
