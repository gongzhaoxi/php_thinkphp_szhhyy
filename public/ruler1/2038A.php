...
<div class="posi_a ov_h" style="top:-60px;left:0px;height:45px;width:377px;">
...
<div class="posi_a ov_h" style="top:-45px;left:279px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
		<p style="width:100px"><span><?php if(empty($W4)){$W4='W4';}?><?php echo $W;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:265px;left:110px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
		<p style="width:71px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:-5px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:174px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:15px;left:359px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
