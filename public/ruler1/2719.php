...
<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:192px; height:64px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="192" height="64"/></div>
</div>
...
<div class="posi_a ov_h" style="top:296px;left:5px;height: 45px;width:192px;">
	<div class="size_tb_bg font borDW">
		<p style="width:192px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:325px;left:80px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:139px;width: 60px;height:64px;">
	<div class="size_lr_bg font borDH">
