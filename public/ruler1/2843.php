...
<div style="overflow: hidden;position:absolute; top:288px;left:32px;width:117px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="117" height="84"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:32px;height: 45px;width:117px;">
	<div class="size_tb_bg font borDW">
		<p style="width:117px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:5px;left:116px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
