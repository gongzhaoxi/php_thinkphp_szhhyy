...
<div class="posi_a ov_h" style="top:-20px;left:332px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:227px;left:332px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($Z1)){$Z1='Z1';}?><?php echo $Z1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:151px;left:189px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
		<p style="width:80px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:227px;left:0px;height:45px;width:186px;">
	<div class="size_tb_bg font borDW">
		<p style="width:186px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:227px;left:189px;height:45px;width:186px;">
	<div class="size_tb_bg font borDW">
		<p style="width:186px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:246px;left:337px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:0px;left:-35px;width:60px;height:167px;">
	<div class="size_lr_bg font borDH">
		<p style="height:137px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:127px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
