...
<div class="size_lr_bg font posi_a borSH" style="height:105px;top:81px;left:272px;"><p style="height:105px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:253px;left:272px;"><p style="height:119px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
