...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:94px;left:35px;width:123px; height:192px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="123" height="192"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:94px;left:190px;width:123px; height:192px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="123" height="192"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:347px;">
	<div class="size_tb_bg font borDW">
		<p style="width:347px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:38px;top:4px;left:-30px;"><p style="height:38px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:347px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:318px;"><p style="width:38px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
