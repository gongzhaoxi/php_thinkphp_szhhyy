...
<div class="posi_a ov_h" style="top:269px;left:123px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:181px;width:60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:26px;left:181px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
