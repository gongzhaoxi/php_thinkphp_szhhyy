...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:9px;width:146px; height:206px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="146" height="206"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:249px;left:9px;width:146px; height:94px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="146" height="94"/></div>
</div>
...
<div class="posi_a ov_h" style="top:110px;left:163px;height: 45px;width:80px;">
	<div class="size_tb_bg font borDW">
		<p style="width:80px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:296px;left:9px;height: 45px;width:147px;">
	<div class="size_tb_bg font borDW">
		<p style="width:147px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:342px;left:44px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
		<p style="height:36px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:230px;width: 60px;height:221px;">
	<div class="size_lr_bg font borDH">
		<p style="height:221px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:103px;left:124px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:218px;left:-60px;width: 60px;height:152px;">
	<div class="size_lr_bg font borDH">
		<p style="height:152px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:249px;left:94px;width: 60px;height:95px;">
	<div class="size_lr_bg font borDH">
		<p style="height:95px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:162px;left:167px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:167px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
