...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:46px;left:71px;width:71px; height:120px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="71" height="120"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:71px;width:71px; height:120px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="71" height="120"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:210px;">
	<div class="size_tb_bg font borDW">
		<p style="width:210 px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:37px;">
	<div class="size_tb_bg font borDW">
		<p style="width:37px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:37px;height:45px;width:139px;">
	<div class="size_tb_bg font borDW">
		<p style="width:139px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:37px;height:45px;width:139px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:46px;left:110px;width:60px;height:122px;">
	<div class="size_lr_bg font borDH">
