...
<div class="posi_a ov_h" style="top:260px;left:0px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:50px;height:45px;width:195px;">
	<div class="size_tb_bg font borDW">
		<p style="width:195px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:6px;height:45px;width:82px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:297px;left:167px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
