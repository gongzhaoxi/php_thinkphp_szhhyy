...
<div class="posi_a ov_h" style="top:211px;left:110px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:151px;left:5px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:5px;width: 60px;height:82px;">
	<div class="size_lr_bg font borDH">
