...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:9px;width:151px; height:146px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="146"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:203px;left:9px;width:151px; height:146px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="146"/></div>
</div>
...
<div class="posi_a ov_h" style="top:152px;left:9px;height:45px;width:153px;">
	<div class="size_tb_bg font borDW">
		<p style="width:153px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
