...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:120px;left:0px;height:45px;width:377px;">
	<div class="size_tb_bg font borDW">
		<p style="width:377px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:0px;height:45px;width:115px;">
	<div class="size_tb_bg font borDW">
		<p style="width:115px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:115px;height:45px;width:151px;">
	<div class="size_tb_bg font borDW">
		<p style="width:151px"><span><?php if(empty($I2)){$I2='I2';}?><?php echo $I2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:266px;height:45px;width:115px;">
	<div class="size_tb_bg font borDW">
		<p style="width:115px"><span><?php if(empty($I1)){$I1='I1';}?><?php echo $I1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:87px;left:6px;height:45px;width:106px;">
	<div class="size_tb_bg font borDW">
		<p style="width:106px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:6px;height:45px;width:87px;">
	<div class="size_tb_bg font borDW">
		<p style="width:87px"><span><?php if(empty($Z1)){$Z1='Z1';}?><?php echo $Z1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:87px;left:117px;height:45px;width:145px;">
	<div class="size_tb_bg font borDW">
		<p style="width:145px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:52px;left:150px;height:45px;width:122px;">
	<div class="size_tb_bg font borDW">
		<p style="width:122px"><span><?php if(empty($M1)){$M1='M1';}?><?php echo $M1;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:87px;left:267px;height:45px;width:109px;">
	<div class="size_tb_bg font borDW">
		<p style="width:109px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:267px;height:45px;width:84px;">
	<div class="size_tb_bg font borDW">
		<p style="width:84px"><span><?php if(empty($R1)){$R1='R1';}?><?php echo $R1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:352px;height:45px;width:25px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:357px;width:60px;height:140px;">
	<div class="size_lr_bg font borDH">
		<p style="height:140px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:107px;left:82px;width:60px;height:31px;">
	<div class="size_lr_bg font borDH">
		<p style="height:31px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:82px;width:60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
