...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:83px;left:56px;width:57px; height:144px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 189px;height: 310px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:189px;height:310px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:300px;left:79px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:260px;left:6px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
		<p style="width:177px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:147px;height:45px;width:43px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:182px;left:149px;width:60px;height:195px;">
	<div class="size_lr_bg font borDH">
		<p style="height:195px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:143px;left:149px;width:60px;height:39px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:187px;left:128px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:128px;width:60px;height:104px;">
	<div class="size_lr_bg font borDH">
