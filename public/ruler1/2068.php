...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:29px;left:42px;width:128px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="133"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:42px;width:128px; height:133px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="133"/></div>
</div>
...
<div class="posi_a ov_h" style="top:236px;left:0px;height:45px;width:43px;">
	<div class="size_tb_bg font borDW">
		<p style="width:43px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:43px;height:45px;width:128px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:28px;left:7px;width:60px;height:136px;">
	<div class="size_lr_bg font borDH">
