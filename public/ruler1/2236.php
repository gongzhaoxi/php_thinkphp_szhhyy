...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:62px;left:79px;width:128px; height:137px;">
...
<div class="posi_a ov_h" style="top:127px;left:208px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:251px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:212px;left:79px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:42px;height:45px;width:205px;">
	<div class="size_tb_bg font borDW">
		<p style="width:205px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:123px;left:5px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:114px;left:-60px;width:60px;height:52px;">
	<div class="size_lr_bg font borDH">
		<p style="height:52px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:261px;left:210px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
		<p style="height:113px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:290px;left:173px;width:60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:2px;width:60px;height:88px;">
	<div class="size_lr_bg font borDH">
		<p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:2px;width:60px;height:108px;">
	<div class="size_lr_bg font borDH">
