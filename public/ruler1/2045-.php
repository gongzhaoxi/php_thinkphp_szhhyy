...
<div class="posi_a ov_h" style="top:-40px;left:0px;height:45px;width:305px;">
	<div class="size_tb_bg font borDW">
		<p style="width:305px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-40px;left:305px;height:45px;width:323px;">
	<div class="size_tb_bg font borDW">
		<p style="width:323px"><span><?php if(empty($I2)){$I2='I2';}?><?php echo $I2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-40px;left:625px;height:45px;width:305px;">
	<div class="size_tb_bg font borDW">
