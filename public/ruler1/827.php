...
<div class="size_lr_bg font posi_a borSH" style="height:132px;top:55px;left:674px;"><p style="height:132px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:118px;top:7px;left:721px;"><p style="height:118px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
