...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:68px;left:73px;width:111px; height:108px;">
...
<div class="posi_a ov_h" style="top:240px;left:0px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:226px;left:39px;height:45px;width:209px;">
	<div class="size_tb_bg font borDW">
		<p style="width:209px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:6px;height:45px;width:58px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:278px;left:183px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:26px;left:0px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
