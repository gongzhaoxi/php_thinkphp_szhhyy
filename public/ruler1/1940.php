...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:94px;left:69px;width:70px; height:191px;">
...
<div style="overflow: hidden;position:absolute; top:94px;left:270px;width:70px; height:191px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="70" height="191"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:407px;">
	<div class="size_tb_bg font borDW">
		<p style="width:407px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:407px;width: 60px;height:377px;">
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:376px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
</div>
</div>
<script>
