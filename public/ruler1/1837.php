...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:49px;left:77px;width:114px; height:279px;">
...
<div class="posi_a ov_h" style="top:326px;left:77px;height:45px;width:112px;">
	<div class="size_tb_bg font borDW">
		<p style="width:112px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:6px;left:2px;width:60px;height:144px;">
	<div class="size_lr_bg font borDH">
