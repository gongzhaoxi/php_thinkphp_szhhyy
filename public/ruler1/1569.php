...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:73px;top:-20px;left:81px;"><p style="width:73px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:28px;top:377px;left:4px;"><p style="width:28px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:159px;">
	<div class="size_tb_bg font borDW">
		<p style="width:159px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:36px;left:54px;"><p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:127px;top:214px;left:54px;"><p style="height:127px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:41px;top:179px;left:36px;"><p style="width:41px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:27px;top:5px;left:159px;"><p style="height:27px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:89px;top:36px;left:159px;"><p style="height:89px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:159px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:159px;width:60px;height:377px;">
