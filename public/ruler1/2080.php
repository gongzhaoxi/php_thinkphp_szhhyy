...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:24px;left:28px;width:99px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:28px;width:99px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:178px;width:99px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:178px;width:99px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="152"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:303px;">
	<div class="size_tb_bg font borDW">
		<p style="width:303px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:81px;left:0px;height:45px;width:27px;">
	<div class="size_tb_bg font borDW">
		<p style="width:27px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:154px;left:27px;height:45px;width:99px;">
	<div class="size_tb_bg font borDW">
		<p style="width:99px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:24px;left:268px;width:60px;height:155px;">
	<div class="size_lr_bg font borDH">
		<p style="height:155px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:178px;left:187px;width:60px;height:25px;">
	<div class="size_lr_bg font borDH">
		<p style="height:25px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
