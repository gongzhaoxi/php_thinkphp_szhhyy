...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:45px;left:27px;width:98px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="98" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:27px;width:98px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="98" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:45px;left:151px;width:98px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="98" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:151px;width:98px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="98" height="121"/></div>
</div>
...
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:27px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:144px;left:27px;height:45px;width:98px;">
	<div class="size_tb_bg font borDW">
		<p style="width:98px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:46px;left:241px;width:60px;height:121px;">
	<div class="size_lr_bg font borDH">
		<p style="height:121px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:163px;width:60px;height:26px;">
	<div class="size_lr_bg font borDH">
