...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:42px;width:128px; height:267px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="267"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:277px;left:64px;width:123px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="123" height="66"/></div>
</div>
...
<div class="posi_a ov_h" style="top:277px;left:0px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:298px;left:64px;height: 45px;width:123px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:128px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
