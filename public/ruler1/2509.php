...
<div class="posi_a ov_h" style="top:187px;left:95px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:179px;width: 60px;height:75px;">
	<div class="size_lr_bg font borDH">
		<p style="height:75px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:179px;width: 60px;height:93px;">
	<div class="size_lr_bg font borDH">
