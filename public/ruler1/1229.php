...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:179px;top:377px;left:198px;"><p style="width:179px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:386px;">
	<div class="size_tb_bg font borDW">
		<p style="width:386px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:52px;top:9px;left:386px;"><p style="height:52px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:386px;width:60px;height:377px;">
