...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:45px;top:377px;left:10px;"><p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:118px;top:377px;left:320px;"><p style="width:118px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:82px;top:179px;left:10px;"><p style="width:82px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
