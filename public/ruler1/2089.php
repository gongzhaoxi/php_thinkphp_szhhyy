...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:26px;left:26px;width:90px; height:150px;">
...
<div style="overflow: hidden;position:absolute; top:202px;left:26px;width:90px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="90" height="150"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:26px;left:144px;width:90px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="90" height="150"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:144px;width:90px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="90" height="150"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:26px;left:261px;width:90px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="90" height="150"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:261px;width:90px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="90" height="150"/></div>
</div>
...
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:27px;">
	<div class="size_tb_bg font borDW">
		<p style="width:27px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:153px;left:144px;height:45px;width:91px;">
	<div class="size_tb_bg font borDW">
		<p style="width:91px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:27px;height:45px;width:91px;">
	<div class="size_tb_bg font borDW">
		<p style="width:91px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:26px;left:342px;width:60px;height:153px;">
	<div class="size_lr_bg font borDH">
