...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:66px;left:66px;width:102px; height:142px;">
...
<div class="posi_a ov_h" style="top:90px;left:169px;height: 45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:281px;left:145px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:164px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
		<p style="height:96px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:276px;left:19px;width: 60px;height:65px;">
	<div class="size_lr_bg font borDH">
