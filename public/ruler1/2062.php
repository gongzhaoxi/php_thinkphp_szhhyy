...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:63px;width:81px; height:146px;">
...
<div class="posi_a ov_h" style="top:56px;left:11px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:11px;height:45px;width:188px;">
	<div class="size_tb_bg font borDW">
		<p style="width:188px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<!-- <div class="posi_a ov_h" style="top:29px;left:134px;width:60px;height:147px;">
	<div class="size_lr_bg font borDH">
		<p style="height:147px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div> -->
<!-- 锁位 -->
</div>
