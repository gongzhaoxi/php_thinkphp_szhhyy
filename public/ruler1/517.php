...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:177px;top:-20px;left:6px;"><p style="width:177px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:131px;top:246px;left:-30px;"><p style="height:131px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:6px;left:189px;"><p style="height:119px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:252px;left:189px;"><p style="height:119px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_lr_bg font posi_a borSH" style="height:117px;top:130px;left:189px;"><p style="height:117px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
</div>
</div>
<script>
