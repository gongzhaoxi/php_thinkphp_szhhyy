...
<!-- 上边 -->
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:35px;top:377px;left:5px;"><p style="width:35px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:234px;top:5px;left:163px;"><p style="height:234px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:129px;top:243px;left:163px;"><p style="height:129px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:58px;top:5px;left:31px;writing-mode:tb-rl;"><p style="height:58px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:54px;top:66px;left:-30px;"><p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:95px;top:377px;left:63px;"><p style="width:95px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
