...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:85px;left:59px;width:141px; height:207px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="141" height="207"/></div>
</div>
...
<div class="posi_a ov_h" style="top:141px;left:9px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:346px;left:60px;width:60px;height:33px;">
	<div class="size_lr_bg font borDH">
		<p style="height:33px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
