...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:42px;width:127px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="127" height="205"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:42px;width:127px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="127" height="97"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:42px;height: 45px;width:128px;">
	<div class="size_tb_bg font borDW">
		<p style="width:128px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:90px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:280px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:280px;left:172px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<!-- <div class="posi_a ov_h" style="top:226px;left:87px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:130px;left:176px;height: 45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<!-- <div class="posi_a ov_h" style="top:276px;left:5px;width: 60px;height:97px;">
	<div class="size_lr_bg font borDH">
