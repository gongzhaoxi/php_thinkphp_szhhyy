...
<!-- 下边 -->
<!-- <div class="size_tb_bg font posi_a borSW" style="width:28px;top:377px;left:475px;"><p style="width:28px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div> -->
...
<div class="size_lr_bg font posi_a borSH" style="height:101px;top:19px;left:208px;"><p style="height:101px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
