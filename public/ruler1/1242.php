...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:135px;top:377px;left:291px;"><p style="width:135px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:40px;top:7px;left:433px;"><p style="height:40px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
