...
<div class="posi_a ov_h" style="top:90px;left:213px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:60px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:-35px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
