...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:231px;top:377px;left:12px;"><p style="width:231px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:168px;top:741px;left:-30px;"><p style="height:168px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div> -->
<!-- 右边 -->
