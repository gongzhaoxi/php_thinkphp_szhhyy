...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:54px;top:377px;left:166px;"><p style="width:54px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:28px;top:4px;left:230px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:358px;top:10px;left:230px;"><p style="height:358px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
