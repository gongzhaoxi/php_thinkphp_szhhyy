...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:118px;top:377px;left:68px;"><p style="width:118px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:57px;top:179px;left:6px;"><p style="width:57px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
