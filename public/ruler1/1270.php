...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:51px;top:377px;left:9px;"><p style="width:51px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:176px;top:9px;left:189px;"><p style="height:176px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
