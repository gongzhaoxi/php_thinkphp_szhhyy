...
<div class="size_lr_bg font posi_a borSH" style="height:135px;top:242px;left:-30px;"><p style="height:135px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:125px;top:5px;left:163px;writing-mode:tb-rl;"><p style="height:125px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:125px;top:247px;left:163px;writing-mode:tb-rl;"><p style="height:125px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
