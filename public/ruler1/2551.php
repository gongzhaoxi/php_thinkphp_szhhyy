...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:70px;width:111px; height:190px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="111" height="190"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:284px;left:5px;width:240px; height:60px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="60"/></div>
</div>
...
<div class="posi_a ov_h" style="top:300px;left:5px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
		<p style="width:240px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:78px;left:0px;height: 45px;width:38px;">
	<div class="size_tb_bg font borDW">
...
<!-- <div class="posi_a ov_h" style="top:281px;left:213px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:283px;left:185px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:179px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
