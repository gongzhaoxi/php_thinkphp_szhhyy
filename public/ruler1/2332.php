...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:79px;width:122px; height:206px;">
...
<div style="overflow: hidden;position:absolute; top:248px;left:79px;width:122px; height:94px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:69px;left:236px;height: 45px;width:44px;">
	<div class="size_tb_bg font borDW">
		<p style="width:44px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:7px;height: 45px;width:65px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:103px;left:11px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:218px;left:240px;width: 60px;height:155px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:162px;left:4px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:4px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
