...
<div class="posi_a ov_h" style="top:234px;left:4px;height:45px;width:157px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:185px;left:97px;width:60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:97px;width:60px;height:84px;">
	<div class="size_lr_bg font borDH">
		<p style="height:84px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
