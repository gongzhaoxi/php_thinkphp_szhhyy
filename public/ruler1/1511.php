...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:105px;top:82px;left:177px;"><p style="height:105px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
...
<div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:112px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
