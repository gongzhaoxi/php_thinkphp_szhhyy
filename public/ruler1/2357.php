...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:6px;width:151px; height:230px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="230"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:264px;left:6px;width:240px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="84"/></div>
</div>
...
<div class="posi_a ov_h" style="top:106px;left:163px;height: 45px;width:83px;">
	<div class="size_tb_bg font borDW">
		<p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:302px;left:6px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:103px;left:123px;width: 60px;height:49px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:264px;left:185px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:167px;width: 60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:167px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
