...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:179px;left:21px;width:54px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:179px;left:115px;width:56px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="56" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:179px;left:209px;width:56px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="56" height="121"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:179px;left:303px;width:54px; height:121px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="54" height="121"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:97px;top:3px;left:377px;"><p style="height:97px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:24px;top:103px;left:377px;"><p style="height:24px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
...
<!-- <div class="size_tb_bg font posi_a borSW" style="width:56px;top:377px;left:115px;"><p style="width:56px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div> -->
<div class="size_tb_bg font posi_a borSW" style="width:262px;top:4px;left:59px;"><p style="width:262px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
