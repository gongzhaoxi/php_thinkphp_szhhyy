...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:45px;width:124px; height:206px;">
...
<div style="overflow: hidden;position:absolute; top:248px;left:45px;width:124px; height:94px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:69px;left:0px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:176px;height: 45px;width:66px;">
	<div class="size_tb_bg font borDW">
		<p style="width:66px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:296px;left:45px;height: 45px;width:125px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:342px;left:65px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
		<p style="height:35px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:155px;left:210px;width: 60px;height:222px;">
	<div class="size_lr_bg font borDH">
		<p style="height:222px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:103px;left:137px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:249px;left:6px;width: 60px;height:94px;">
	<div class="size_lr_bg font borDH">
		<p style="height:94px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:162px;left:174px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:174px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
