...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:71px;width:111px; height:267px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="111" height="267"/></div>
</div>
