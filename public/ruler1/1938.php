...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:93px;left:35px;width:124px; height:191px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="124" height="191"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:93px;left:221px;width:124px; height:191px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="124" height="191"/></div>
</div>
<!-- 标尺寸 -->
...
<!-- <div class="size_tb_bg font posi_a borSW" style="width:115px;top:377px;left:49px;"><p style="width:115px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div> -->
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:349px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
</div>
</div>
<script>
