...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:8px;left:64px;width:147px; height:361px;">
...
<div style="overflow: hidden;position:absolute; top:8px;left:399px;width:147px; height:361px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="147" height="361"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 609px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:49px;top:377px;left:553px;"><p style="width:49px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:89px;top:7px;left:357px;writing-mode:tb-rl;"><p style="height:89px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:282px;left:357px;writing-mode:tb-rl;"><p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:102px;top:275px;left:609px;"><p style="height:102px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:83px;top:215px;left:218px;"><p style="width:83px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:102px;left:335px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:149px;top:377px;left:63px;"><p style="width:149px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
