2578<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:61px;left:61px;width:95px; height:132px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="95" height="132"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:284px;left:32px;width:95px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="95" height="61"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 160px;height: 256px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 160px;height: 256
...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height: 45px;width:160px;">
	<div class="size_tb_bg font borDW">
		<p style="width:160px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:299px;left:32px;height: 45px;width:95px;">
	<div class="size_tb_bg font borDW">
		<p style="width:95px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:269px;left:128px;height: 45px;width:32px;">
	<div class="size_tb_bg font borDW">
		<p style="width:32px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:269px;left:101px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:269px;left:0px;height: 45px;width:32px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:177px;left:88px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:204px;left:58px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S0)){$S0='S0';}?><?php echo $S0;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:58px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:117px;left:4px;height: 45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:140px;width: 60px;height:377px;">
...
<div class="posi_a ov_h" style="top:111px;left:-5px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:256px;left:120px;width: 60px;height:118px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:168px;left:-7px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:32px;left:-7px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
		<p style="height:74px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
