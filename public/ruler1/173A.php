...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:68px;left:71px;width:108px; height:107px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="108" height="107"/></div>
</div>
...
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 250px;height: 244px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:110px;left:186px;height: 45px;width:57px;">
	<div class="size_tb_bg font borDW">
		<p style="width:57px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:193px;left:39px;height: 45px;width:140px;">
	<div class="size_tb_bg font borDW">
		<p style="width:140px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:260px;left:122px;height: 45px;width:48px;">
	<div class="size_tb_bg font borDW">
		<p style="width:48px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:107px;left:210px;width: 60px;height:49px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:161px;left:178px;width: 60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:178px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
