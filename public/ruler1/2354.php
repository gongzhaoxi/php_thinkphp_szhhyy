...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:80px;width:129px; height:266px;">
...
<div class="posi_a ov_h" style="top:277px;left:209px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:5px;height: 45px;width:68px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:3px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
		<p style="height:67px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:2px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:2px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
