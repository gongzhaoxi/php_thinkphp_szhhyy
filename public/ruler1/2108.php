...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:76px;left:76px;width:94px; height:229px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="94" height="229"/></div>
</div>
<!-- 砂网 -->
...
<div class="posi_a ov_h" style="top:288px;left:41px;height:45px;width:128px;">
	<div class="size_tb_bg font borDW">
		<p style="width:128px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:323px;left:5px;height:45px;width:220px;">
	<div class="size_tb_bg font borDW">
		<p style="width:220px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:97px;left:173px;height:45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:215px;left:189px;width:60px;height:158px;">
	<div class="size_lr_bg font borDH">
		<p style="height:158px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:220px;left:162px;width:60px;height:119px;">
	<div class="size_lr_bg font borDH">
		<p style="height:119px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:41px;left:162px;width:60px;height:71px;">
	<div class="size_lr_bg font borDH">
		<p style="height:71px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:158px;left:134px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
