...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:66px;width:102px; height:272px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="272"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 234px;height: 282px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:234px;height:282px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:108px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
		<p style="width:36px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:305px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:264px;left:5px;height:45px;width:194px;">
	<div class="size_tb_bg font borDW">
		<p style="width:194px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:135px;left:174px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:194px;width:60px;height:196px;">
	<div class="size_lr_bg font borDH">
		<p style="height:196px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:123px;left:194px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:-60px;width:60px;height:89px;">
	<div class="size_lr_bg font borDH">
		<p style="height:89px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:165px;width:60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:165px;width:60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:165px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
