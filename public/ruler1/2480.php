...
<div style="overflow: hidden;position:absolute; top:266px;left:80px;width:128px; height:72px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:295px;left:80px;height: 45px;width:128px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:38px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:328px;left:129px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:113px;left:4px;height: 45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:266px;left:40px;width: 60px;height:72px;">
	<div class="size_lr_bg font borDH">
		<p style="height:72px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:163px;left:2px;width: 60px;height:66px;">
	<div class="size_lr_bg font borDH">
		<p style="height:66px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:37px;left:2px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
