...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:59px;left:8px;width:104px; height:261px;">
...
<div style="overflow: hidden;position:absolute; top:59px;left:264px;width:104px; height:261px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="168"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:59px;left:378px;width:104px; height:261px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="168"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:59px;left:640px;width:104px; height:261px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="168"/></div>
</div>
...
<!-- 下边 -->
<!-- <div class="size_tb_bg font posi_a borSW" style="width:24px;top:377px;left:575px;"><p style="width:55px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div> -->
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:753px;">
	<div class="size_tb_bg font borDW">
		<p style="width:753px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:129px;top:9px;left:186px;"><p style="height:129px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:129px;top:239px;left:186px;"><p style="height:129px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:120px;top:4px;left:474px;"><p style="height:120px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:114px;top:9px;left:588px;"><p style="height:114px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div> -->
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:70px;top:167px;left:117px;"><p style="width:70px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:68px;top:155px;left:201px;"><p style="height:68px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:153px;top:222px;left:119px;"><p style="height:153px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:47px;top:9px;left:37px;"><p style="height:47px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:118px;top:48px;left:639px;"><p style="height:118px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:639px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:753px;width:60px;height:377px;">
