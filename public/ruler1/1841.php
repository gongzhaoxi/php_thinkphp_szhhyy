...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:47px;left:70px;width:112px; height:283px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="112" height="283"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 250px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:250px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:328px;left:70px;height:45px;width:145px;">
	<div class="size_tb_bg font borDW">
		<p style="width:145px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:140px;left:214px;height:45px;width:37px;">
	<div class="size_tb_bg font borDW">
		<p style="width:37px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:198px;left:0px;height:45px;width:65px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:164px;left:-60px;width:60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:247px;left:0px;width:60px;height:126px;">
	<div class="size_lr_bg font borDH">
		<p style="height:126px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:0px;width:60px;height:154px;">
	<div class="size_lr_bg font borDH">
