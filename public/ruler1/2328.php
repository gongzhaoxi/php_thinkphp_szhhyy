...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:96px;width:146px; height:206px;">
...
<div style="overflow: hidden;position:absolute; top:249px;left:96px;width:146px; height:94px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:110px;left:9px;height: 45px;width:80px;">
	<div class="size_tb_bg font borDW">
		<p style="width:80px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:296px;left:96px;height: 45px;width:146px;">
	<div class="size_tb_bg font borDW">
		<p style="width:146px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:342px;left:133px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:103px;left:28px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:218px;left:210px;width: 60px;height:152px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:162px;left:14px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:14px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
