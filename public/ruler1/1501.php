...
<div class="size_lr_bg font posi_a borSH" style="height:115px;top:219px;left:105px;"><p style="height:115px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:105px;top:82px;left:381px;"><p style="height:105px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:81px;top:44px;left:381px;"><p style="height:81px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:176px;top:82px;left:213px;"><p style="height:176px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
