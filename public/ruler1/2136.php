...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:234px;">
	<div class="size_tb_bg font borDW">
		<p style="width:231px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:85px;left:199px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
		<p style="width:62px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:222px;left:38px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
		<p style="width:61px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:109px;left:6px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:155px;left:-60px;width:60px;height:222px;">
	<div class="size_lr_bg font borDH">
		<p style="height:222px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:106px;left:-60px;width:60px;height:49px;">
	<div class="size_lr_bg font borDH">
		<p style="height:49px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:243px;left:194px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:273px;left:163px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
