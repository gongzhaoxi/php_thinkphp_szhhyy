...
<div class="posi_a ov_h" style="top:255px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:33px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:297px;left:97px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
		<p style="height:51px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:-7px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:-7px;width:60px;height:72px;">
	<div class="size_lr_bg font borDH">
