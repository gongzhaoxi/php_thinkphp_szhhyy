...
<div class="posi_a ov_h" style="top:213px;left:4px;height:45px;width:157px;">
	<div class="size_tb_bg font borDW">
		<p style="width:157px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:171px;left:97px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:97px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
