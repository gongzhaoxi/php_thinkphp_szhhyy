...
<div class="posi_a ov_h" style="top:102px;left:199px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
		<p style="width:36px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:268px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:240px;left:36px;height:45px;width:194px;">
	<div class="size_tb_bg font borDW">
		<p style="width:194px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:6px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:115px;left:-60px;width:60px;height:52px;">
	<div class="size_lr_bg font borDH">
		<p style="height:52px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:194px;width:60px;height:110px;">
	<div class="size_lr_bg font borDH">
		<p style="height:110px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:291px;left:164px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:0px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:86px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:0px;width:60px;height:104px;">
	<div class="size_lr_bg font borDH">
