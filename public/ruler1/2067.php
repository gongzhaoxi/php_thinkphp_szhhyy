...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:25px;left:46px;width:159px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="159" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:46px;width:159px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="159" height="151"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:251px;">
	<div class="size_tb_bg font borDW">
		<p style="width:251px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:46px;">
	<div class="size_tb_bg font borDW">
		<p style="width:46px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:154px;left:46px;height:45px;width:161px;">
	<div class="size_tb_bg font borDW">
		<p style="width:161px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:26px;left:12px;width:60px;height:153px;">
	<div class="size_lr_bg font borDH">
