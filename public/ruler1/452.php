...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:160px;left:5px;width:67px; height:184px;">
...
<div style="overflow: hidden;position:absolute; top:160px;left:180px;width:67px; height:184px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="184"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 126px;left: 0;width: 251px;height: 251px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:27px;top:-20px;left:220px;"><p style="width:27px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:71px;top:129px;left:151px;writing-mode:tb-rl;"><p style="height:71px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:71px;top:302px;left:151px;writing-mode:tb-rl;"><p style="height:71px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:79px;top:298px;left:251px;"><p style="height:79px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:48px;top:267px;left:76px;"><p style="width:48px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:46px;top:204px;left:138px;"><p style="height:46px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
