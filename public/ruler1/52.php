...
<div class="size_lr_bg font posi_a borSH" style="height:160px;top:3px;left:183px;writing-mode:tb-rl;"><p style="height:160px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:160px;top:214px;left:183px;writing-mode:tb-rl;"><p style="height:160px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:167px;top:210px;left:324px;"><p style="height:167px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
