...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:609px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:81px;top:44px;left:573px;"><p style="height:81px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:81px;left:609px;"><p style="height:106px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:609px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
