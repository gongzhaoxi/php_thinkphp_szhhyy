...
<div style="overflow: hidden;position:absolute; top:276px;left:71px;width:105px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="105" height="96"/></div>
</div>
...
<div class="posi_a ov_h" style="top:225px;left:86px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:174px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:174px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
