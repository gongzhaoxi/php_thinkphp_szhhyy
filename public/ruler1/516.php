...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:146px;top:231px;left:-30px;"><p style="height:146px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:135px;top:6px;left:189px;"><p style="height:135px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:134px;top:237px;left:189px;"><p style="height:134px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:86px;top:178px;left:97px;"><p style="width:86px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:86px;top:146px;left:189px;"><p style="height:86px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
</div>
</div>
<script>
