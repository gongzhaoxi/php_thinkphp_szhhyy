...
<div style="overflow: hidden;position:absolute; top:288px;left:5px;width:172px; height:56px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="172" height="56"/></div>
</div>
...
<div class="posi_a ov_h" style="top:300px;left:5px;height: 45px;width:172px;">
	<div class="size_tb_bg font borDW">
		<p style="width:172px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:288px;left:117px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
