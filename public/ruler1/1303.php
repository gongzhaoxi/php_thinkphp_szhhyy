...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:297px;">
	<div class="size_tb_bg font borDW">
		<p style="width:297px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="posi_a ov_h" style="top:0px;left:297px;width:60px;height:377px;">
