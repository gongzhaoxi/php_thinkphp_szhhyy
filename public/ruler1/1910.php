...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:49px;left:90px;width:113px; height:284px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="113" height="284"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:49px;left:290px;width:113px; height:284px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="113" height="284"/></div>
</div>
<!-- 标尺寸 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:119px;top:5px;left:346px;"><p style="height:119px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_tb_bg font posi_a borSW" style="width:93px;top:377px;left:41px;"><p style="width:93px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div> -->
<div class="size_tb_bg font posi_a borSW" style="width:32px;top:377px;left:448px;"><p style="width:32px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
