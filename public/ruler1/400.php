...
<div class="size_lr_bg font posi_a borSH" style="height:126px;top:5px;left:185px;writing-mode:tb-rl;"><p style="height:126px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:125px;top:247px;left:185px;writing-mode:tb-rl;"><p style="height:125px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:135px;top:242px;left:314px;"><p style="height:135px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:53px;top:134px;left:170px;"><p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
