...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:5px;width:70px; height:187px;">
...
<div style="overflow: hidden;position:absolute; top:33px;left:177px;width:70px; height:187px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="168"/></div>
</div>
...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:27px;top:377px;left:220px;"><p style="width:27px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:103px;top:5px;left:123px;"><p style="height:103px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:88px;top:162px;left:123px;"><p style="height:88px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:45px;top:118px;left:79px;"><p style="width:45px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:111px;left:137px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:221px;top:156px;left:250px;"><p style="height:221px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:23px;top:5px;left:46px;"><p style="height:23px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:117px;top:251px;left:-30px;"><p style="height:117px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:639px;width:60px;height:377px;">
