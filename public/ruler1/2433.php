...
<div style="overflow: hidden;position:absolute; top:266px;left:42px;width:127px; height:72px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:295px;left:42px;height: 45px;width:128px;">
	<div class="size_tb_bg font borDW">
		<p style="width:128px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:85px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:163px;left:174px;width: 60px;height:99px;">
	<div class="size_lr_bg font borDH">
