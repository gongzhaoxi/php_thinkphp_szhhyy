...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:6px;width:123px; height:235px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="123" height="235"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:206px;height:243px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<div class="posi_a ov_h" style="top:301px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:328px;left:5px;height:45px;width:196px;">
	<div class="size_tb_bg font borDW">
		<p style="width:196px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:248px;left:5px;height:45px;width:160px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:155px;left:186px;width:60px;height:222px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:243px;left:166px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:271px;left:130px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
