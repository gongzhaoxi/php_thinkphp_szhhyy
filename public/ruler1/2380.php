...
<div class="posi_a ov_h" style="top:242px;left:132px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:11px;width: 60px;height:89px;">
	<div class="size_lr_bg font borDH">
		<p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:11px;width: 60px;height:110px;">
	<div class="size_lr_bg font borDH">
