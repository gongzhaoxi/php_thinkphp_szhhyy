...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:63px;left:29px;width:68px; height:176px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="68" height="176"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:26px;top:4px;left:126px;"><p style="height:26px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:72px;top:301px;left:126px;"><p style="height:72px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:178px;top:62px;left:126px;"><p style="height:178px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:70px;top:-20px;left:28px;"><p style="width:70px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:21px;top:-20px;left:101px;"><p style="width:21px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
