...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:508px;">
	<div class="size_tb_bg font borDW">
		<p style="width:508px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:0px;height:45px;width:154px;">
	<div class="size_tb_bg font borDW">
		<p style="width:154px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:154px;height:45px;width:205px;">
	<div class="size_tb_bg font borDW">
		<p style="width:205px"><span><?php if(empty($I2)){$I2='I2';}?><?php echo $I2;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:356px;height:45px;width:154px;">
	<div class="size_tb_bg font borDW">
		<p style="width:154px"><span><?php if(empty($I1)){$I1='I1';}?><?php echo $I1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:266px;left:6px;height:45px;width:145px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:266px;left:157px;height:45px;width:196px;">
	<div class="size_tb_bg font borDW">
		<p style="width:196px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:266px;left:358px;height:45px;width:145px;">
	<div class="size_tb_bg font borDW">
		<p style="width:145px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:358px;height:45px;width:114px;">
	<div class="size_tb_bg font borDW">
		<p style="width:114px"><span><?php if(empty($R1)){$R1='R1';}?><?php echo $R1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:86px;left:476px;height:45px;width:25px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:287px;left:137px;width:60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:137px;width:60px;height:257px;">
	<div class="size_lr_bg font borDH">
		<p style="height:257px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
