...
<div class="posi_a ov_h" style="top:238px;left:9px;height:45px;width:46px;">
	<div class="size_tb_bg font borDW">
		<p style="width:46px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:238px;left:145px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
		<p style="width:40px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:62px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
		<p style="width:75px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:214px;left:77px;width:60px;height:157px;">
	<div class="size_lr_bg font borDH">
		<p style="height:157px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
