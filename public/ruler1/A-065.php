...
<div class="size_lr_bg font posi_a borSH" style="height:298px;top:8px;left:200px;"><p style="height:298px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:121px;top:377px;left:71px;"><p style="width:121px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
