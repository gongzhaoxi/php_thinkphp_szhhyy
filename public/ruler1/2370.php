...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:80px;width:128px; height:266px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:80px;width:95px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:95px;left:209px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:209px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:80px;height: 45px;width:95px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:4px;width: 60px;height:89px;">
	<div class="size_lr_bg font borDH">
