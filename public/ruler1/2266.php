...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:94px;width:150px; height:109px;">
...
<div class="posi_a ov_h" style="top:223px;left:88px;height:45px;width:158px;">
	<div class="size_tb_bg font borDW">
		<p style="width:158px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:7px;height:45px;width:82px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:129px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:11px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:25px;left:11px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
