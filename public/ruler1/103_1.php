...
<div class="size_lr_bg font posi_a borSH" style="height:59px;top:158px;left:127px;writing-mode:tb-rl;"><p style="height:59px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:74px;top:270px;left:127px;writing-mode:tb-rl;"><p style="height:74px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
