...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:86px;left:70px;width:72px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="205"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:86px;left:246px;width:72px; height:205px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="72" height="205"/></div>
</div>
<!-- 标尺寸 -->
