...
<div class="posi_a ov_h" style="top:78px;left:214px;height: 45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:205px;left:125px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:283px;left:-35px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:0px;width: 60px;height:84px;">
	<div class="size_lr_bg font borDH">
