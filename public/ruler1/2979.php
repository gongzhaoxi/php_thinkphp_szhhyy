...
<div style="overflow: hidden;position:absolute; top:289px;left:4px;width:90px; height:57px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:301px;left:4px;height: 45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:278px;left:95px;height: 45px;width:31px;">
	<div class="size_tb_bg font borDW">
		<p style="width:31px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:191px;left:31px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:28px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:289px;left:35px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
