...
<div class="size_lr_bg font posi_a borSH" style="height:74px;top:33px;left:128px;writing-mode:tb-rl;"><p style="height:74px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:59px;top:160px;left:128px;writing-mode:tb-rl;"><p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
