...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:75px;left:63px;width:92px; height:227px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 229px;height: 377px;'></div>";
}
?>
...
<div class="posi_a ov_h" style="top:328px;left:62px;height:45px;width:127px;">
	<div class="size_tb_bg font borDW">
		<p style="width:127px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:141px;left:190px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:220px;left:-6px;width:60px;height:151px;">
	<div class="size_lr_bg font borDH">
		<p style="height:151px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:-6px;width:60px;height:151px;">
	<div class="size_lr_bg font borDH">
		<p style="height:151px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
