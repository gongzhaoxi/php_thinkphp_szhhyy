...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:10px;left:25px;"><p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:128px;top:239px;left:25px;"><p style="height:128px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:83px;top:147px;left:35px;"><p style="height:83px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
