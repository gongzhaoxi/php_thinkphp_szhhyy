...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:84px;width:132px; height:267px;">
...
<div class="posi_a ov_h" style="top:130px;left:6px;height: 45px;width:73px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:180px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:5px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:5px;width: 60px;height:110px;">
	<div class="size_lr_bg font borDH">
