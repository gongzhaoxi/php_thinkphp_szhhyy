...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:73px;width:115px; height:193px;">
...
<div class="posi_a ov_h" style="top:250px;left:0px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:210px;left:6px;height:45px;width:180px;">
	<div class="size_tb_bg font borDW">
		<p style="width:180px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:240px;left:40px;height:45px;width:148px;">
	<div class="size_tb_bg font borDW">
		<p style="width:148px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:6px;height:45px;width:63px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:261px;left:152px;width:60px;height:112px;">
	<div class="size_lr_bg font borDH">
		<p style="height:112px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:290px;left:120px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:0px;width:60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:0px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
