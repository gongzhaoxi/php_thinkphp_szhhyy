...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:51px;left:127px;width:96px; height:270px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="96" height="270"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 321px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:321px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:321px;">
	<div class="size_tb_bg font borDW">
		<p style="width:321px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:323px;left:82px;height:45px;width:185px;">
	<div class="size_tb_bg font borDW">
		<p style="width:185px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:139px;left:270px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
		<p style="width:52px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:187px;left:0px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:232px;left:-60px;width:60px;height:145px;">
	<div class="size_lr_bg font borDH">
		<p style="height:145px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:-60px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
		<p style="height:64px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:241px;left:5px;width:60px;height:124px;">
	<div class="size_lr_bg font borDH">
		<p style="height:124px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:9px;left:5px;width:60px;height:146px;">
	<div class="size_lr_bg font borDH">
		<p style="height:146px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
