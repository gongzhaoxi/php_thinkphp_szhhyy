...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:58px;left:5px;width:120px; height:128px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="120" height="128"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:192px;left:5px;height:45px;width:190px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:126px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:126px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
