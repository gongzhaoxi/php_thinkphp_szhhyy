...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:42px;width:128px; height:266px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="128" height="266"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:76px;width:95px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="95" height="97"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:76px;height: 45px;width:95px;">
	<div class="size_tb_bg font borDW">
