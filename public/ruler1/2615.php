...
<div style="overflow: hidden;position:absolute; top:276px;left:36px;width:102px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="102" height="97"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:36px;height: 45px;width:102px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:195px;left:38px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
