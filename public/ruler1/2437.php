...
<div class="posi_a ov_h" style="top:298px;left:42px;height: 45px;width:128px;">
	<div class="size_tb_bg font borDW">
		<p style="width:128px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:75px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:261px;left:0px;height: 45px;width:42px;">
	<div class="size_tb_bg font borDW">
