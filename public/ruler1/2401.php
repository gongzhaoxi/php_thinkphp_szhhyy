...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:5px;width:130px; height:204px;">
...
<div style="overflow: hidden;position:absolute; top:277px;left:44px;width:131px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="131" height="96"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:44px;height: 45px;width:131px;">
	<div class="size_tb_bg font borDW">
		<p style="width:131px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:282px;left:0px;height: 45px;width:44px;">
	<div class="size_tb_bg font borDW">
		<p style="width:44px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:143px;height: 45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:242px;left:70px;width: 60px;height:35px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:120px;left:104px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
...
<!-- <div class="posi_a ov_h" style="top:276px;left:155px;width: 60px;height:68px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:35px;left:143px;width: 60px;height:81px;">
	<div class="size_lr_bg font borDH">
