...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:28px;left:38px;width:115px; height:135px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="135"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:38px;width:115px; height:135px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="135"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:28px;left:225px;width:115px; height:135px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="135"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:216px;left:225px;width:115px; height:135px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="115" height="135"/></div>
</div>
...
<div class="posi_a ov_h" style="top:49px;left:0px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:143px;left:38px;height:45px;width:117px;">
	<div class="size_tb_bg font borDW">
		<p style="width:117px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:162px;left:244px;width:60px;height:30px;">
	<div class="size_lr_bg font borDH">
