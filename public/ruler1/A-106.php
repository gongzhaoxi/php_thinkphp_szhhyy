...
<!-- 上边 -->
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:282px;">
	<div class="size_tb_bg font borDW">
		<p style="width:282px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:282px;width: 60px;height:377px;">
