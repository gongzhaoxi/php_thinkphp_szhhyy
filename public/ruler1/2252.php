...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:62px;left:73px;width:113px; height:136px;">
...
<div class="posi_a ov_h" style="top:126px;left:219px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:252px;left:0px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:39px;height:45px;width:214px;">
	<div class="size_tb_bg font borDW">
		<p style="width:214px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:122px;left:5px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:262px;left:218px;width:60px;height:111px;">
	<div class="size_lr_bg font borDH">
		<p style="height:111px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:291px;left:186px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
