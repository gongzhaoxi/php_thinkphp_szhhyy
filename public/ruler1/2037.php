...
<!-- <div class="posi_a ov_h" style="top:76px;left:145px;height:45px;width:45px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:147px;left:191px;height:45px;width:64px;">
	<div class="size_tb_bg font borDW">
		<p style="width:64px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:20px;left:0px;height:45px;width:118px;">
	<div class="size_tb_bg font borDW">
		<p style="width:118px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:20px;left:258px;height:45px;width:118px;">
	<div class="size_tb_bg font borDW">
		<p style="width:118px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="posi_a ov_h" style="top:236px;left:337px;width:60px;height:139px;">
	<div class="size_lr_bg font borDH">
		<p style="height:139px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:236px;left:156px;width:60px;height:139px;">
	<div class="size_lr_bg font borDH">
		<p style="height:139px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:156px;width:60px;height:163px;">
	<div class="size_lr_bg font borDH">
		<p style="height:163px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:166px;left:83px;width:60px;height:66px;">
	<div class="size_lr_bg font borDH">
