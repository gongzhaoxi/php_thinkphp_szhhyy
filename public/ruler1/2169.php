...
<div class="posi_a ov_h" style="top:194px;left:6px;height:45px;width:218px;">
	<div class="size_tb_bg font borDW">
		<p style="width:218px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:160px;left:157px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:32px;left:157px;width:60px;height:71px;">
	<div class="size_lr_bg font borDH">
