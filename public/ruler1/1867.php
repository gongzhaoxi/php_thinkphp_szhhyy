...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:8px;left:99px;width:147px; height:361px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 308px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:308px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:308px;">
	<div class="size_tb_bg font borDW">
		<p style="width:308px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:246px;height:45px;width:64px;">
	<div class="size_tb_bg font borDW">
		<p style="width:64px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:0px;height:45px;width:91px;">
	<div class="size_tb_bg font borDW">
		<p style="width:91px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:230px;left:-60px;width:60px;height:147px;">
	<div class="size_lr_bg font borDH">
		<p style="height:147px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:238px;left:14px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:8px;left:14px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
