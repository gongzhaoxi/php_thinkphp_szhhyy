...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:94px;width:150px; height:229px;">
...
<div style="overflow: hidden;position:absolute; top:264px;left:50px;width:150px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:262px;left:202px;height: 45px;width:49px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:264px;left:9px;width: 60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:11px;width: 60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:11px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
