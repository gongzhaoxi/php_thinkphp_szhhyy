...
<div style="overflow: hidden;position:absolute; top:276px;left:80px;width:128px; height:97px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:226px;left:127px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
