...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:55px;left:57px;width:134px; height:268px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="134" height="268"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:199px;">
	<div class="size_tb_bg font borDW">
		<p style="width:199px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:143px;left:8px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:-45px;left:178px;height:45px;width:173px;">
	<div class="size_tb_bg font borDW">
		<p style="width:173px"><span><?php if(empty($I2)){$I2='I2';}?><?php echo $I2;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:-45px;left:351px;height:45px;width:175px;">
	<div class="size_tb_bg font borDW">
		<p style="width:175px"><span><?php if(empty($I1)){$I1='I1';}?><?php echo $I1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:357px;left:6px;height:45px;width:168px;">
	<div class="size_tb_bg font borDW">
		<p style="width:168px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:76px;left:6px;height:45px;width:134px;">
	<div class="size_tb_bg font borDW">
		<p style="width:134px"><span><?php if(empty($Z1)){$Z1='Z1';}?><?php echo $Z1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:377px;left:181px;height:45px;width:166px;">
	<div class="size_tb_bg font borDW">
		<p style="width:166px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:76px;left:180px;height:45px;width:133px;">
	<div class="size_tb_bg font borDW">
		<p style="width:133px"><span><?php if(empty($M1)){$M1='M1';}?><?php echo $M1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:357px;left:357px;height:45px;width:166px;">
	<div class="size_tb_bg font borDW">
		<p style="width:166px"><span><?php if(empty($R)){$R='R';}?><?php echo $R;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:76px;left:354px;height:45px;width:133px;">
	<div class="size_tb_bg font borDW">
		<p style="width:133px"><span><?php if(empty($R1)){$R1='R1';}?><?php echo $R1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:95px;left:487px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:330px;left:55px;width:60px;height:44px;">
	<div class="size_lr_bg font borDH">
		<p style="height:44px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
