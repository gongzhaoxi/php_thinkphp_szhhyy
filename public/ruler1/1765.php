...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:140px;top:377px;left:82px;"><p style="width:140px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:68px;top:179px;left:7px;"><p style="width:68px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:30px;top:7px;left:229px;"><p style="height:30px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:229px;"><p style="height:57px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
