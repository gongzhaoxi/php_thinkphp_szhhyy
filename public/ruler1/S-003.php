...
<!-- 砂网 -->
<!-- <div style="background: url(../color/shawang.png); position:absolute; top: 0px;left: 0;width: 126px;height: 377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:114px;top:-20px;left:6px;"><p style="width:114px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:136px;top:241px;left:-30px;"><p style="height:136px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:121px;top:6px;left:126px;"><p style="height:121px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:123px;top:248px;left:126px;"><p style="height:123px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_lr_bg font posi_a borSH" style="height:109px;top:133px;left:126px;"><p style="height:109px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
</div>
</div><script>
