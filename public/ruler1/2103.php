...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:46px;left:21px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:21px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:110px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:110px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:199px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:199px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:46px;left:289px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:212px;left:289px;width:69px; height:119px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="69" height="119"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:110px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
		<p style="width:72px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:20px;height:45px;width:72px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:46px;left:342px;width:60px;height:121px;">
	<div class="size_lr_bg font borDH">
