...
<div class="posi_a ov_h" style="top:232px;left:5px;height:45px;width:220px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:186px;left:158px;width:60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:38px;left:158px;width:60px;height:83px;">
	<div class="size_lr_bg font borDH">
