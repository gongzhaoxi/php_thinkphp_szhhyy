...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:30px;left:72px;width:115px; height:181px;">
...
<div class="posi_a ov_h" style="top:194px;left:73px;height:45px;width:115px;">
	<div class="size_tb_bg font borDW">
		<p style="width:115px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:43px;height:45px;width:70px;">
	<div class="size_tb_bg font borDW">
		<p style="width:70px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:80px;height:45px;width:70px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:77px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
