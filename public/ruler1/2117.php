...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:6px;width:123px; height:234px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="123" height="234"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 206px;height: 243px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:206px;height:242px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
...
<!-- <div class="posi_a ov_h" style="top:328px;left:0px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:328px;left:73px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:223px;left:5px;height:45px;width:129px;">
	<div class="size_tb_bg font borDW">
		<p style="width:129px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:134px;height:45px;width:67px;">
	<div class="size_tb_bg font borDW">
		<p style="width:67px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:155px;left:166px;width:60px;height:222px;">
	<div class="size_lr_bg font borDH">
		<p style="height:222px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:105px;left:166px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:242px;left:166px;width:60px;height:131px;">
	<div class="size_lr_bg font borDH">
		<p style="height:131px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:242px;left:100px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
		<p style="height:101px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:159px;left:130px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:130px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
