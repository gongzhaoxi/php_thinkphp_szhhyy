...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:5px;width:151px; height:267px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="267"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:50px;width:150px; height:98px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="150" height="98"/></div>
</div>
...
<div class="posi_a ov_h" style="top:283px;left:0px;height: 45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:130px;left:162px;height: 45px;width:84px;">
	<div class="size_tb_bg font borDW">
		<p style="width:84px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:50px;height: 45px;width:150px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:120px;left:122px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:166px;width: 60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:166px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
