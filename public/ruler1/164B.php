...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 180px;height: 243px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 180px;height: 243px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:111px;left:0px;height: 45px;width:54px;">
	<div class="size_tb_bg font borDW">
		<p style="width:54px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:194px;left:58px;height: 45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:95px;left:149px;height: 45px;width:32px;">
	<div class="size_tb_bg font borDW">
		<p style="width:32px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:266px;left:71px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<!-- 左边 -->
<!-- 右边 -->
...
<div class="posi_a ov_h" style="top:243px;left:140px;width: 60px;height:132px;">
	<div class="size_lr_bg font borDH">
