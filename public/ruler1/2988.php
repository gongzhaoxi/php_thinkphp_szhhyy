...
<div style="overflow: hidden;position:absolute; top:282px;left:4px;width:154px; height:90px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="154" height="90"/></div>
</div>
