...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:79px;width:128px; height:109px;">
...
<div class="posi_a ov_h" style="top:115px;left:210px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:329px;left:146px;height:45px;width:64px;">
	<div class="size_tb_bg font borDW">
		<p style="width:64px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:225px;left:40px;height:45px;width:65px;">
	<div class="size_tb_bg font borDW">
		<p style="width:65px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:5px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:175px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:5px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:24px;left:5px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
