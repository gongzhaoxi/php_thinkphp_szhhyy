...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:148px;top:-20px;left:5px;"><p style="width:148px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:186px;top:-20px;left:157px;"><p style="width:186px"><span><?php if(empty($M)){$M='M';}?><?php echo $M;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:28px;top:5px;left:-30px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:227px;top:75px;left:-30px;"><p style="height:227px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
