...
<div class="posi_a ov_h" style="top:-20px;left:145px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:227px;left:145px;height:45px;width:45px;"> -->
	<!-- <div class="size_tb_bg font borDW"> -->
		<!-- <p style="width:45px"><span><?php if(empty($Z1)){$Z1='Z1';}?><?php echo $Z1;?></span></p> -->
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:148px;left:0px;height:45px;width:66px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:236px;left:150px;width:60px;height:140px;">
	<div class="size_lr_bg font borDH">
		<p style="height:140px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:236px;left:-35px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:-35px;width:60px;height:163px;">
	<div class="size_lr_bg font borDH">
		<p style="height:163px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:-35px;width:60px;height:66px;">
	<div class="size_lr_bg font borDH">
