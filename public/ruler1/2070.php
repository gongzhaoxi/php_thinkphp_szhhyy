...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:25px;left:97px;width:93px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="150"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:97px;width:93px; height:150px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="150"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:289px;">
	<div class="size_tb_bg font borDW">
		<p style="width:289px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:80px;left:0px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
		<p style="width:52px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:154px;left:51px;height:45px;width:187px;">
	<div class="size_tb_bg font borDW">
		<p style="width:187px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:51px;height:45px;width:187px;">
	<div class="size_tb_bg font borDW">
		<p style="width:187px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:25px;left:165px;width:60px;height:152px;">
	<div class="size_lr_bg font borDH">
