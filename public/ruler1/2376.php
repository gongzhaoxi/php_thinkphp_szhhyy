...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:94px;width:152px; height:207px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:94px;width:152px; height:98px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:242px;left:130px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:9px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:9px;width: 60px;height:112px;">
	<div class="size_lr_bg font borDH">
