...
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 337px;height: 280px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:23px;top:377px;left:311px;"><p style="width:23px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:337px;">
	<div class="size_tb_bg font borDW">
		<p style="width:337px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:337px;width: 60px;height:377px;">
...
<div class="size_lr_bg font posi_a borSH" style="height:110px;top:29px;left:337px;"><p style="height:110px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:62px;top:29px;left:186px;writing-mode:tb-rl;"><p style="height:62px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:72px;top:179px;left:186px;writing-mode:tb-rl;"><p style="height:72px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:202px;top:175px;left:337px;"><p style="height:202px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:39px;top:103px;left:128px;"><p style="width:39px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:39px;top:94px;left:175px;"><p style="height:39px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
