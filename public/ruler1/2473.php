...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:42px;width:126px; height:174px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:72px;width:106px; height:65px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="106" height="65"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 250px;height: 246px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 250px;height: 246
...
<div class="posi_a ov_h" style="top:298px;left:72px;height: 45px;width:106px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:272px;left:0px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:272px;left:212px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L3)){$L3='L3';}?><?php echo $L3;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:272px;left:33px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:90px;left:136px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:246px;left:-60px;width: 60px;height:128px;">
	<div class="size_lr_bg font borDH">
		<p style="height:128px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:276px;left:119px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
