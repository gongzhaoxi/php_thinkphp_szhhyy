...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:376px;">
	<div class="size_tb_bg font borDW">
		<p style="width:376px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:49px;top:12px;left:376px;"><p style="height:49px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:376px;"><p style="height:57px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<div class="posi_a ov_h" style="top:0px;left:376px;width:60px;height:377px;">
