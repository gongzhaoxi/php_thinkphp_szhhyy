...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:38px;left:42px;width:126px; height:189px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="126" height="189"/></div>
</div>
...
<div class="posi_a ov_h" style="top:164px;left:174px;width: 60px;height:97px;">
	<div class="size_lr_bg font borDH">
		<p style="height:97px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:174px;width: 60px;height:88px;">
	<div class="size_lr_bg font borDH">
