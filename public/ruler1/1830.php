...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 160px;height: 377px;'></div>";
}
?>
...
<div class="posi_a ov_h" style="top:328px;left:5px;height:45px;width:150px;">
	<div class="size_tb_bg font borDW">
		<p style="width:150px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:163px;left:-60px;width:60px;height:52px;">
	<div class="size_lr_bg font borDH">
