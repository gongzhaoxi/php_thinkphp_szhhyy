...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:51px;left:51px;width:120px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="120" height="275"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:51px;left:222px;width:120px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="120" height="275"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:51px;left:393px;width:120px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="120" height="275"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:51px;left:564px;width:120px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="120" height="275"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:180px;top:6px;left:735px;"><p style="height:180px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:122px;top:377px;left:50px;"><p style="width:122px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
