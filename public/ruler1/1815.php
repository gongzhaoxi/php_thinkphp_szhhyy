...
<div class="posi_a ov_h" style="top:175px;left:128px;height:45px;width:57px;">
	<div class="size_tb_bg font borDW">
		<p style="width:57px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:326px;left:8px;height:45px;width:115px;">
	<div class="size_tb_bg font borDW">
		<p style="width:115px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:326px;left:257px;height:45px;width:113px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:101px;left:126px;width:60px;height:119px;">
	<div class="size_lr_bg font borDH">
