...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:79px;width:123px; height:253px;">
...
<div class="posi_a ov_h" style="top:270px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:241px;left:41px;height:45px;width:161px;">
	<div class="size_tb_bg font borDW">
		<p style="width:161px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:6px;height:45px;width:68px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:114px;left:-60px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:166px;width:60px;height:111px;">
	<div class="size_lr_bg font borDH">
		<p style="height:111px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:291px;left:130px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:171px;left:2px;width:60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:2px;width:60px;height:102px;">
	<div class="size_lr_bg font borDH">
