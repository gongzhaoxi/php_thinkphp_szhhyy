...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:78px;width:124px; height:273px;">
...
<div class="posi_a ov_h" style="top:296px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:42px;height:45px;width:162px;">
	<div class="size_tb_bg font borDW">
		<p style="width:162px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:135px;left:5px;height:45px;width:67px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:284px;left:166px;width:60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:130px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:2px;width:60px;height:93px;">
	<div class="size_lr_bg font borDH">
		<p style="height:93px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:2px;width:60px;height:115px;">
	<div class="size_lr_bg font borDH">
