...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:42px;left:31px;width:91px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:230px;left:31px;width:91px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:42px;left:154px;width:91px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="103"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:230px;left:154px;width:91px; height:103px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="91" height="103"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:276px;">
	<div class="size_tb_bg font borDW">
		<p style="width:276px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:48px;left:0px;height:45px;width:31px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:123px;left:31px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
		<p style="width:94px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:42px;left:241px;width:60px;height:105px;">
	<div class="size_lr_bg font borDH">
		<p style="height:105px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:147px;left:165px;width:60px;height:25px;">
	<div class="size_lr_bg font borDH">
