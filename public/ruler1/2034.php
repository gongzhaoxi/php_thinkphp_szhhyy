...
<div class="posi_a ov_h" style="top:76px;left:0px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:0px;left:-35px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:97px;left:-35px;width:60px;height:148px;">
	<div class="size_lr_bg font borDH">
