...
<div class="posi_a ov_h" style="top:211px;left:73px;height:45px;width:116px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:172px;left:0px;width:60px;height:85px;">
	<div class="size_lr_bg font borDH">
		<p style="height:85px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:0px;width:60px;height:105px;">
	<div class="size_lr_bg font borDH">
