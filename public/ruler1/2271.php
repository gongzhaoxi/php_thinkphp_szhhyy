...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:7px;width:151px; height:110px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="151" height="110"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
