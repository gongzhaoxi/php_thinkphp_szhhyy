...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:93px;left:52px;width:78px; height:191px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 164px;height: 377px;'></div>";
}
?>
...
<div class="posi_a ov_h" style="top:328px;left:53px;height:45px;width:78px;">
	<div class="size_tb_bg font borDW">
		<p style="width:78px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:166px;left:131px;height:45px;width:34px;">
	<div class="size_tb_bg font borDW">
		<p style="width:34px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:166px;left:0px;height:45px;width:48px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:211px;left:-60px;width:60px;height:166px;">
	<div class="size_lr_bg font borDH">
		<p style="height:166px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:-60px;width:60px;height:43px;">
	<div class="size_lr_bg font borDH">
		<p style="height:43px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:216px;left:-11px;width:60px;height:128px;">
	<div class="size_lr_bg font borDH">
		<p style="height:128px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:-11px;width:60px;height:128px;">
	<div class="size_lr_bg font borDH">
		<p style="height:128px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
