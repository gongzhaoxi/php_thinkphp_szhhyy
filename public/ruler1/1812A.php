...
<div class="posi_a ov_h" style="top:189px;left:0px;height:45px;width:79px;">
	<div class="size_tb_bg font borDW">
		<p style="width:79px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:88px;left:18px;width:60px;height:146px;">
	<div class="size_lr_bg font borDH">
		<p style="height:143px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:241px;left:106px;width:60px;height:1129px;">
	<div class="size_lr_bg font borDH">
		<p style="height:129px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:106px;width:60px;height:74px;">
	<div class="size_lr_bg font borDH">
