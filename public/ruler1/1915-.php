...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-5px;left:0px;height: 30px;width:291px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:291px;">
		<p style="width:291px; height: 30px;"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-5px;left:291px;height: 30px;width:335px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:335px;">
		<p style="width:335px; height: 30px;"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:628px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:628px;">
		<p style="width:628px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
...
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:18px;top:45px;left:-10px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="font posi_a borSW" style="width:25px;top:20px;left:291px;"><p style="width:25px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p></div>
<div class="font posi_a borSW" style="width:19px;top:45px;left:613px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:133px;top:318px;left:32px;"><p style="width:133px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:133px;top:21px;left:177px;"><p style="width:133px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:133px;top:355px;left:177px;"><p style="width:133px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<div class="font posi_a borSW" style="width:133px;top:182px;left:177px;"><p style="width:133px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:283px;top:59px;left:32px;writing-mode:tb-rl;"><p style="height:283px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:377px;top:0px;left:628px;writing-mode:tb-rl;"><p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p></div>
