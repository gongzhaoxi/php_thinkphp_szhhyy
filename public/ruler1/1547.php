...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:212px;">
	<div class="size_tb_bg font borDW">
		<p style="width:212px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:33px;top:6px;left:212px;"><p style="height:33px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:88px;top:36px;left:212px;"><p style="height:88px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:212px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:212px;width:60px;height:377px;">
