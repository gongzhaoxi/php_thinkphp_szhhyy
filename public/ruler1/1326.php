...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:40px;top:377px;left:70px;"><p style="width:40px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:302px;">
	<div class="size_tb_bg font borDW">
		<p style="width:302px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:145px;top:7px;left:36px;"><p style="height:145px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:145px;top:225px;left:36px;"><p style="height:145px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:90px;top:4px;left:302px;"><p style="height:90px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:56px;top:179px;left:7px;"><p style="width:56px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:28px;top:4px;left:302px;"><p style="height:28px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:178px;top:7px;left:302px;"><p style="height:178px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:352px;top:12px;left:302px;"><p style="height:352px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:302px;width:60px;height:377px;">
