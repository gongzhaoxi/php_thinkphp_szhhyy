...
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:233px;">
	<div class="size_tb_bg font borDW">
		<p style="width:233px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:69px;top:81px;left:233px;"><p style="height:69px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:33px;top:5px;left:233px;"><p style="height:33px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
