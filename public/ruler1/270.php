...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:126px;left:44px;width:63px; height:125px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="63" height="125"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:105px;top:-20px;left:23px;"><p style="width:105px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:151px;">
	<div class="size_tb_bg font borDW">
		<p style="width:151px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:106px;top:190px;left:-30px;"><p style="height:106px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:151px;width: 60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:54px;top:3px;left:151px;"><p style="height:54px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:20px;top:59px;left:151px;"><p style="height:20px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:54px;top:320px;left:151px;"><p style="height:54px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:127px;top:125px;left:151px;"><p style="height:127px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:65px;top:254px;left:43px;"><p style="width:65px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:18px;top:377px;left:130px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
</div>
</div>
<script>
