...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:6px;width:150px; height:110px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="150" height="110"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:285px;left:0px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:7px;height:45px;width:195px;">
	<div class="size_tb_bg font borDW">
		<p style="width:195px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:270px;left:167px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:25px;left:168px;width:60px;height:76px;">
	<div class="size_lr_bg font borDH">
