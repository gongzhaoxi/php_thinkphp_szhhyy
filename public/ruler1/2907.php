...
<div style="overflow: hidden;position:absolute; top:288px;left:5px;width:198px; height:58px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="198" height="58"/></div>
</div>
