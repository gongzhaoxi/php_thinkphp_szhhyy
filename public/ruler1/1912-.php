...
<!-- 标尺寸 -->
<!-- 大边坐标 -->
<div class="posi_a ov_h" style="top:-20px;left:0px;height: 20px;width:359px;">
	<div class="size_tb_bg font borDW" style="height: 20px;width:359px;">
		<p style="width:359px; height: 20px;"><span><?php if(empty($W1)){$W1='W1';}?><?php echo $W1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-20px;left:359px;height: 20px;width:265px;">
	<div class="size_tb_bg font borDW" style="height: 20px;width:265px;">
		<p style="width:265px; height: 20px;"><span><?php if(empty($W2)){$W2='W2';}?><?php echo $W2;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:-30px;left:476px;height: 30px;width:242px;"> -->
	...
	<!-- </div> -->
<!-- </div> -->
<div class="posi_a ov_h" style="top:-30px;left:0px;height: 30px;width:624px;">
	<div class="size_tb_bg font borDW" style="height: 30px;width:624px;">
		<p style="width:624px; height: 30px;"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="size_lr_bg font posi_a borSH" style="height:353px;top:24px;left:-15px;writing-mode:tb-rl;"><p style="height:353px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p></div>
<!-- 横向坐标 -->
<div class="font posi_a borSW" style="width:18px;top:51px;left:-15px;"><p style="width:18px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="font posi_a borSW" style="width:25px;top:21px;left:353px;"><p style="width:25px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p></div>
<div class="font posi_a borSW" style="width:19px;top:51px;left:616px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:112px;top:303px;left:27px;"><p style="width:112px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:112px;top:22px;left:138px;"><p style="width:112px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:112px;top:342px;left:138px;"><p style="width:112px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<div class="font posi_a borSW" style="width:112px;top:174px;left:138px;"><p style="width:112px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:260px;top:68px;left:17px;writing-mode:tb-rl;"><p style="height:260px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
