...
<div style="overflow: hidden;position:absolute; top:276px;left:67px;width:101px; height:94px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="101" height="94"/></div>
</div>
...
<div class="posi_a ov_h" style="top:325px;left:67px;height: 45px;width:101px;">
	<div class="size_tb_bg font borDW">
