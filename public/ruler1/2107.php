...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:92px;left:64px;width:78px; height:192px;">
...
<div class="posi_a ov_h" style="top:299px;left:35px;height:45px;width:109px;">
	<div class="size_tb_bg font borDW">
		<p style="width:109px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:187px;">
	<div class="size_tb_bg font borDW">
		<p style="width:187px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:103px;left:147px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:211px;left:159px;width:60px;height:167px;">
	<div class="size_lr_bg font borDH">
		<p style="height:167px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:216px;left:135px;width:60px;height:129px;">
	<div class="size_lr_bg font borDH">
		<p style="height:129px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:35px;left:135px;width:60px;height:87px;">
	<div class="size_lr_bg font borDH">
		<p style="height:87px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:151px;left:113px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
