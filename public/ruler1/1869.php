...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:9px;left:98px;width:147px; height:361px;">
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 363px;height: 377px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:363px;height:377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:363px;">
	<div class="size_tb_bg font borDW">
		<p style="width:363px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:300px;height:45px;width:64px;">
	<div class="size_tb_bg font borDW">
		<p style="width:64px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:185px;left:0px;height:45px;width:90px;">
	<div class="size_tb_bg font borDW">
		<p style="width:90px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
