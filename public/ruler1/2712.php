...
<div style="overflow: hidden;position:absolute; top:276px;left:60px;width:85px; height:96px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:279px;left:172px;height: 45px;width:33px;">
	<div class="size_tb_bg font borDW">
