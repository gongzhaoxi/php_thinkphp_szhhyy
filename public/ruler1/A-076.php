...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:137px;top:-20px;left:6px;"><p style="width:137px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:341px;">
	<div class="size_tb_bg font borDW">
		<p style="width:341px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:223px;top:53px;left:341px;"><p style="height:223px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:175px;top:101px;left:60px;"><p style="height:175px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:89px;top:377px;left:54px;"><p style="width:89px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
