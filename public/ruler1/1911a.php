...
<div class="font posi_a borSW" style="width:19px;top:84px;left:720px;"><p style="width:19px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:315px;top:308px;left:53px;"><p style="width:315px"><span><?php if(empty($BW)){$BW='BW';}?><?php echo $BW;?></span></p></div>
<div class="font posi_a borSW" style="width:315px;top:21px;left:54px;"><p style="width:315px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<div class="font posi_a borSW" style="width:315px;top:343px;left:54px;"><p style="width:315px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p></div>
<!-- 竖向坐标 -->
<div class="size_lr_bg font posi_a borSH" style="height:264px;top:66px;left:54px;writing-mode:tb-rl;"><p style="height:264px"><span><?php if(empty($BH)){$BH='BH';}?><?php echo $BH;?></span></p></div>
