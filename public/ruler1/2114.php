...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:130px;left:69px;width:126px; height:168px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="126" height="168"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:264px;">
	<div class="size_tb_bg font borDW">
		<p style="width:264px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:112px;left:0px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
		<p style="width:69px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:325px;left:69px;height:45px;width:126px;">
	<div class="size_tb_bg font borDW">
		<p style="width:126px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:0px;left:4px;height:45px;width:256px;">
	<div class="size_tb_bg font borDW">
		<p style="width:256px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<!-- <div class="posi_a ov_h" style="top:3px;left:342px;width:60px;height:172px;">
	<div class="size_lr_bg font borDH">
