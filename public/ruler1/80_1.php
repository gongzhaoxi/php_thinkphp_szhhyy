...
<div class="size_lr_bg font posi_a borSH" style="height:167px;top:210px;left:135px;"><p style="height:167px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:159px;top:4px;left:107px;writing-mode:tb-rl;"><p style="height:159px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:159px;top:214px;left:107px;writing-mode:tb-rl;"><p style="height:159px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:45px;top:166px;left:135px;"><p style="height:45px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
