...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:225px;top:-20px;left:6px;"><p style="width:225px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
...
<!-- 下边 -->
<div class="posi_a ov_h" style="top:377px;left:0px;height: 45px;width:697px;">
	<div class="size_tb_bg font borDW">
		<p style="width:697px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 左边 -->
...
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:697px;width: 60px;height:377px;">
