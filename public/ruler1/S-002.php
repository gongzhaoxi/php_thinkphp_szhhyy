...
<!-- 砂网 -->
<!-- <div style="background: url(../color/shawang.png); position:absolute; top: 0px;left: 0;width: 191px;height: 377px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:167px;top:-20px;left:12px;"><p style="width:167px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:151px;top:25px;left:191px;"><p style="height:151px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:177px;top:188px;left:191px;"><p style="height:177px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
</div>
</div><script>
