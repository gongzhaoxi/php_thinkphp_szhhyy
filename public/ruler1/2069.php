...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:3px;left:96px;width:97px; height:170px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="97" height="170"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:204px;left:96px;width:97px; height:170px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="97" height="170"/></div>
</div>
...
<div class="posi_a ov_h" style="top:70px;left:0px;height:45px;width:50px;">
	<div class="size_tb_bg font borDW">
		<p style="width:50px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:50px;height:45px;width:190px;">
	<div class="size_tb_bg font borDW">
		<p style="width:190px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-45px;left:50px;height:45px;width:190px;">
	<div class="size_tb_bg font borDW">
		<p style="width:190px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:0px;left:163px;width:60px;height:176px;">
	<div class="size_lr_bg font borDH">
		<p style="height:176px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
