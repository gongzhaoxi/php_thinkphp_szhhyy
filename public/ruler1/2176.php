...
<div class="posi_a ov_h" style="top:193px;left:75px;height:45px;width:116px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:1px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:1px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
