...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:31px;left:6px;width:114px; height:180px;">
...
<div class="posi_a ov_h" style="top:285px;left:0px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:192px;left:5px;height:45px;width:180px;">
	<div class="size_tb_bg font borDW">
		<p style="width:180px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:180px;">
	<div class="size_tb_bg font borDW">
		<p style="width:180px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:247px;left:5px;height:45px;width:148px;">
	<div class="size_tb_bg font borDW">
		<p style="width:148px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:126px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:269px;left:120px;width:60px;height:51px;">
	<div class="size_lr_bg font borDH">
		<p style="height:51px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:160px;left:120px;width:60px;height:52px;">
	<div class="size_lr_bg font borDH">
		<p style="height:52px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:120px;width:60px;height:71px;">
	<div class="size_lr_bg font borDH">
