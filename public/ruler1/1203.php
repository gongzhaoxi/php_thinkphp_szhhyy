...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:44px;top:-20px;left:193x;"><p style="width:44px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:28px;top:377px;left:208px;"><p style="width:28px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:57px;top:99px;left:207px;"><p style="height:57px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
