...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:69px;left:8px;width:126px; height:107px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="126" height="107"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<div class="posi_a ov_h" style="top:193px;left:7px;height:45px;width:126px;">
	<div class="size_tb_bg font borDW">
		<p style="width:126px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:160px;left:139px;width:60px;height:78px;">
	<div class="size_lr_bg font borDH">
		<p style="height:78px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:139px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
