...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:92px;left:39px;width:86px; height:193px;">
...
<div style="overflow: hidden;position:absolute; top:92px;left:165px;width:86px; height:193px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="86" height="193"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:195px;top:91px;left:290px;"><p style="height:195px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:84px;top:289px;left:290px;"><p style="height:84px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:88px;top:377px;left:164px;"><p style="width:88px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
</div>
</div>
<script>
