...
<div style="overflow: hidden;position:absolute; top:288px;left:5px;width:172px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="172" height="84"/></div>
</div>
...
<div class="posi_a ov_h" style="top:236px;left:86px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
