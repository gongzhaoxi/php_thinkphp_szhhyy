...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:74px;width:118px; height:253px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="118" height="253"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:264px;left:40px;width:186px; height:76px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="186" height="76"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 265px;height: 263px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 265px;height: 263px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:95px;left:0px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:274px;left:0px;height: 45px;width:39px;">
	<div class="size_tb_bg font borDW">
		<p style="width:39px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:122px;left:197px;height: 45px;width:64px;">
	<div class="size_tb_bg font borDW">
		<p style="width:64px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:293px;left:40px;height: 45px;width:186px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:339px;left:92px;width: 60px;height:39px;">
	<div class="size_lr_bg font borDH">
		<p style="height:39px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:225px;width: 60px;height:209px;">
	<div class="size_lr_bg font borDH">
		<p style="height:209px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:114px;left:157px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:263px;left:-60px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
		<p style="height:111px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:263px;left:166px;width: 60px;height:76px;">
	<div class="size_lr_bg font borDH">
		<p style="height:76px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:192px;width: 60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:83px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:192px;width: 60px;height:106px;">
	<div class="size_lr_bg font borDH">
