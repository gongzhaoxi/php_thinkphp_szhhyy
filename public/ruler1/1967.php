...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:50px;left:42px;width:96px; height:281px;">
...
<div style="overflow: hidden;position:absolute; top:50px;left:178px;width:95px; height:279px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="95" height="279"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:50px;left:315px;width:96px; height:281px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="96" height="281"/></div>
</div>
<!-- 标尺寸 -->
