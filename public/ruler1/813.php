...
<div class="size_lr_bg font posi_a borSH" style="height:132px;top:55px;left:224px;"><p style="height:132px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:267px;top:55px;left:362px;"><p style="height:267px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
