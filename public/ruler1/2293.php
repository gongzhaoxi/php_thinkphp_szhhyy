...
<div class="posi_a ov_h" style="top:115px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
		<p style="width:42px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:275px;left:0px;height:45px;width:42px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:229px;left:5px;height:45px;width:204px;">
	<div class="size_tb_bg font borDW">
		<p style="width:204px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:176px;height:45px;width:71px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:243px;left:175px;width:60px;height:64px;">
	<div class="size_lr_bg font borDH">
