...
<div class="posi_a ov_h" style="top:232px;left:6px;height:45px;width:180px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:186px;left:119px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:37px;left:119px;width:60px;height:81px;">
	<div class="size_lr_bg font borDH">
