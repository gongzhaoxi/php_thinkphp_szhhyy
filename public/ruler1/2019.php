...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:40px;left:32px;width:43px; height:290px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="43" height="290"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:40px;left:123px;width:43px; height:290px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="43" height="290"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:40px;left:213px;width:43px; height:290px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="43" height="290"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:40px;left:303px;width:43px; height:290px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="43" height="290"/></div>
</div>
<!-- 标尺寸 -->
