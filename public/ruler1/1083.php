...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:55px;top:377px;left:704px;"><p style="width:55px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:768px;">
	<div class="size_tb_bg font borDW">
		<p style="width:768px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:129px;top:9px;left:250px;"><p style="height:129px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:129px;top:239px;left:250px;"><p style="height:129px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:114px;top:9px;left:652px;"><p style="height:114px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<!-- 右边 -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:35px;top:7px;left:768px;"><p style="height:35px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:118px;top:48px;left:768px;"><p style="height:118px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:359px;top:9px;left:768px;"><p style="height:359px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:768px;width:60px;height:377px;">
