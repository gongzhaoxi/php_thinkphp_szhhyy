...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:60px;width:93px; height:193px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="93" height="193"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 213px;height: 262px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:213px;height:262px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:213px;">
	<div class="size_tb_bg font borDW">
		<p style="width:213px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:84px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<!-- <div class="posi_a ov_h" style="top:357px;left:5px;height:45px;width:85px;">
	<div class="size_tb_bg font borDW">
		<p style="width:85px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:212px;left:84px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:84px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:241px;left:5px;height:45px;width:177px;">
	<div class="size_tb_bg font borDW">
		<p style="width:177px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:122px;left:159px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:193px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:173px;width:60px;height:209px;">
	<div class="size_lr_bg font borDH">
		<p style="height:209px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:114px;left:173px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:262px;left:146px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:173px;left:146px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:86px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:146px;width:60px;height:105px;">
	<div class="size_lr_bg font borDH">
