...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:51px;left:7px;width:101px; height:275px;">
...
<div style="overflow: hidden;position:absolute; top:51px;left:269px;width:101px; height:275px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="101" height="275"/></div>
</div>
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 377px;height: 377px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:180px;top:-20px;left:6px;"><p style="width:180px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<!-- 下边 -->
...
<!-- 左边 -->
<div class="size_lr_bg font posi_a borSH" style="height:278px;top:50px;left:-30px;"><p style="height:278px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:62px;top:50px;left:233px;writing-mode:tb-rl;"><p style="height:62px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:63px;top:265px;left:233px;writing-mode:tb-rl;"><p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:119px;top:258px;left:377px;"><p style="height:119px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:72px;top:213px;left:114px;"><p style="width:72px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:68px;top:118px;left:212px;"><p style="height:68px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
