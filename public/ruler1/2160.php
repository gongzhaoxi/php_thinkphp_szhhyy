...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:36px;left:74px;width:114px; height:210px;">
...
<div class="posi_a ov_h" style="top:277px;left:0px;height:45px;width:40px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:232px;left:74px;height:45px;width:114px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:264px;left:40px;height:45px;width:148px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:181px;left:-60px;width:60px;height:196px;">
	<div class="size_lr_bg font borDH">
		<p style="height:196px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:124px;left:-60px;width:60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:283px;left:152px;width:60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:119px;width:60px;height:59px;">
	<div class="size_lr_bg font borDH">
		<p style="height:59px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:186px;left:0px;width:60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:0px;width:60px;height:113px;">
	<div class="size_lr_bg font borDH">
