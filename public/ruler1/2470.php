...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:38px;left:80px;width:126px; height:189px;">
...
<div class="posi_a ov_h" style="top:216px;left:126px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:164px;left:4px;width: 60px;height:98px;">
	<div class="size_lr_bg font borDH">
		<p style="height:98px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:4px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
