...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:75px;left:6px;width:92px; height:228px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="92" height="228"/></div>
</div>
<!-- 砂网 -->
...
<div class="posi_a ov_h" style="top:288px;left:6px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
		<p style="width:94px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:323px;left:6px;height:45px;width:150px;">
	<div class="size_tb_bg font borDW">
		<p style="width:150px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:95px;left:103px;height:45px;width:52px;">
	<div class="size_tb_bg font borDW">
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:130px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:215px;left:120px;width:60px;height:162px;">
	<div class="size_lr_bg font borDH">
		<p style="height:162px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:220px;left:93px;width:60px;height:119px;">
	<div class="size_lr_bg font borDH">
		<p style="height:119px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:41px;left:93px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
		<p style="height:70px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:116px;left:64px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
		<p style="height:101px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
