...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:62px;width:99px; height:149px;">
...
<div class="posi_a ov_h" style="top:234px;left:62px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:265px;left:33px;height:45px;width:130px;">
	<div class="size_tb_bg font borDW">
		<p style="width:130px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:136px;left:4px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:182px;left:-60px;width:60px;height:195px;">
	<div class="size_lr_bg font borDH">
		<p style="height:195px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:122px;left:-60px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:284px;left:125px;width:60px;height:91px;">
	<div class="size_lr_bg font borDH">
		<p style="height:91px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:97px;width:60px;height:60px;">
	<div class="size_lr_bg font borDH">
		<p style="height:60px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:185px;left:-7px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
		<p style="height:96px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-7px;width:60px;height:116px;">
	<div class="size_lr_bg font borDH">
