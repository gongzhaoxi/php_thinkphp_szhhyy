...
<div style="overflow: hidden;position:absolute; top:287px;left:59px;width:90px; height:84px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:5px;left:-7px;width: 60px;height:93px;">
	<div class="size_lr_bg font borDH">
