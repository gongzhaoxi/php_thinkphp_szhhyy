...
<div class="posi_a ov_h" style="top:216px;left:-11px;width:60px;height:156px;">
	<div class="size_lr_bg font borDH">
		<p style="height:156px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-11px;width:60px;height:156px;">
	<div class="size_lr_bg font borDH">
		<p style="height:156px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
