...
<!-- 下边 -->
<div class="size_tb_bg font posi_a borSW" style="width:510px;top:377px;left:1105px;"><p style="width:510px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:1643px;">
	<div class="size_tb_bg font borDW">
		<p style="width:1643px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:149px;top:26px;left:1643px;"><p style="height:149px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="posi_a ov_h" style="top:0px;left:1643px;width:60px;height:377px;">
