...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:70px;width:110px; height:190px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="110" height="190"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:284px;left:37px;width:175px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="175" height="61"/></div>
</div>
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 250px;height: 256px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0;width: 250px;height: 256
...
<div class="posi_a ov_h" style="top:299px;left:37px;height: 45px;width:175px;">
	<div class="size_tb_bg font borDW">
		<p style="width:175px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:78px;left:0px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
		<p style="width:37px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:269px;left:0px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
		<p style="width:37px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:274px;left:180px;height: 45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L2)){$L2='L2';}?><?php echo $L2;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:269px;left:213px;height: 45px;width:37px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:205px;left:105px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:117px;left:186px;height: 45px;width:60px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:163px;left:210px;width: 60px;height:214px;">
	<div class="size_lr_bg font borDH">
		<p style="height:214px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:111px;left:146px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:283px;left:153px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:168px;left:179px;width: 60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:33px;left:179px;width: 60px;height:74px;">
	<div class="size_lr_bg font borDH">
