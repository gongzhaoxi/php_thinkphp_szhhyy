...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:35px;left:70px;width:110px; height:206px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="110" height="206"/></div>
</div>

<!-- 上下固花件 -->

<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:240px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="240" height="66"/></div>
</div>
...
<div class="posi_a ov_h" style="top:296px;left:5px;height: 45px;width:240px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:185px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:35px;left:179px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
