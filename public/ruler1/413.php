...
<div class="size_lr_bg font posi_a borSH" style="height:181px;top:5px;left:281px;"><p style="height:181px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:5px;left:6px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:112px;top:260px;left:6px;writing-mode:tb-rl;"><p style="height:112px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:123px;top:254px;left:281px;"><p style="height:123px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 锁位 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:65px;top:121px;left:22px;"><p style="height:65px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
