...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:8px;left:63px;width:144px; height:359px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="144" height="359"/></div>
</div>
...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:216px;">
	<div class="size_tb_bg font borDW">
		<p style="width:216px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:143px;left:9px;height:45px;width:46px;">
	<div class="size_tb_bg font borDW">
		<p style="width:46px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
...
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:181px;width:60px;height:377px;">
