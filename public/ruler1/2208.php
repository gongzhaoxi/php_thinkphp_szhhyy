...
<div class="posi_a ov_h" style="top:194px;left:62px;height:45px;width:100px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:-7px;width:60px;height:82px;">
	<div class="size_lr_bg font borDH">
		<p style="height:82px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:-7px;width:60px;height:99px;">
	<div class="size_lr_bg font borDH">
