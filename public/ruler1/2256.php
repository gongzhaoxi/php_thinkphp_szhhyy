...
<div class="posi_a ov_h" style="top:141px;left:219px;height:45px;width:39px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:264px;left:39px;height:45px;width:215px;">
	<div class="size_tb_bg font borDW">
		<p style="width:215px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:135px;left:5px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:283px;left:218px;width:60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:315px;left:186px;width:60px;height:58px;">
	<div class="size_lr_bg font borDH">
