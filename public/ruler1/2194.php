...
<div class="posi_a ov_h" style="top:74px;left:180px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
		<p style="width:33px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:252px;left:0px;height:45px;width:33px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:248px;left:33px;height:45px;width:178px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:297px;left:147px;width:60px;height:50px;">
	<div class="size_lr_bg font borDH">
