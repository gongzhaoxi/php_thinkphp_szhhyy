...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:71px;left:5px;width:97px; height:138px;">
...
<div style="overflow: hidden;position:absolute; top:282px;left:5px;width:97px; height:90px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="97" height="90"/></div>
</div>
...
<div class="posi_a ov_h" style="top:327px;left:5px;height: 45px;width:97px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:209px;left:30px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:193px;left:95px;width: 60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:27px;left:95px;width: 60px;height:77px;">
	<div class="size_lr_bg font borDH">
