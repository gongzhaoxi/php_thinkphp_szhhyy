...
<div class="size_lr_bg font posi_a borSH" style="height:74px;top:270px;left:25px;writing-mode:tb-rl;"><p style="height:74px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
