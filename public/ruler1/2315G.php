...
<div class="posi_a ov_h" style="top:132px;left:162px;height: 45px;width:82px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:119px;left:123px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
		<p style="height:56px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:275px;left:167px;width: 60px;height:97px;">
	<div class="size_lr_bg font borDH">
		<p style="height:97px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:167px;width: 60px;height:90px;">
	<div class="size_lr_bg font borDH">
		<p style="height:90px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:167px;width: 60px;height:111px;">
	<div class="size_lr_bg font borDH">
