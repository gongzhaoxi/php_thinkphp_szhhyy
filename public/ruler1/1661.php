...
<div class="size_lr_bg font posi_a borSH" style="height:164px;top:457px;left:-30px;"><p style="height:164px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:69px;top:81px;left:457px;"><p style="height:69px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
