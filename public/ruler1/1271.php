...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:248px;">
	<div class="size_tb_bg font borDW">
		<p style="width:248px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:176px;top:9px;left:248px;"><p style="height:176px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p></div>
