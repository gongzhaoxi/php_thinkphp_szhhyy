...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:31px;left:5px;width:121px; height:181px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="121" height="181"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
<!-- <div class="posi_a ov_h" style="top:105px;left:0px;height:45px;width:32px;">
	<div class="size_tb_bg font borDW">
		<p style="width:32px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div> -->
<div class="posi_a ov_h" style="top:270px;left:79px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:193px;left:5px;height:45px;width:190px;">
	<div class="size_tb_bg font borDW">
		<p style="width:190px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:110px;left:131px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:125px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:125px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
