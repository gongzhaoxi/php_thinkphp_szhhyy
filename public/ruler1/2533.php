...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:33px;left:70px;width:109px; height:189px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="109" height="189"/></div>
</div>
...
<div class="posi_a ov_h" style="top:205px;left:95px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:167px;left:179px;width: 60px;height:84px;">
	<div class="size_lr_bg font borDH">
		<p style="height:84px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:179px;width: 60px;height:102px;">
	<div class="size_lr_bg font borDH">
