...
<!-- 花件 -->
<!-- <div style="overflow: hidden;position:absolute; top:5px;left:66px;width:102px; height:233px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="102" height="233"/></div>
</div> -->
<!-- 砂网 -->
<div style="background: url(/static/images/shawang.png); position:absolute; top:16px;left:16px;width:156px;height:108px; ">
</div>
<div style="background: url(/static/images/shawang.png); position:absolute; top:253px;left:6px;width:178px;height:118px; ">
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:188px;">
	<div class="size_tb_bg font borDW">
		<p style="width:188px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:85px;left:0px;height:45px;width:36px;">
	<div class="size_tb_bg font borDW">
		<p style="width:36px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:277px;left:99px;height:45px;width:38px;">
	<div class="size_tb_bg font borDW">
		<p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:357px;left:5px;height:45px;width:94px;">
	<div class="size_tb_bg font borDW">
		<p style="width:94px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:327px;left:38px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
		<p style="width:62px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:222px;left:5px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
		<p style="width:61px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:109px;left:174px;height:45px;width:56px;">
	<div class="size_tb_bg font borDW">
		<p style="width:56px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div> -->
<!-- 中间竖 -->
<!-- 中间横 -->
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:168px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:247px;left:-60px;width:60px;height:124px;">
	<div class="size_lr_bg font borDH">
		<p style="height:124px"><span><?php if(empty($H1)){$H1='H1';}?><?php echo $H1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:7px;left:-60px;width:60px;height:124px;">
	<div class="size_lr_bg font borDH">
		<p style="height:124px"><span><?php if(empty($H2)){$H2='H2';}?><?php echo $H2;?></span></p>
	</div>
</div>
<!-- <div class="posi_a ov_h" style="top:155px;left:194px;width:60px;height:222px;">
	<div class="size_lr_bg font borDH">
		<p style="height:222px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:106px;left:194px;width:60px;height:49px;">
	<div class="size_lr_bg font borDH">
		<p style="height:49px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:243px;left:-60px;width:60px;height:130px;">
	<div class="size_lr_bg font borDH">
		<p style="height:130px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:243px;left:163px;width:60px;height:100px;">
	<div class="size_lr_bg font borDH">
		<p style="height:100px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:160px;left:164px;width:60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div> -->
<!-- <div class="posi_a ov_h" style="top:4px;left:164px;width:60px;height:97px;">
	<div class="size_lr_bg font borDH">
		<p style="height:97px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div> -->
<!-- 锁位 -->
</div>
