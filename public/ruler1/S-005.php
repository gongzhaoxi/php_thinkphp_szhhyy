...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:142px;top:-20px;left:23px;"><p style="width:142px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<!-- 下边 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:189px;top:377px;left:0px;"><p style="width:189px"><span><?php if(empty($DW)){$DW='DW';}?><?php echo $DW;?></span></p></div>
<!-- 左边 -->
