...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:34px;left:41px;width:114px; height:194px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="114" height="194"/></div>
</div>
<!-- 砂网 -->
<?php
if(!isset($SW)){
...
if($SW=='1'){
echo "<div style='background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width: 230px;height: 262px;'></div>";
}
?>
<!-- <div style="background: url(/static/images/shawang.png); position:absolute; top: 0px;left: 0px;width:230px;height:262px; ">
</div> -->
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:230px;">
	<div class="size_tb_bg font borDW">
		<p style="width:230px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:83px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
		<p style="width:41px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:286px;left:0px;height:45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:210px;left:41px;height:45px;width:116px;">
	<div class="size_tb_bg font borDW">
		<p style="width:116px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:327px;left:5px;height:45px;width:220px;">
	<div class="size_tb_bg font borDW">
		<p style="width:220px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:240px;left:6px;height:45px;width:185px;">
	<div class="size_tb_bg font borDW">
		<p style="width:185px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:121px;left:162px;height:45px;width:62px;">
	<div class="size_tb_bg font borDW">
		<p style="width:62px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
<!-- 左边 -->
<!-- 右边 -->
<div class="posi_a ov_h" style="top:0px;left:210px;width:60px;height:377px;">
	<div class="size_lr_bg font borDH">
		<p style="height:377px"><span><?php if(empty($H)){$H='H';}?><?php echo $H;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:167px;left:190px;width:60px;height:210px;">
	<div class="size_lr_bg font borDH">
		<p style="height:210px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:114px;left:190px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:-60px;width:60px;height:112px;">
	<div class="size_lr_bg font borDH">
		<p style="height:112px"><span><?php if(empty($GBH)){$GBH='GBH';}?><?php echo $GBH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:262px;left:156px;width:60px;height:54px;">
	<div class="size_lr_bg font borDH">
		<p style="height:54px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:172px;left:156px;width:60px;height:86px;">
	<div class="size_lr_bg font borDH">
		<p style="height:86px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:5px;left:156px;width:60px;height:106px;">
	<div class="size_lr_bg font borDH">
		<p style="height:106px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
