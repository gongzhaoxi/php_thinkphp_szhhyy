...
<div style="overflow: hidden;position:absolute; top:282px;left:62px;width:97px; height:61px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:299px;left:62px;height: 45px;width:97px;">
	<div class="size_tb_bg font borDW">
		<p style="width:97px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:282px;left:29px;height: 45px;width:34px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:209px;left:90px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:327px;left:87px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
		<p style="width:45px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:142px;left:5px;height: 45px;width:51px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:282px;left:23px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
		<p style="height:61px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:193px;left:-6px;width: 60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:27px;left:-6px;width: 60px;height:77px;">
	<div class="size_lr_bg font borDH">
