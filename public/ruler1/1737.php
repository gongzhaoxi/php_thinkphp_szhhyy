...
<!-- 中间横 -->
<div class="size_tb_bg font posi_a borSW" style="width:110px;top:179px;left:12px;"><p style="width:110px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<!-- 左边 -->
...
<!-- <div class="size_lr_bg font posi_a borSH" style="height:168px;top:376px;left:-30px;"><p style="height:168px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div> -->
<!-- 右边 -->
