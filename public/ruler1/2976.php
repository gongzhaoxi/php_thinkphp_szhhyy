...
<div style="overflow: hidden;position:absolute; top:282px;left:62px;width:97px; height:90px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:327px;left:62px;height: 45px;width:97px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:232px;left:60px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:193px;left:-7px;width: 60px;height:63px;">
	<div class="size_lr_bg font borDH">
		<p style="height:63px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:27px;left:-7px;width: 60px;height:77px;">
	<div class="size_lr_bg font borDH">
