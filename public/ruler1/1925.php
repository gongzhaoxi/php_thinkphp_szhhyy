...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:97px;width:81px; height:244px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="244"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:67px;left:358px;width:81px; height:244px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="244"/></div>
</div>
<!-- 标尺寸 -->
