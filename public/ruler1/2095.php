...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:43px;left:29px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:29px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:145px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:145px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:43px;left:262px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:231px;left:262px;width:87px; height:105px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="87" height="105"/></div>
</div>
...
<div class="posi_a ov_h" style="top:142px;left:144px;height:45px;width:88px;">
	<div class="size_tb_bg font borDW">
		<p style="width:88px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:29px;height:45px;width:88px;">
	<div class="size_tb_bg font borDW">
