...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:67px;left:73px;width:109px; height:107px;">
...
<div class="posi_a ov_h" style="top:160px;left:0px;width:60px;height:77px;">
	<div class="size_lr_bg font borDH">
		<p style="height:77px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:0px;width:60px;height:96px;">
	<div class="size_lr_bg font borDH">
