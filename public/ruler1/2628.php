...
<div style="overflow: hidden;position:absolute; top:276px;left:66px;width:102px; height:95px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:326px;left:66px;height: 45px;width:102px;">
	<div class="size_tb_bg font borDW">
		<p style="width:102px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:44px;left:169px;height: 45px;width:36px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:225px;left:97px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
