...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:97px;width:150px; height:235px;">
...
<div style="overflow: hidden;position:absolute; top:249px;left:97px;width:150px; height:81px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:132px;left:6px;height: 45px;width:82px;">
	<div class="size_tb_bg font borDW">
		<p style="width:82px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:284px;left:97px;height: 45px;width:150px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:336px;left:136px;width: 60px;height:37px;">
	<div class="size_lr_bg font borDH">
		<p style="height:37px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:179px;left:-60px;width: 60px;height:198px;">
	<div class="size_lr_bg font borDH">
		<p style="height:198px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:116px;left:29px;width: 60px;height:61px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:249px;left:57px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:80px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:185px;left:13px;width: 60px;height:58px;">
	<div class="size_lr_bg font borDH">
		<p style="height:58px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:13px;width: 60px;height:104px;">
	<div class="size_lr_bg font borDH">
