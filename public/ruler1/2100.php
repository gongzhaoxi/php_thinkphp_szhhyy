...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:25px;left:18px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:18px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:25px;left:111px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:111px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:25px;left:206px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:206px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:25px;left:300px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:202px;left:300px;width:61px; height:151px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="61" height="151"/></div>
</div>
...
<div class="posi_a ov_h" style="top:153px;left:110px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
		<p style="width:61px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:18px;height:45px;width:61px;">
	<div class="size_tb_bg font borDW">
		<p style="width:61px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:25px;left:342px;width:60px;height:153px;">
	<div class="size_lr_bg font borDH">
		<p style="height:153px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
