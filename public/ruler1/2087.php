...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:5px;left:34px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:34px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:5px;left:148px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:148px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:5px;left:262px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:262px;width:78px; height:166px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="78" height="166"/></div>
</div>
...
<div class="posi_a ov_h" style="top:156px;left:149px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:156px;left:34px;height:45px;width:80px;">
	<div class="size_tb_bg font borDW">
		<p style="width:80px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
...
<div class="posi_a ov_h" style="top:3px;left:342px;width:60px;height:168px;">
	<div class="size_lr_bg font borDH">
		<p style="height:168px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p>
	</div>
</div>
