...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:63px;left:72px;width:113px; height:137px;">
...
<div class="posi_a ov_h" style="top:172px;left:0px;width:60px;height:57px;">
	<div class="size_lr_bg font borDH">
		<p style="height:57px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:34px;left:0px;width:60px;height:76px;">
	<div class="size_lr_bg font borDH">
