...
<div style="overflow: hidden;position:absolute; top:276px;left:37px;width:175px; height:65px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="175" height="65"/></div>
</div>
...
<div class="posi_a ov_h" style="top:276px;left:0px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
