...
<div class="posi_a ov_h" style="top:192px;left:5px;height:45px;width:192px;">
	<div class="size_tb_bg font borDW">
		<p style="width:192px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:159px;left:131px;width:60px;height:53px;">
	<div class="size_lr_bg font borDH">
		<p style="height:53px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:31px;left:131px;width:60px;height:70px;">
	<div class="size_lr_bg font borDH">
