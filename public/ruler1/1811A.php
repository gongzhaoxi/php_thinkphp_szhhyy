...
<div class="posi_a ov_h" style="top:182px;left:0px;height:45px;width:75px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:227px;left:-60px;width:60px;height:150px;">
	<div class="size_lr_bg font borDH">
		<p style="height:150px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:83px;left:14px;width:60px;height:144px;">
	<div class="size_lr_bg font borDH">
		<p style="height:144px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:234px;left:0px;width:60px;height:136px;">
	<div class="size_lr_bg font borDH">
		<p style="height:136px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:8px;left:0px;width:60px;height:68px;">
	<div class="size_lr_bg font borDH">
