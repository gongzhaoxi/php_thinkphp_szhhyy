...
<div class="size_lr_bg font posi_a borSH" style="height:223px;top:53px;left:150px;"><p style="height:223px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:91px;top:377px;left:53px;"><p style="width:91px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
