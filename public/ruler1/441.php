...
<div class="size_lr_bg font posi_a borSH" style="height:112px;top:5px;left:41px;writing-mode:tb-rl;"><p style="height:112px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:111px;top:261px;left:41px;writing-mode:tb-rl;"><p style="height:111px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<!-- 锁位 -->
<div class="size_tb_bg font posi_a borSW" style="width:65px;top:210px;left:5px;"><p style="width:65px"><span><?php if(empty($LW)){$LW='LW';}?><?php echo $LW;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:65px;top:122px;left:-30px;"><p style="height:65px"><span><?php if(empty($LH)){$LH='LH';}?><?php echo $LH;?></span></p></div>
