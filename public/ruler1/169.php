...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:120px;left:7px;width:99px; height:250px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="99" height="250"/></div>
</div>
<!-- 标尺寸 -->
<!-- 上边 -->
<!-- 下边 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:107px;top:6px;left:113px;"><p style="height:107px"><span><?php if(empty($GTH)){$GTH='GTH';}?><?php echo $GTH;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:252px;top:119px;left:113px;"><p style="height:252px"><span><?php if(empty($FH)){$FH='FH';}?><?php echo $FH;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:101px;top:377px;left:6px;"><p style="width:101px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p></div>
<div class="size_tb_bg font posi_a borSW" style="width:30px;top:-20px;left:6px;"><p style="width:30px"><span><?php if(empty($T)){$T='T';}?><?php echo $T;?></span></p></div>
</div>
</div>
<script>
