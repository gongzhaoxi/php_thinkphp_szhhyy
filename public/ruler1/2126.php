...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:75px;width:117px; height:235px;">
...
<div class="posi_a ov_h" style="top:327px;left:51px;height:45px;width:85px;">
	<div class="size_tb_bg font borDW">
		<p style="width:85px"><span><?php if(empty($S1)){$S1='S1';}?><?php echo $S1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:224px;left:96px;height:45px;width:85px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:273px;left:101px;width:60px;height:101px;">
	<div class="size_lr_bg font borDH">
