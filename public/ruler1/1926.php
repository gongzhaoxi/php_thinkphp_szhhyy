...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:96px;left:96px;width:81px; height:187px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="187"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:96px;left:315px;width:81px; height:187px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="81" height="187"/></div>
</div>
<!-- 标尺寸 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:38px;top:377px;left:447px;"><p style="width:38px"><span><?php if(empty($L1)){$L1='L1';}?><?php echo $L1;?></span></p></div>
</div>
</div>
<script>
