...
<div class="posi_a ov_h" style="top:325px;left:9px;height:45px;width:251px;">
	<div class="size_tb_bg font borDW">
		<p style="width:251px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:141px;left:225px;height:45px;width:46px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:233px;left:1px;width:60px;height:98px;">
	<div class="size_lr_bg font borDH">
		<p style="height:98px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:46px;left:1px;width:60px;height:117px;">
	<div class="size_lr_bg font borDH">
		<p style="height:117px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
