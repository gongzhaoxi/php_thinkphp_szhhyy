...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:105px;top:-20px;left:113px;"><p style="width:105px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:222px;">
	<div class="size_tb_bg font borDW">
		<p style="width:222px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:27px;top:5px;left:222px;"><p style="height:27px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:89px;top:36px;left:222px;"><p style="height:89px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:222px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:222px;width:60px;height:377px;">
