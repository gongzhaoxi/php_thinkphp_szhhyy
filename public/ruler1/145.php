...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:50px;left:50px;width:113px; height:277px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="113" height="277"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:50px;left:214px;width:113px; height:277px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="113" height="277"/></div>
</div>
<!-- 标尺寸 -->
