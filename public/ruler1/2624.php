...
<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:164px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:296px;left:5px;height: 45px;width:164px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:195px;left:97px;height: 45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:130px;left:4px;height: 45px;width:57px;">
	<div class="size_tb_bg font borDW">
