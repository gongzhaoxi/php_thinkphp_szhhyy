...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:80px;width:127px; height:228px;">
...
<div class="posi_a ov_h" style="top:73px;left:209px;height: 45px;width:41px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:106px;left:5px;height: 45px;width:70px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:152px;left:-60px;width: 60px;height:209px;">
	<div class="size_lr_bg font borDH">
		<p style="height:209px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:102px;left:15px;width: 60px;height:50px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:264px;left:-34px;width: 60px;height:84px;">
	<div class="size_lr_bg font borDH">
		<p style="height:84px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:156px;left:3px;width: 60px;height:79px;">
	<div class="size_lr_bg font borDH">
		<p style="height:79px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:3px;width: 60px;height:96px;">
	<div class="size_lr_bg font borDH">
