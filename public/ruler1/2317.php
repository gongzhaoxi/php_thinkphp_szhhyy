...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:6px;left:46px;width:127px; height:264px;">
...
<div style="overflow: hidden;position:absolute; top:276px;left:46px;width:127px; height:95px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
...
<div class="posi_a ov_h" style="top:129px;left:180px;height: 45px;width:69px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:121px;left:141px;width: 60px;height:54px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:178px;width: 60px;height:89px;">
	<div class="size_lr_bg font borDH">
		<p style="height:89px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:6px;left:178px;width: 60px;height:109px;">
	<div class="size_lr_bg font borDH">
