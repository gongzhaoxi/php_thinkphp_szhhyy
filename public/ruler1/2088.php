...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:4px;left:30px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:30px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:4px;left:154px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:154px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:4px;left:279px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:205px;left:279px;width:67px; height:167px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="67" height="167"/></div>
</div>
...
<div class="posi_a ov_h" style="top:357px;left:0px;height:45px;width:31px;">
	<div class="size_tb_bg font borDW">
		<p style="width:31px"><span><?php if(empty($L)){$L='L';}?><?php echo $L;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:155px;left:200px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
		<p style="width:69px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:155px;left:30px;height:45px;width:69px;">
	<div class="size_tb_bg font borDW">
		<p style="width:69px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
