...
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:144px;top:7px;left:140px;"><p style="height:144px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:144px;top:226px;left:140px;"><p style="height:144px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:130px;top:55px;left:235px;"><p style="height:130px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<!-- 中间横 -->
