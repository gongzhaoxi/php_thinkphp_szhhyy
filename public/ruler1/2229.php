...
<div class="posi_a ov_h" style="top:194px;left:102px;height:45px;width:45px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:160px;left:173px;width:60px;height:55px;">
	<div class="size_lr_bg font borDH">
		<p style="height:55px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:30px;left:173px;width:60px;height:73px;">
	<div class="size_lr_bg font borDH">
