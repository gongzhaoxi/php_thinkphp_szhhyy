...
<div class="posi_a ov_h" style="top:242px;left:36px;width: 60px;height:36px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:181px;left:167px;width: 60px;height:92px;">
	<div class="size_lr_bg font borDH">
		<p style="height:92px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:4px;left:167px;width: 60px;height:112px;">
	<div class="size_lr_bg font borDH">
