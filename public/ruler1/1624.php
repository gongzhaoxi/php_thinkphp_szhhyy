...
<!-- 标尺寸 -->
<!-- 上边 -->
<div class="size_tb_bg font posi_a borSW" style="width:157px;top:-20px;left:314px;"><p style="width:157px"><span><?php if(empty($F)){$F='F';}?><?php echo $F;?></span></p></div>
<!-- 下边 -->
...
<div class="size_tb_bg font posi_a borSW" style="width:89px;top:377px;left:382px;"><p style="width:89px"><span><?php if(empty($I)){$I='I';}?><?php echo $I;?></span></p></div>
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:478px;">
	<div class="size_tb_bg font borDW">
		<p style="width:478px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<div class="size_lr_bg font posi_a borSH" style="height:102px;top:48px;left:478px;"><p style="height:102px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:103px;top:226px;left:478px;"><p style="height:103px"><span><?php if(empty($P)){$P='P';}?><?php echo $P;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:158px;top:478px;left:-30px;"><p style="height:158px"><span><?php if(empty($LPH)){$LPH='LPH';}?><?php echo $LPH;?></span></p></div>
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:34px;top:7px;left:478px;"><p style="height:34px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:89px;top:36px;left:478px;"><p style="height:89px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<!-- <div class="size_lr_bg font posi_a borSH" style="height:147px;top:99px;left:478px;"><p style="height:147px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div> -->
<div class="posi_a ov_h" style="top:0px;left:478px;width:60px;height:377px;">
