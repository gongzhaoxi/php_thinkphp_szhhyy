...
<div class="size_lr_bg font posi_a borSH" style="height:177px;top:81px;left:234px;"><p style="height:177px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
<div class="size_lr_bg font posi_a borSH" style="height:139px;top:119px;left:46px;"><p style="height:139px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
...
<div class="size_tb_bg font posi_a borSW" style="width:72px;top:377px;left:43px;"><p style="width:72px"><span><?php if(empty($O)){$O='O';}?><?php echo $O;?></span></p></div>
</div>
</div>
<script>
