...
<div style="overflow: hidden;position:absolute; top:276px;left:5px;width:194px; height:95px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="194" height="95"/></div>
</div>
...
<div class="posi_a ov_h" style="top:326px;left:5px;height: 45px;width:194px;">
	<div class="size_tb_bg font borDW">
		<p style="width:194px"><span><?php if(empty($Z)){$Z='Z';}?><?php echo $Z;?></span></p>
	</div>
</div>
...
<div class="posi_a ov_h" style="top:120px;left:105px;width: 60px;height:56px;">
	<div class="size_lr_bg font borDH">
