...
<div style="overflow: hidden;position:absolute; top:276px;left:37px;width:175px; height:66px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flowers;?>" id="imageE<?php echo $diff;?>" width="175" height="66"/></div>
</div>
...
<div class="posi_a ov_h" style="top:296px;left:37px;height: 45px;width:175px;">
	<div class="size_tb_bg font borDW">
...
<div class="posi_a ov_h" style="top:276px;left:153px;width: 60px;height:67px;">
	<div class="size_lr_bg font borDH">
		<p style="height:67px"><span><?php if(empty($GBH1)){$GBH1='GBH1';}?><?php echo $GBH1;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:181px;left:179px;width: 60px;height:60px;">
	<div class="size_lr_bg font borDH">
...
<div class="posi_a ov_h" style="top:35px;left:179px;width: 60px;height:80px;">
	<div class="size_lr_bg font borDH">
		<p style="height:50px"><span><?php if(empty($D)){$D='D';}?><?php echo $D;?></span></p>
	</div>
</div>
<!-- 锁位 -->
</div>
