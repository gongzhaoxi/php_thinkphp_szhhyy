...
<!-- 花件 -->
<div style="overflow: hidden;position:absolute; top:24px;left:23px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:23px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:148px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:148px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:24px;left:139px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
<div style="overflow: hidden;position:absolute; top:201px;left:139px;width:82px; height:152px;">
<div class="img<?php echo $diff;?>" style="background:url(/upload/<?php echo $flowerPic;?>);"></div>
<div class="img<?php echo $diff;?> text"><img src="/upload/<?php echo $flower;?>" id="imageE<?php echo $diff;?>" width="82" height="152"/></div>
</div>
...
<div class="posi_a ov_h" style="top:153px;left:148px;height:45px;width:83px;">
	<div class="size_tb_bg font borDW">
		<p style="width:83px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p>
	</div>
</div>
<div class="posi_a ov_h" style="top:-46px;left:23px;height:45px;width:83px;">
	<div class="size_tb_bg font borDW">
		<p style="width:83px"><span><?php if(empty($FW)){$FW='FW';}?><?php echo $FW;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
<!-- 中间横 -->
