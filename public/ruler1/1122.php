...
<div class="posi_a ov_h" style="top:377px;left:0px;height:45px;width:609px;">
	<div class="size_tb_bg font borDW">
		<p style="width:609px"><span><?php if(empty($W)){$W='W';}?><?php echo $W;?></span></p>
	</div>
</div>
<!-- 中间竖 -->
...
<div class="size_lr_bg font posi_a borSH" style="height:120px;top:5px;left:572px;"><p style="height:120px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div>
...
<div class="size_lr_bg font posi_a borSH" style="height:69px;top:81px;left:496px;"><p style="height:69px"><span><?php if(empty($B)){$B='B';}?><?php echo $B;?></span></p></div>
<!-- 中间横 -->
...
<!-- 右边 -->
<div class="size_lr_bg font posi_a borSH" style="height:34px;top:5px;left:609px;"><p style="height:34px"><span><?php if(empty($S)){$S='S';}?><?php echo $S;?></span></p></div>
<!-- <div class="size_lr_bg font posi_a borSH" style="height:118px;top:48px;left:609px;"><p style="height:118px"><span><?php if(empty($A)){$A='A';}?><?php echo $A;?></span></p></div> -->
<div class="size_lr_bg font posi_a borSH" style="height:215px;top:81px;left:609px;"><p style="height:215px"><span><?php if(empty($C)){$C='C';}?><?php echo $C;?></span></p></div>
<div class="posi_a ov_h" style="top:0px;left:609px;width:60px;height:377px;">
